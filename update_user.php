...
// Generate a fresh random password at runtime - never a hardcoded shared secret.
...
echo "UPDATED_USER: {$user->email} | Random password set | Institute ID: {$user->institute_id} | Role: {$user->role}\n";
