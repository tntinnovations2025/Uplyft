...
{
    /**
     * Validate timetable slot against double-booking conflicts and subject daily limit.
     *
    ...
    public function validateConflict(
        ...
        // ── Check 1: Subject Daily Limit Conflict (Max 1 lecture of a subject per class per day) ──
        if ($subjectId) {
            ...
            if ($subjectDailyConflict) {
                ...
                $slotTime    = "{$subjectDailyConflict->start_time} - {$subjectDailyConflict->end_time}";
