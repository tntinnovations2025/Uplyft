...
Route::middleware('throttle:api')->group(function () {
    ...
    Route::post('/admissions', [StudentAdmissionController::class, 'store'])->name('api.admissions.store');
    Route::get('/admissions/{student}/invoice', [StudentAdmissionController::class, 'generateInvoicePdf'])->name('api.admissions.invoice');

    // Module 5: Teacher Onboarding & Secure Document Upload
    Route::post('/teachers/onboarding', [TeacherOnboardingController::class, 'store'])->name('api.teachers.onboarding');

    // Module 5: Class Roster & Attendance Management
    Route::get('/attendance/roster', [AttendanceController::class, 'index'])->name('api.attendance.roster');
