<?php $__env->startSection('title', 'Course Materials & Notes'); ?>
...
<div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:24px;flex-wrap:wrap;gap:12px">
    <div>
        ...
        <p style="color:var(--text-muted);font-size:14px;margin-top:2px">
            <?php echo e($subject->subject_name ?? 'Subject'); ?> (<?php if($subject): ?>? <?php echo e($subject->subject_code); ?> <?php endif; ?>) — Upload syllabus documents and course readings.
        </p>
    </div>
    <a href="<?php echo e($subject && $subject->institute_class_id ? route('lms.subjects.class', $subject->institute_class_id) : route('lms.subjects.list')); ?>" class="btn btn-ghost btn-sm">← Back to Subjects</a>
</div>

<div class="grid-2">
    
    <?php if($isTeacherOrPrincipal): ?>
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">📤 Upload Study Material</h3>
            </div>
            <form method="POST" action="<?php echo e(route('lms.materials.store', $subjectId)); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
    ...
    <div class="card">
        <div class="card-header">
            ...
            <a href="<?php echo e(route('lms.chatbot.index', ['subject_id' => $subjectId])); ?>" class="btn btn-ghost btn-sm">Full Screen Chat ↗</a>
        </div>
...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">📄 Indexed Materials (<?php echo e($materials->count()); ?>)</h3>
    </div>
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;gap:14px;padding:14px;border-bottom:1px solid var(--border)">
            <div style="display:flex;align-items:center;gap:14px;min-width:0">
                ...
                <div style="min-width:0">
                    <div style="font-weight:600;font-size:14px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis"><?php echo e($material->title); ?></div>
                    <div class="muted" style="font-size:12px;margin-top:2px">
                        <?php echo e(ucfirst($material->document_type)); ?> ·
                        <?php echo e($material->file_size_formatted); ?> ·
                        uploaded by <?php echo e($material->uploader->name ?? '—'); ?>

                    </div>
                </div>
            </div>
            <div style="display:flex;align-items:center;gap:10px;flex-shrink:0">
                <?php if($material->is_rag_indexed): ?>
                    <span class="badge badge-green">Indexed</span>
                <?php else: ?>
                    <span class="badge badge-yellow">Not Indexed</span>
                <?php endif; ?>
                <?php if($isTeacherOrPrincipal && (auth()->id() === $material->uploaded_by || auth()->user()->isPrincipal())): ?>
                    <form method="POST" action="<?php echo e(route('lms.materials.destroy', [$subjectId, $material])); ?>"
...
<script>
    document.getElementById('chat-form').addEventListener('submit', async function (e) {
        ...
        try {
            const res = await fetch('<?php echo e(route('lms.materials.chatbot', $subjectId)); ?>', {
                method: 'POST',
                headers: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('lms.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\UPLYFT\uplifyt\resources\views\lms\materials\index.blade.php ENDPATH**/ ?>