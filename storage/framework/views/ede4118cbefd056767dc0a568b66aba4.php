<section>
        ...
        <div style="display:flex;align-items:center;gap:12px">
            ...
            <div>
                ...
                <p style="font-size: 13px; color: #64748b; margin-top: 3px; font-weight: 500;">
                    <?php echo e(__('Verify with your current password and an OTP sent to your registered email.')); ?>
    ...
    <?php if(session('status') === 'otp-sent'): ?>
        <div style="background:#f0fdf4;border:1px solid #bbf7d0;padding:11px 14px;border-radius:10px;color:#166534;font-weight:700;font-size:13px;margin-bottom:16px;">
            ✅ OTP sent to <strong><?php echo e($user->email); ?></strong>. Codes are valid for 2 minutes.
        </div>
    <?php elseif(session('status') === 'otp-send-failed'): ?>
    ...
    <form method="post" action="<?php echo e(route('profile.password.send-otp')); ?>" style="display: flex; align-items: center; gap: 12px; margin-bottom: 18px; background: #f8fafc; border: 1px dashed #cbd5e1; border-radius: 12px; padding: 12px 16px;">
        <?php echo csrf_field(); ?>
        <span style="font-size: 24px;">📧</span>
        <div style="flex:1;">
            <div style="font-size: 13px; font-weight: 700; color: #0f172a;">Step 1 — Request your OTP</div>
            <div style="font-size: 12px; color: #64748b;">An OTP will be sent to <strong><?php echo e($user->email); ?></strong> from your institute&apos;s notification address.</div>
        </div>
    ...
    <form method="post" action="<?php echo e(route('password.update')); ?>" style="display: flex; flex-direction: column; gap: 18px;">
        ...
        <div>
            ...
            <input id="update_password_current_password" name="current_password" type="password" autocomplete="current-password"
                ...
                class="form-input"
                style="width: 100%; padding: 11px 16px; background: #ffffff; border: 1px solid <?php echo e($errors->updatePassword->has('current_password') ? '#ef4444' : '#cbd5e1'); ?>; border-radius: 10px; color: #0f172a; font-size: 14px; outline: none; transition: all 0.2s ease;" />
            ...
            <?php if($errors->updatePassword->has('current_password')): ?>
                <div style="color: #dc2626; font-size: 12px; font-weight: 600; margin-top: 6px; display: flex; align-items: center; gap: 6px;">
                    <span>⚠️</span>
                    <span><?php echo e($errors->updatePassword->first('current_password')); ?></span>
                </div>
            <?php endif; ?>
        </div>
        ...
        <div>
            <label for="update_password_otp" style="display: block; font-size: 12px; font-weight: 700; color: #334155; margin-bottom: 6px;">
                <?php echo e(__('Email OTP')); ?> *
            </label>
            <input id="update_password_otp" name="otp" type="text" inputmode="numeric" maxlength="6" autocomplete="one-time-code"
                placeholder="Enter 6-digit OTP..."
                style="width: 100%; padding: 11px 16px; background: #ffffff; border: 1px solid <?php echo e($errors->updatePassword->has('otp') ? '#ef4444' : '#cbd5e1'); ?>; border-radius: 10px; color: #0f172a; font-size: 14px; letter-spacing: 4px; text-align: center; font-weight: 700; outline: none; transition: all 0.2s ease;" />
            <p style="font-size: 12px; color: #64748b; margin-top: 4px;">
                Request a new OTP whenever a code expires. Each code is single-use and valid for 2 minutes.
            </p>

            <?php if($errors->updatePassword->has('otp')): ?>
                <div style="color: #dc2626; font-size: 12px; font-weight: 600; margin-top: 6px; display: flex; align-items: center; gap: 6px;">
                    <span>⚠️</span>
                    <span><?php echo e($errors->updatePassword->first('otp')); ?></span>
                </div>
            <?php endif; ?>
        </div>
        ...
        <div>
            ...
            <input id="update_password_password" name="password" type="password" autocomplete="new-password"
                ...
                class="form-input"
                style="width: 100%; padding: 11px 16px; background: #ffffff; border: 1px solid <?php echo e($errors->updatePassword->has('password') ? '#ef4444' : '#cbd5e1'); ?>; border-radius: 10px; color: #0f172a; font-size: 14px; outline: none; transition: all 0.2s ease;" />
            <p style="font-size: 12px; color: #64748b; margin-top: 4px;">
            ...
            <?php if($errors->updatePassword->has('password')): ?>
                <div style="color: #dc2626; font-size: 12px; font-weight: 600; margin-top: 6px; display: flex; align-items: center; gap: 6px;">
                    <span>⚠️</span>
                    <span><?php echo e($errors->updatePassword->first('password')); ?></span>
                </div>
            <?php endif; ?>
        </div>
        ...
        <div>
            ...
            <input id="update_password_password_confirmation" name="password_confirmation" type="password" autocomplete="new-password"
                ...
                class="form-input"
                style="width: 100%; padding: 11px 16px; background: #ffffff; border: 1px solid <?php echo e($errors->updatePassword->has('password_confirmation') ? '#ef4444' : '#cbd5e1'); ?>; border-radius: 10px; color: #0f172a; font-size: 14px; outline: none; transition: all 0.2s ease;" />

            <?php if($errors->updatePassword->has('password_confirmation')): ?>
                <div style="color: #dc2626; font-size: 12px; font-weight: 600; margin-top: 6px; display: flex; align-items: center; gap: 6px;">
                    <span>⚠️</span>
                    <span><?php echo e($errors->updatePassword->first('password_confirmation')); ?></span>
                </div>
            <?php endif; ?>
        </div>
...
</section><?php /**PATH D:\UPLYFT\uplifyt\resources\views\profile\partials\update-password-form.blade.php ENDPATH**/ ?>