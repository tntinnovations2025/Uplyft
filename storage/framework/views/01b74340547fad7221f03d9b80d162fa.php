<?php $__env->startSection('title', 'Class Timetable & Schedule'); ?>
<?php $__env->startSection('page-header', 'Class Timetable'); ?>
...
<div class="timetable-wrapper">
            ...
            <div>
                ...
                <div class="timetable-header-sub">
                    ...
                    <span class="timetable-meta-pill">
                        ...
                        <span>Class: <strong><?php echo e($classSection?->instituteClass?->custom_name ?? $classSection?->instituteClass?->class_name ?? 'Class 10'); ?> (<?php echo e($classSection?->section_name ?? '10-A'); ?>)</strong></span>
                    </span>
                    <span class="timetable-meta-pill">
                        <i class="fa-solid fa-graduation-cap text-indigo-500"></i>
                        <span>Student: <strong><?php echo e($student->first_name ?? 'Student'); ?> <?php echo e($student->last_name ?? ''); ?></strong></span>
                    </span>
                </div>
            </div>
        </div>
    ...
    <div class="day-jump-strip">
        ...
        <?php $todayDay = strtolower(date('l')); ?>
        <?php $__currentLoopData = $days; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            ?>
            <a href="#day-<?php echo e($d); ?>" class="day-jump-chip <?php echo e($isToday ? 'active-today' : ''); ?>">
                <i class="fa-regular fa-calendar <?php echo e($isToday ? 'text-rose-600' : 'text-slate-400'); ?>"></i>
                <span style="text-transform:capitalize"><?php echo e($d); ?></span>
                <span style="font-size:10.5px;padding:1px 5px;border-radius:10px;background:<?php echo e($isToday ? '#ffe4e6' : '#f1f5f9'); ?>;color:<?php echo e($isToday ? '#e11d48' : '#64748b'); ?>;font-weight:800">
                    <?php echo e($daySlotCount); ?>
    ...
    <div id="view-swimlanes" class="horizontal-days-stack">
        <?php $__currentLoopData = $days; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div id="day-<?php echo e($day); ?>" class="horizontal-day-row <?php echo e($isToday ? 'is-today-row' : ''); ?>">
                
                <!-- Left Day Pillar Column -->
                <div class="day-pillar-card">
                    <div style="display:flex;flex-direction:column;gap:4px">
                        <div class="day-name-heading">
                            <i class="fa-regular fa-calendar-check <?php echo e($isToday ? 'text-rose-600' : 'text-indigo-600'); ?>"></i>
                    ...
                    <div class="day-count-badge">
                        <?php echo e($daySlots->count()); ?> <?php echo e(Str::plural('Lecture', $daySlots->count())); ?>
                ...
                <div>
                                ...
                                <div class="lecture-slot-card">
                                    <div>
                                        <div style="display:flex;align-items:center;justify-content:space-between;gap:8px;margin-bottom:8px">
                                            <span class="lecture-time-badge">
                                                ...
                                                <span><?php echo e(substr($slot->start_time, 0, 5)); ?> - <?php echo e(substr($slot->end_time, 0, 5)); ?></span>
                                            </span>
                                            <span class="lecture-code-badge">
                                                <?php echo e($slot->subject?->subject_code ?? 'SUB'); ?>
                                        ...
                                        <div style="margin-top:6px">
                                            <span class="lecture-class-tag">
                                                ...
                                                <span><?php echo e($secLabel ?: 'Class Section'); ?></span>
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="lecture-footer-meta">
                                        <span style="display:flex;align-items:center;gap:5px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">
                                            ...
                                            <span class="truncate"><?php echo e($slot->teacher?->name ?? 'Faculty'); ?></span>
                                        </span>
                                        <span class="lecture-room-tag">
                                            <i class="fa-solid fa-door-open"></i>
                                            <span><?php echo e($cleanRoom); ?></span>
                                        </span>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php else: ?>
                        <div class="empty-day-banner">
                            ...
                            <span>No classes scheduled for <strong><?php echo e(ucfirst($day)); ?></strong> — Academic Free Day.</span>
                        </div>
                    <?php endif; ?>
                </div>
            ...
            <table class="matrix-table" style="min-width:850px">
                <thead>
                    <tr>
                        ...
                        <?php $__currentLoopData = $days; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $isToday = ($todayDay === $day); ?>
                            <th style="<?php echo e($isToday ? 'background:#fff1f2;color:#e11d48;border-color:#fecdd3;' : ''); ?>">
                                <div style="display:flex;align-items:center;justify-content:center;gap:5px">
                                    <span><?php echo e(ucfirst($day)); ?></span>
                                    <?php if($isToday): ?>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $timeSlotsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tSlot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td class="matrix-time-header">
                                <i class="fa-regular fa-clock"></i>
                                <div><?php echo e($tSlot); ?></div>
                            </td>
                            <?php $__currentLoopData = $days; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\UPLYFT\uplifyt\resources\views\student\timetable.blade.php ENDPATH**/ ?>