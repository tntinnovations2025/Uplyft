<?php $__env->startSection('title', 'Institute Settings & Configuration'); ?>
<?php $__env->startSection('breadcrumb', 'Institute Settings'); ?>
...
<div class="settings-container">
    ...
    <div style="display:flex;align-items:center;gap:10px;flex-wrap:wrap;background:#ffffff;border:1px solid #e2e8f0;border-radius:14px;padding:14px 18px;box-shadow:0 4px 20px rgba(15,23,42,0.03);">
        ...
        <a href="<?php echo e(route('principal.settings.index')); ?>" style="display:inline-flex;align-items:center;gap:6px;padding:8px 14px;border-radius:999px;font-size:12.5px;font-weight:700;color:#0f172a;background:#f1f5f9;border:1px solid #e2e8f0;text-decoration:none;">🏠 Institute Settings</a>
        <?php if(Route::has('principal.security.edit')): ?>
            <a href="<?php echo e(route('principal.security.edit')); ?>" style="display:inline-flex;align-items:center;gap:6px;padding:8px 14px;border-radius:999px;font-size:12.5px;font-weight:700;color:#0f172a;background:#f1f5f9;border:1px solid #e2e8f0;text-decoration:none;">🔐 Security &amp; 2FA</a>
        <?php endif; ?>
        <a href="<?php echo e(route('principal.attendance-settings.index')); ?>" style="display:inline-flex;align-items:center;gap:6px;padding:8px 14px;border-radius:999px;font-size:12.5px;font-weight:700;color:#0f172a;background:#f1f5f9;border:1px solid #e2e8f0;text-decoration:none;">⏰ Attendance Lock Rules</a>
        <?php if(isset($topOrg) && $topOrg && auth()->user()->isPrincipal()): ?>
            <a href="<?php echo e(route('principal.organization.campuses.index')); ?>" style="display:inline-flex;align-items:center;gap:6px;padding:8px 14px;border-radius:999px;font-size:12.5px;font-weight:700;color:#0f172a;background:#f1f5f9;border:1px solid #e2e8f0;text-decoration:none;">🏢 Manage Campuses</a>
        <?php endif; ?>
        <a href="<?php echo e(route('profile.edit')); ?>" style="display:inline-flex;align-items:center;gap:6px;padding:8px 14px;border-radius:999px;font-size:12.5px;font-weight:700;color:#0f172a;background:#f1f5f9;border:1px solid #e2e8f0;text-decoration:none;">👤 Personal Settings</a>
    </div>
    ...
    <div style="display:flex;align-items:center;gap:8px;flex-wrap:wrap;background:#ffffff;border:1px solid #e2e8f0;border-radius:14px;padding:12px 14px;box-shadow:0 4px 20px rgba(15,23,42,0.03);">
        ...
        ?>
        <?php $__currentLoopData = $tabs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => [$icon, $label]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="?tab=<?php echo e($key); ?>"
               style="display:inline-flex;align-items:center;gap:7px;padding:9px 16px;border-radius:999px;font-size:12.5px;font-weight:800;text-decoration:none;transition:all 0.2s ease;
                      <?php echo e($activeTab === $key ? 'background:linear-gradient(135deg,#4f46e5,#6366f1);color:#ffffff;box-shadow:0 3px 10px rgba(79,70,229,0.3);' : 'background:#f8fafc;color:#475569;border:1px solid #e2e8f0;'); ?>">
                <span style="font-size:14px"><?php echo e($icon); ?></span><?php echo e($label); ?>
    ...
    <!-- Top Header & Save Bar -->
    <form method="POST" action="<?php echo e(route('principal.settings.update')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div class="settings-grid" style="<?php echo e($activeTab !== 'all' ? 'display:flex;flex-direction:column;gap:24px' : ''); ?>">
            
            <!-- CARD 1: 💰 Financial Targets & Budgets -->
            <?php if($activeTab === 'financial' || $activeTab === 'all'): ?>
                <div class="settings-card" id="card-financial">
                    ...
                    <div class="form-group">
                        <label class="form-label" for="monthly_income_target">Monthly Income Target (<?php echo e($currencySymbol); ?>) *</label>
                        <input type="number" step="1000" id="monthly_income_target" name="monthly_income_target" value="<?php echo e(old('monthly_income_target', $setting->monthly_income_target)); ?>" required class="form-input" placeholder="e.g. 500000">
                        <span class="form-hint">Used as the primary collection benchmark line on your executive financial graph.</span>
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="monthly_expense_budget">Monthly Expense Budget (<?php echo e($currencySymbol); ?>) *</label>
                        <input type="number" step="1000" id="monthly_expense_budget" name="monthly_expense_budget" value="<?php echo e(old('monthly_expense_budget', $setting->monthly_expense_budget)); ?>" required class="form-input" placeholder="e.g. 350000">
                    ...
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px">
                        <div class="form-group">
                            ...
                            <input type="number" min="1" max="31" id="fee_due_day_of_month" name="fee_due_day_of_month" value="<?php echo e(old('fee_due_day_of_month', $setting->fee_due_day_of_month)); ?>" required class="form-input" placeholder="e.g. 10">
                            <span class="form-hint">Day of month (1-31)</span>
                        </div>

                        <div class="form-group">
                            <label class="form-label" for="late_fee_fine_amount">Late Fine (<?php echo e($currencySymbol); ?>) *</label>
                            <input type="number" step="50" min="0" id="late_fee_fine_amount" name="late_fee_fine_amount" value="<?php echo e(old('late_fee_fine_amount', $setting->late_fee_fine_amount)); ?>" required class="form-input" placeholder="e.g. 500">
                    ...
                    <div class="form-group" style="position:relative">
                        ...
                        <input type="hidden" id="currency_symbol" name="currency_symbol" value="<?php echo e(old('currency_symbol', $setting->currency_symbol ?? 'PKR')); ?>">
            ...
            <?php if($activeTab === 'payroll' || $activeTab === 'all'): ?>
                <div class="settings-card" id="card-payroll">
                    <div class="settings-card-header" style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:16px">
                        ...
                        <form method="POST" action="<?php echo e(route('principal.accounts.salaries.auto-disburse')); ?>" style="margin:0" onsubmit="return confirm('⚡ Confirm auto-disbursing all staff salaries for <?php echo e(now()->format('F Y')); ?> and deducting from total income?');">
                            <?php echo csrf_field(); ?>
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $staffMembers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $staff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    ...
                                    <tr style="border-bottom:1px solid #f1f5f9;cursor:pointer"
                                        ...
                                        data-staff-name="<?php echo e(e($staff->name)); ?>"
                                        data-role-title="<?php echo e(e($roleTitle)); ?>"
                                        data-salary="<?php echo e($sal ?? ''); ?>"
                                        data-absent-days="<?php echo e($abs); ?>"
                                        data-payout-day="<?php echo e($pday); ?>"
                                        data-deduction-type="<?php echo e($dtype); ?>"
                                        data-fixed-fine="<?php echo e($ffine); ?>"
                                        onclick="openStaffPayrollFromElem(this)">
                                        <td style="padding:14px 16px">
                                            <div style="font-weight:800;color:#0f172a;font-size:14px"><?php echo e($staff->name); ?></div>
                                            <div style="font-size:11.5px;color:#64748b;margin-top:1px">✉️ <?php echo e($staff->email); ?></div>
                                        </td>
                                        <td style="padding:14px 16px">
                                        ...
                                        <td style="padding:14px 16px">
                                            <?php if($sal): ?>
                                                <span style="font-weight:800;color:#059669;font-size:14px">
                                                    <?php echo e($currencySymbol); ?> <?php echo e(number_format($sal, 2)); ?>
                                        ...
                                        <td style="padding:14px 16px">
                                            <span class="badge badge-blue" style="font-size:11px;font-weight:700">
                                                <?php echo e($abs); ?> Days / Month
                                            </span>
                                        </td>
                                        <td style="padding:14px 16px">
                                            <span style="font-size:13px;font-weight:700;color:#334155">
                                                🗓️ Day <?php echo e($pday); ?>

                                            </span>
                                        </td>
                                        <td style="padding:14px 16px">
                                            <?php if($dtype === 'pro_rata'): ?>
                                                <span style="font-size:12px;font-weight:700;color:#0284c7">Pro-Rata Daily Rate</span>
                                            <?php elseif($dtype === 'fixed'): ?>
                                                <span style="font-size:12px;font-weight:700;color:#d97706">Fixed Fine (<?php echo e($currencySymbol); ?> <?php echo e(number_format($ffine, 0)); ?>)</span>
                                            <?php else: ?>
            ...
            <?php if($activeTab === 'financial' || $activeTab === 'bank' || $activeTab === 'all'): ?>
                <div class="settings-card" id="card-bank">
                    ...
                    <div class="toggle-box">
                        ...
                        <label class="toggle-switch">
                            <input type="checkbox" name="show_payment_details" value="1" <?php echo e(old('show_payment_details', $setting->show_payment_details) ? 'checked' : ''); ?>>
                    ...
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px">
                        <div class="form-group">
                            ...
                            <input type="text" id="bank_name" name="bank_name" value="<?php echo e(old('bank_name', $setting->bank_name)); ?>" class="form-input" placeholder="e.g. Meezan Bank Ltd.">
                        </div>

                        <div class="form-group">
                            <label class="form-label" for="bank_account_title">Account Title</label>
                            <input type="text" id="bank_account_title" name="bank_account_title" value="<?php echo e(old('bank_account_title', $setting->bank_account_title)); ?>" class="form-input" placeholder="e.g. Uplyft Education Trust">
                        </div>
                    </div>
                    ...
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px">
                        <div class="form-group">
                            ...
                            <input type="text" id="bank_account_number" name="bank_account_number" value="<?php echo e(old('bank_account_number', $setting->bank_account_number)); ?>" class="form-input" placeholder="e.g. 01020304050607">
                        </div>

                        <div class="form-group">
                            <label class="form-label" for="onebill_voucher_prefix">1Bill Prefix / Biller ID</label>
                            <input type="text" id="onebill_voucher_prefix" name="onebill_voucher_prefix" value="<?php echo e(old('onebill_voucher_prefix', $setting->onebill_voucher_prefix)); ?>" class="form-input" placeholder="e.g. 100456">
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="bank_iban">IBAN (International Bank Account Number)</label>
                        <input type="text" id="bank_iban" name="bank_iban" value="<?php echo e(old('bank_iban', $setting->bank_iban)); ?>" class="form-input" placeholder="PK00MEZN0000000102030405">
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="payment_instructions">Payment Instructions (Shown to Students)</label>
                        <textarea id="payment_instructions" name="payment_instructions" rows="2" class="form-input" placeholder="Please upload a photo of your deposit slip or ATM receipt after transfer."><?php echo e(old('payment_instructions', $setting->payment_instructions)); ?></textarea>
                    </div>
                </div>
            <?php endif; ?>

            <!-- CARD 3: 📧 Notifications & Contact Channels -->
            <?php if($activeTab === 'notifications' || $activeTab === 'financial' || $activeTab === 'bank' || $activeTab === 'all'): ?>
                <div class="settings-card" id="card-notifications">
                    ...
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px">
                        <div class="form-group">
                            ...
                            <input type="email" id="notification_email" name="notification_email" value="<?php echo e(old('notification_email', $setting->notification_email)); ?>" class="form-input" placeholder="e.g. noreply@yourinstitute.edu">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="notification_phone" name="notification_phone" value="<?php echo e(old('notification_phone', $setting->notification_phone)); ?>" class="form-input" placeholder="e.g. +92 300 1234567">
            ...
            <?php if($activeTab === 'academic' || $activeTab === 'all'): ?>
                <div class="settings-card" id="card-academic">
                    ...
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.1" min="0" max="1000" id="passing_percentage" name="passing_percentage" value="<?php echo e(old('passing_percentage', $setting->passing_percentage)); ?>" required class="form-input" placeholder="e.g. 40">
                        ...
                        <div class="form-group">
                            ...
                            <select name="grade_scale_type" id="grade_scale_type" class="form-input" onchange="updatePassingScoreLabel(this.value)">
                                <option value="percentage" <?php echo e(old('grade_scale_type', $setting->grade_scale_type) === 'percentage' ? 'selected' : ''); ?>>Percentage (0-100%)</option>
                                <option value="marks" <?php echo e(old('grade_scale_type', $setting->grade_scale_type) === 'marks' ? 'selected' : ''); ?>>Absolute Marks (Direct Marks Scale)</option>
                                <option value="gpa" <?php echo e(old('grade_scale_type', $setting->grade_scale_type) === 'gpa' ? 'selected' : ''); ?>>GPA 4.0 Standard Scale</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="institute_name" name="institute_name" value="<?php echo e(old('institute_name', $institute?->name ?? 'Uplyft Academy')); ?>" class="form-input">
                    </div>

                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px">
                        <div class="form-group">
                            <label class="form-label" for="contact_email">Official Email</label>
                            <input type="email" id="contact_email" name="contact_email" value="<?php echo e(old('contact_email', $institute?->contact_email ?? '')); ?>" class="form-input">
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="contact_phone">Contact Phone</label>
                            <input type="text" id="contact_phone" name="contact_phone" value="<?php echo e(old('contact_phone', $institute?->contact_phone ?? '')); ?>" class="form-input">
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="city">City / Campus Location</label>
                        <input type="text" id="city" name="city" value="<?php echo e(old('city', $institute?->city ?? '')); ?>" class="form-input" placeholder="e.g. Lahore, Karachi, Islamabad">
                    </div>
                </div>
            <?php endif; ?>

            <!-- CARD 5: 🎨 Institute Brand Logo & Identity Studio -->
            <?php if($activeTab === 'branding' || $activeTab === 'all'): ?>
                ...
                <?php if($institute && $institute->logo_path): ?>
                    <div style="display:flex;align-items:center;justify-content:space-between;background:#f8fafc;border:1px solid #e2e8f0;border-radius:12px;padding:14px 18px">
                        <div style="display:flex;align-items:center;gap:14px">
                            <div style="width:54px;height:54px;border-radius:50%;background:#ffffff;border:2.5px solid #eab308;box-shadow:0 0 14px rgba(234,179,8,0.35);padding:2px;display:flex;align-items:center;justify-content:center;overflow:hidden;flex-shrink:0">
                                <img src="<?php echo e($institute->logo_url); ?>" alt="<?php echo e($institute->name); ?> Logo" style="width:100%;height:100%;object-fit:contain;border-radius:50%" />
                            </div>
                            <div>
                ...
                <div id="principal-logo-dropzone" 
                    ...
                    <div id="principal-dropzone-idle">
                        ...
                        <div style="font-size:14px;font-weight:800;color:#1e1b4b"><?php echo e(($institute && $institute->logo_path) ? 'Click or Drop Image to Replace Institute Logo' : 'Click or Drop Image to Upload Institute Logo'); ?></div>
        ...
        <div style="margin-top:24px;display:flex;justify-content:flex-end;gap:12px;background:#ffffff;border:1px solid #e2e8f0;border-radius:16px;padding:18px 24px;box-shadow:0 4px 20px rgba(15,23,42,0.04)">
            <a href="<?php echo e(route('principal.dashboard')); ?>" class="btn btn-secondary" style="padding:10px 22px;border-radius:10px">
                Cancel
            </a>
    ...
    <div class="apple-liquid-glass-card" style="width:100%;max-width:540px;max-height:90vh;overflow-y:auto;padding:26px 28px;border-radius:24px;box-sizing:border-box;box-shadow:0 25px 60px -12px rgba(15,23,42,0.35)">
        ...
        <form id="staffPayrollForm" method="POST" action="">
            ...
            <div class="form-group" style="margin-bottom:16px">
                <label class="form-label" for="modal_basic_salary_pkr" style="margin-bottom:6px">Individual Monthly Basic Salary (<?php echo e($currencySymbol); ?>) *</label>
            ...
            <div class="form-group" id="modal_fixed_deduction_group" style="display:none;margin-bottom:16px">
                <label class="form-label" for="modal_fixed_absent_deduction_amount" style="margin-bottom:6px">Fixed Fine Per Extra Absent Day (<?php echo e($currencySymbol); ?>) *</label>
...
<script>
    ...
    function openStaffPayrollModal(staffId, staffName, roleTitle, sal, abs, pday, dtype, ffine) {
        ...
        form.action = "<?php echo e(url('/principal/settings/staff')); ?>/" + staffId + "/payroll";
...
<?php echo $__env->make('principal.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\UPLYFT\uplifyt\resources\views\principal\settings\index.blade.php ENDPATH**/ ?>