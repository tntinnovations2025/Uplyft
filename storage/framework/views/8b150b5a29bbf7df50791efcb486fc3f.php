...
<?php $__env->startSection('title', 'Register New Student'); ?>
<?php $__env->startSection('breadcrumb', 'Student Admissions'); ?>
...
<div class="glass-card">
    <div class="form-header">
        <div>
            ...
            <div style="font-size:13px;color:#64748b;margin-top:4px;font-weight:500">
                Register a new student under <?php echo e($institute->name); ?>. Click any section heading to expand it. All fields are optional — fill in whatever data is available.
            </div>
        </div>
    ...
    <form action="<?php echo e(route($routePrefix . 'store')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <input type="hidden" name="institute_id" value="<?php echo e(auth()->user()->institute_id); ?>">
        ...
        <div style="display:flex;align-items:center;gap:8px;background:#f0fdf4;border:1px solid #a7f3d0;border-radius:10px;padding:8px 14px;margin-bottom:18px;font-size:12px;color:#059669;font-weight:700">
            ...
            <code style="background:#ffffff;border:1px solid #a7f3d0;padding:2px 10px;border-radius:6px;font-weight:800;font-size:13px;color:#059669;font-family:monospace">
                <?php echo e($autoStudentId ?? 'STD-'.now()->year.'-0001'); ?>
            ...
            <div class="section-body">
                <div class="form-grid form-grid-2 mb-6">
                    <div>
                        ...
                        <input type="text" name="first_name" class="form-control" value="<?php echo e(old('first_name')); ?>" placeholder="e.g. Muhammad">
                    </div>
                    <div>
                        <label class="field-label">Last Name <span class="optional-tag">(optional)</span></label>
                        <input type="text" name="last_name" class="form-control" value="<?php echo e(old('last_name')); ?>" placeholder="e.g. Ali">
                    </div>
                </div>
                ...
                <div class="form-grid form-grid-3 mb-6">
                    <div>
                        ...
                        <input type="email" name="email" class="form-control" value="<?php echo e(old('email')); ?>" placeholder="student@institute.edu">
                    </div>
                    <div>
                        ...
                        <div style="display:flex;gap:6px">
                            ...
                            <input type="text" id="student_phone" name="phone_number" class="form-control" value="<?php echo e(old('phone_number')); ?>" placeholder="3001234567" maxlength="10" oninput="formatPhoneInput(this, 'phone_country_code', 'phone_digit_hint')">
                        </div>
                ...
                <div class="form-grid form-grid-3">
                    ...
                    <div>
                        ...
                        <input type="text" name="student_bform_cnic" class="form-control" value="<?php echo e(old('student_bform_cnic')); ?>" placeholder="00000-0000000-0" maxlength="15" oninput="formatCNIC(this)">
            ...
            <div class="section-body">
                <div class="form-grid form-grid-3 mb-6">
                    <div>
                        ...
                        <input type="text" name="father_guardian_name" class="form-control" value="<?php echo e(old('father_guardian_name')); ?>" placeholder="e.g. Tariq Mehmood">
                    </div>
                    <div>
                        ...
                        <div style="display:flex;gap:6px">
                            ...
                            <input type="text" id="guardian_phone" name="guardian_phone_number" class="form-control" value="<?php echo e(old('guardian_phone_number')); ?>" placeholder="3009876543" maxlength="10" oninput="formatPhoneInput(this, 'guardian_country_code', 'guardian_digit_hint')">
                        </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="father_guardian_cnic" class="form-control" value="<?php echo e(old('father_guardian_cnic')); ?>" placeholder="00000-0000000-0" maxlength="15" oninput="formatCNIC(this)">
                        <span style="font-size:11px;color:#64748b">Fixed Format: 00000-0000000-0</span>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea name="address" class="form-control" rows="2" placeholder="House #, Street, Sector, City"><?php echo e(old('address')); ?></textarea>
                </div>
            </div>
        </div>
            ...
            <div class="section-body">
                <div class="form-grid form-grid-3">
                    ...
                    <div>
                        ...
                        <input type="number" name="previous_marks" step="0.01" min="0" max="100" class="form-control" value="<?php echo e(old('previous_marks')); ?>" placeholder="e.g. 85.50">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="form-section" id="section-financial">
            ...
            <div class="section-body">
                <div class="form-grid form-grid-3 mb-6">
                    <div>
                        <label class="field-label">Base Monthly Tuition Fee (<?php echo e($currencySymbol ?? 'PKR'); ?>) <span class="optional-tag">(optional)</span></label>
                        <input type="number" id="base_fee" name="base_fee" min="0" step="500" class="form-control" value="<?php echo e(old('base_fee', '10000')); ?>" oninput="recalculateFeeVoucher()">
                    </div>
                    <div>
                        ...
                        <select id="guardian_tax_status" name="guardian_tax_status" class="form-control" onchange="onTaxStatusChanged()">
                            <option value="non-filer" <?php echo e(old('guardian_tax_status') == 'non-filer' ? 'selected' : ''); ?>>Non-Filer (Standard 15% Tax)</option>
                            <option value="filer" <?php echo e(old('guardian_tax_status') == 'filer' ? 'selected' : ''); ?>>Filer (Discounted 5% Tax)</option>
                        </select>
                    </div>
                    <div>
                        <label class="field-label">Tax Rate Percentage (%) <span class="optional-tag">(optional)</span></label>
                        <div style="position:relative">
                            <input type="number" id="tax_percentage" name="tax_percentage" step="0.5" min="0" max="100" class="form-control" value="<?php echo e(old('tax_percentage', '15')); ?>" oninput="recalculateFeeVoucher()">
                ...
                <div class="form-grid form-grid-2 mb-6" style="background:#f8fafc;border:1px dashed #cbd5e1;border-radius:14px;padding:18px">
                    <div>
                        <label class="field-label" style="color:#059669">
                            Admission Fee (<?php echo e($currencySymbol ?? 'PKR'); ?>) — <span style="color:#ef4444;font-weight:bold">Non-Refundable</span>
                        </label>
                        <input type="number" id="admission_fee" name="admission_fee" min="0" step="500" class="form-control" value="<?php echo e(old('admission_fee', '5000')); ?>" oninput="recalculateFeeVoucher()">
                    ...
                    <div>
                        <label class="field-label" style="color:#0284c7">
                            Security Deposit Fee (<?php echo e($currencySymbol ?? 'PKR'); ?>) — <span style="color:#059669;font-weight:bold">Refundable on Graduation/Departure</span>
                        </label>
                        <input type="number" id="security_fee" name="security_fee" min="0" step="500" class="form-control" value="<?php echo e(old('security_fee', '5000')); ?>" oninput="recalculateFeeVoucher()">
                ...
                <div style="background:#fdf4ff;border:1px solid #f5d0fe;border-radius:14px;padding:20px;margin-bottom:16px">
                    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:14px;flex-wrap:wrap;gap:8px">
                        ...
                        <?php if(auth()->user()->role === 'principal' || auth()->user()->role === 'admin'): ?>
                    ...
                    <div class="form-grid form-grid-2 mb-4">
                        <div>
                            ...
                            <select id="scholarship_category_id" name="scholarship_category_id" class="form-control" onchange="onScholarshipCategoryChanged()">
                                ...
                                <?php $__currentLoopData = $scholarships; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($sch->id); ?>" data-pct="<?php echo e($sch->discount_percentage); ?>" data-questions='<?php echo json_encode($sch->questions, 15, 512) ?>' <?php echo e(old('scholarship_category_id') == $sch->id ? 'selected' : ''); ?>>
                                        🎓 <?php echo e($sch->title); ?> (<?php echo e(number_format($sch->discount_percentage, 0)); ?>% Off)
                                    </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php if(auth()->user()->role === 'principal' || auth()->user()->role === 'admin'): ?>
                        ...
                        <div>
                            ...
                            <div style="position:relative">
                                <input type="number" id="scholarship_percentage" name="scholarship_percentage" step="0.5" min="0" max="100" class="form-control" value="<?php echo e(old('scholarship_percentage', '0')); ?>" oninput="recalculateFeeVoucher()" readonly>
                ...
                <div style="background:#ffffff;border:1px solid rgba(226,232,240,0.85);border-radius:16px;padding:20px;box-shadow:0 4px 20px -2px rgba(0,0,0,0.04)">
                    ...
                    <div style="display:grid;grid-template-columns:repeat(auto-fit, minmax(140px, 1fr));gap:12px;text-align:center">
                        <div style="background:#f8fafc;padding:12px;border-radius:10px;border:1px solid #e2e8f0">
                            ...
                            <div id="preview_base_fee" style="font-size:15px;font-weight:800;color:#0f172a;margin-top:4px"><?php echo e($currencySymbol ?? 'PKR'); ?> 10,000</div>
                        </div>
                        <div style="background:#ecfdf5;padding:12px;border-radius:10px;border:1px solid #a7f3d0">
                            ...
                            <div id="preview_admission_fee" style="font-size:15px;font-weight:800;color:#059669;margin-top:4px"><?php echo e($currencySymbol ?? 'PKR'); ?> 5,000</div>
                        </div>
                        <div style="background:#eff6ff;padding:12px;border-radius:10px;border:1px solid #bfdbfe">
                            ...
                            <div id="preview_security_fee" style="font-size:15px;font-weight:800;color:#0284c7;margin-top:4px"><?php echo e($currencySymbol ?? 'PKR'); ?> 5,000</div>
                        </div>
                        <div style="background:#ecfdf5;padding:12px;border-radius:10px;border:1px solid #a7f3d0">
                            <div style="font-size:10px;text-transform:uppercase;color:#059669;font-weight:700">Scholarship</div>
                            <div id="preview_discount" style="font-size:15px;font-weight:800;color:#059669;margin-top:4px">- <?php echo e($currencySymbol ?? 'PKR'); ?> 0</div>
                        </div>
                        <div style="background:#eff6ff;padding:12px;border-radius:10px;border:1px solid #bfdbfe">
                            <div style="font-size:10px;text-transform:uppercase;color:#0284c7;font-weight:700">Tax (<span id="preview_tax_rate">15%</span>)</div>
                            <div id="preview_tax_amount" style="font-size:15px;font-weight:800;color:#0284c7;margin-top:4px">+ <?php echo e($currencySymbol ?? 'PKR'); ?> 2,250</div>
                        </div>
                        <div style="background:#fdf2f8;padding:12px;border-radius:10px;border:1px solid #fbcfe8">
                            ...
                            <div id="preview_grand_total" style="font-size:17px;font-weight:900;color:#be185d;margin-top:4px"><?php echo e($currencySymbol ?? 'PKR'); ?> 22,250</div>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
        ...
        <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            "<?php echo e($class->id); ?>": [
                <?php $__currentLoopData = $class->sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    { id: "<?php echo e($sec->id); ?>", name: "<?php echo e($sec->section_name ?? $sec->name); ?>" },
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ],
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    };
    ...
    function recalculateFeeVoucher() {
        ...
        const currSym = <?php echo json_encode($currencySymbol ?? 'PKR', 15, 512) ?>;
...
<?php echo $__env->make(auth()->check() && !auth()->user()->isPrincipal() && !auth()->user()->isGlobalAdmin() ? 'layouts.app' : 'principal.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\UPLYFT\uplifyt\resources\views\principal\students\create.blade.php ENDPATH**/ ?>