...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Your institute "<?php echo e($institute->name); ?>" has been registered.</p>
        </div>
        <div class="body">
            <p>Dear <strong><?php echo e($principal->name); ?></strong>,</p>
            <p>Your Principal master login has been created for <strong><?php echo e($institute->name); ?></strong>. Below are your login credentials:</p>

            <div class="credential-box">
                <table>
                    <tr><td>Login URL</td><td><?php echo e(config('app.url')); ?>/login</td></tr>
                    <tr><td>Email</td><td><?php echo e($principal->email); ?></td></tr>
                    <?php if($principal->identifier): ?>
                    <tr><td>Employee ID</td><td><?php echo e($principal->identifier); ?></td></tr>
                    <?php endif; ?>
                    <tr><td>Password</td><td><?php echo e($plainPassword); ?></td></tr>
                </table>
            </div>
            ...
            <a href="<?php echo e(config('app.url')); ?>/login" class="cta">🔐 Log In Now</a>
        </div>
        <div class="footer">
            &copy; <?php echo e(date('Y')); ?> UPLYFT — Multi-Institute LMS Platform
        </div>
    </div>
</body>
</html>
<?php /**PATH D:\UPLYFT\uplifyt\resources\views\emails\principal-credentials.blade.php ENDPATH**/ ?>