...
<?php endif; ?>
    ...
    <form id="globalAdminLoginForm" method="POST" action="<?php echo e(route('global-admin.login')); ?>">
        <?php echo csrf_field(); ?>
...
<?php endif; ?>
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;font-size:9.5px;color:#64748b;margin-top:2px;">
            ...
            <?php if(Route::has('password.request')): ?>
                <a href="<?php echo e(route('password.request')); ?>" style="color:#4f46e5;text-decoration:none;font-weight:700">Forgot Password?</a>
            <?php endif; ?>
        </div>
...
<?php endif; ?>
<?php /**PATH D:\UPLYFT\uplifyt\resources\views\auth\global-admin-login.blade.php ENDPATH**/ ?>