<?php $__env->startSection('title', ($user->staff_role ? $user->staff_role . ' Dashboard' : 'Staff Dashboard')); ?>
<?php $__env->startSection('page-header', ($user->staff_role ? $user->staff_role . ' Portal' : 'Faculty & Staff Portal')); ?>
...
<div class="space-y-6">
        ...
        <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div class="flex items-center gap-4">
                <div class="w-12 h-12 rounded-2xl bg-gradient-to-tr from-indigo-700 via-indigo-600 to-violet-600 text-white flex items-center justify-center text-xl font-extrabold shadow-md shadow-indigo-500/25 border border-white/60 font-display">
                    <?php echo e(strtoupper(substr($user->name ?? 'T', 0, 1))); ?>
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-500 font-semibold mt-1 flex items-center gap-2 flex-wrap">
                        ...
                        <span class="text-indigo-700 font-bold bg-indigo-50 px-2.5 py-0.5 rounded-md border border-indigo-200/70"><?php echo e($user->identifier ?? '—'); ?></span>
                    </p>
                </div>
            </div>
            <div class="flex flex-wrap items-center gap-2.5">
                <span class="badge badge-indigo text-xs font-bold">
                    <i class="fa-solid fa-id-badge"></i> <?php echo e(strtoupper($user->staff_role ?? 'Teacher')); ?><?php echo e($user->employment_type ? ' (' . ucfirst($user->employment_type) . ')' : ''); ?>
                ...
                <?php endif; ?>
                <span class="badge badge-indigo text-xs font-bold">
                    <i class="fa-solid fa-building"></i> <?php echo e($user->institute->name ?? 'Uplyft Academy'); ?>
    ...
    <?php if($isAccountant || auth()->user()->hasPermission('accounts') || auth()->user()->hasPermission('invoices')): ?>
        ...
        <div class="flex flex-wrap items-center justify-between gap-3 p-4 bg-white/90 border border-slate-200/90 rounded-2xl shadow-sm backdrop-blur-md">
            ...
            <div class="flex items-center gap-2 flex-wrap">
                <a href="<?php echo e(auth()->user()->staffUrl('accounts?tab=ledger&action=new_expense')); ?>" class="btn btn-primary text-xs font-bold px-3.5 py-2 inline-flex items-center gap-2 shadow-sm">
                    <i class="fa-solid fa-plus"></i> Record Expense for AI Audit
                </a>
                <a href="<?php echo e(auth()->user()->staffUrl('accounts?tab=ai_report')); ?>" class="btn btn-secondary text-xs font-bold px-3.5 py-2 inline-flex items-center gap-2">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <div class="liquid-glass-card p-5 border border-emerald-200/80 bg-gradient-to-br from-emerald-50/60 via-white to-emerald-50/30 relative overflow-hidden group shadow-2xs hover:shadow-md transition">
                ...
                <div class="text-2xl font-black text-slate-900 font-display tracking-tight">
                    PKR <?php echo e(number_format($totalFeeCollected ?? 0)); ?>
            ...
            <div class="liquid-glass-card p-5 border border-rose-200/80 bg-gradient-to-br from-rose-50/60 via-white to-rose-50/30 relative overflow-hidden group shadow-2xs hover:shadow-md transition">
                ...
                <div class="text-2xl font-black text-slate-900 font-display tracking-tight">
                    PKR <?php echo e(number_format($totalRemainingFee ?? 0)); ?>

                </div>
                <div class="mt-2 flex items-center gap-1.5 text-xs text-rose-700 font-semibold">
                    <i class="fa-solid fa-triangle-exclamation text-rose-600"></i>
                    <span><?php echo e($unpaidCount ?? 0); ?> Pending vouchers</span>
                </div>
            </div>
            ...
            <div class="liquid-glass-card p-5 border border-amber-200/80 bg-gradient-to-br from-amber-50/60 via-white to-amber-50/30 relative overflow-hidden group shadow-2xs hover:shadow-md transition">
                ...
                <div class="text-2xl font-black text-slate-900 font-display tracking-tight">
                    PKR <?php echo e(number_format($totalFinesCollected ?? 0)); ?>
            ...
            <div class="liquid-glass-card p-5 border border-indigo-200/80 bg-gradient-to-br from-indigo-50/60 via-white to-indigo-50/30 relative overflow-hidden group shadow-2xs hover:shadow-md transition">
                ...
                <div class="mt-2 flex items-center gap-1.5 text-xs text-indigo-700 font-semibold">
                    ...
                    <span><?php echo e($paidCount ?? 0); ?> Paid / <?php echo e($totalInvoicesCount); ?> Total Issued</span>
                </div>
            </div>
        </div>
            ...
            <div class="liquid-glass-card p-6 border border-slate-200/90 shadow-sm flex flex-col justify-between">
                ...
                <div class="mt-4 pt-3 border-t border-slate-200/80 flex items-center justify-around text-xs font-bold">
                    <div class="flex items-center gap-2 text-emerald-700">
                        ...
                        <span>Paid: <?php echo e($paidCount ?? 0); ?></span>
                    </div>
                    <div class="flex items-center gap-2 text-rose-700">
                        <span class="w-3 h-3 rounded-full bg-rose-500"></span>
                        <span>Unpaid: <?php echo e($unpaidCount ?? 0); ?></span>
                    </div>
                </div>
            </div>
        </div>
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                if (ctxBar) {
                    new Chart(ctxBar.getContext('2d'), {
                        type: 'bar',
                        data: {
                            labels: <?php echo json_encode($monthsList ?? ['Month 1', 'Month 2', 'Month 3') ?>,
                            datasets: [
                                {
                                    label: 'Fee Collected (PKR)',
                                    data: <?php echo json_encode($monthlyCollectedData ?? [0, 0, 0) ?>,
                                ...
                                },
                                {
                                    ...
                                    data: <?php echo json_encode($monthlyUnpaidData ?? [0, 0, 0) ?>,
                ...
                if (ctxDonut) {
                    new Chart(ctxDonut.getContext('2d'), {
                        ...
                        data: {
                            ...
                            datasets: [{
                                data: [<?php echo e($paidCount ?? 0); ?>, <?php echo e($unpaidCount ?? 0); ?>],
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="liquid-glass-card p-6 flex flex-col gap-4 relative overflow-hidden group hover:border-indigo-300 hover:shadow-md transition duration-200">
            <div class="flex justify-between items-start">
                ...
                <span class="badge badge-indigo text-xs font-bold">
                    <?php echo e($todaySlots->count()); ?> <?php echo e(Str::plural('Class', $todaySlots->count())); ?>
            ...
            <div class="mt-auto pt-4 border-t border-slate-200/80 flex flex-col gap-2.5">
                <?php $__empty_1 = true; $__currentLoopData = $todaySlots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $todaySlot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="flex items-center justify-between text-xs text-slate-800 bg-slate-50/90 hover:bg-indigo-50/50 p-3 rounded-xl border border-slate-200/85 hover:border-indigo-200/80 transition">
                        <span class="flex items-center gap-1.5 text-indigo-600 font-bold">
                            <i class="fa-regular fa-clock text-indigo-500"></i> <?php echo e($todaySlot['start_time']); ?>

                        </span>
                        <div class="text-right">
                            <span class="font-extrabold text-slate-900 block"><?php echo e($todaySlot['subject_name']); ?></span>
                            <span class="text-[11px] text-slate-500 font-bold flex items-center justify-end gap-1">
                                <i class="fa-solid fa-chalkboard text-slate-400 text-[10px]"></i> <?php echo e($todaySlot['section_name']); ?>
                ...
                <div class="pt-2 flex items-center gap-2">
                    ...
                    <a href="<?php echo e(auth()->user()->staffUrl('schedule')); ?>" title="Open Full Screen Schedule" class="px-3.5 py-2.5 rounded-xl btn-secondary text-xs font-bold">
        ...
        <?php if(auth()->user()->hasPermission('assessment_engine') || auth()->user()->hasPermission('lms_content')): ?>
            <div class="liquid-glass-card p-6 flex flex-col gap-4 relative overflow-hidden group hover:border-amber-500/40 hover:shadow-md transition duration-200">
                ...
                <div class="mt-auto pt-4 border-t border-slate-200/80">
                    <a href="<?php echo e(route('lms.assessments.index')); ?>" class="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl btn-secondary text-xs font-bold">
                        <i class="fa-solid fa-check-double text-[11px]"></i>
                        <span>Grade Submissions</span>
                    </a>
                </div>
            </div>
        <?php elseif(auth()->user()->hasPermission('invoices') || auth()->user()->hasPermission('accounts')): ?>
            <div class="liquid-glass-card p-6 flex flex-col gap-4 relative overflow-hidden group hover:border-emerald-500/40 hover:shadow-md transition duration-300">
                ...
                <div class="mt-auto pt-4 border-t border-slate-200/80 flex gap-2">
                    <a href="<?php echo e(auth()->user()->staffUrl('invoices')); ?>" class="flex-1 inline-flex items-center justify-center gap-2 px-3.5 py-2.5 rounded-xl btn-success text-xs font-bold">
                        <i class="fa-solid fa-receipt text-[11px]"></i>
                        <span>Fee Invoices</span>
                    </a>
                    <a href="<?php echo e(auth()->user()->staffUrl('accounts')); ?>" class="inline-flex items-center justify-center px-3.5 py-2.5 rounded-xl btn-secondary text-xs font-bold">
        ...
        <?php if(auth()->user()->hasPermission('attendance')): ?>
            <div class="liquid-glass-card p-6 flex flex-col gap-4 relative overflow-hidden group hover:border-pink-500/40 hover:shadow-md transition duration-300">
                ...
                <div class="mt-auto pt-4 border-t border-slate-200/80">
                    <a href="<?php echo e(auth()->user()->staffUrl('attendance')); ?>" class="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl btn-primary text-xs font-bold">
                        <i class="fa-solid fa-play text-[11px]"></i>
                        <span>Start Roster for <?php echo e($todaySlots->first()['subject_code'] ?? 'CS-101'); ?></span>
                    </a>
                </div>
            </div>
        <?php elseif(auth()->user()->hasPermission('directory')): ?>
            <div class="liquid-glass-card p-6 flex flex-col gap-4 relative overflow-hidden group hover:border-pink-500/40 hover:shadow-md transition duration-300">
                <div class="flex justify-between items-start">
                ...
                <div class="mt-auto pt-4 border-t border-slate-200/80">
                    <a href="<?php echo e(auth()->user()->staffUrl('directory')); ?>" class="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl btn-primary text-xs font-bold">
    ...
    <?php if(auth()->user()->hasAnyDelegatedPermission()): ?>
    <div class="liquid-glass-card p-6 border border-slate-200/90 shadow-sm relative overflow-hidden">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5">
            <?php if(auth()->user()->hasPermission('student_registration', 'view')): ?>
                <a href="<?php echo e(auth()->user()->staffUrl('students/create')); ?>" class="flex items-center gap-3.5 p-3.5 rounded-xl bg-white hover:bg-slate-50/90 border border-slate-200/90 hover:border-emerald-300 transition group shadow-2xs hover:shadow-xs">
                    ...
                    <?php if(!auth()->user()->hasPermission('student_registration', 'edit')): ?>
            ...
            <?php if(auth()->user()->hasPermission('students', 'view')): ?>
                <a href="<?php echo e(auth()->user()->staffUrl('students')); ?>" class="flex items-center gap-3.5 p-3.5 rounded-xl bg-white hover:bg-slate-50/90 border border-slate-200/90 hover:border-sky-300 transition group shadow-2xs hover:shadow-xs">
            ...
            <?php if(auth()->user()->hasPermission('timetables', 'view')): ?>
                <a href="<?php echo e(auth()->user()->staffUrl('timetables')); ?>" class="flex items-center gap-3.5 p-3.5 rounded-xl bg-white hover:bg-slate-50/90 border border-slate-200/90 hover:border-indigo-300 transition group shadow-2xs hover:shadow-xs">
            ...
            <?php if(auth()->user()->hasPermission('directory', 'view')): ?>
                <a href="<?php echo e(auth()->user()->staffUrl('directory')); ?>" class="flex items-center gap-3.5 p-3.5 rounded-xl bg-white hover:bg-slate-50/90 border border-slate-200/90 hover:border-purple-300 transition group shadow-2xs hover:shadow-xs">
                    ...
                    <?php if(!auth()->user()->hasPermission('directory', 'edit')): ?>
                        <span class="ml-auto text-[10px] font-bold text-slate-500 bg-slate-100 px-2 py-0.5 rounded border border-slate-200"><i class="fa-solid fa-eye text-slate-400 mr-1"></i> View Only</span>
                    <?php endif; ?>
                </a>
            <?php endif; ?>
            ...
            <?php if(auth()->user()->hasPermission('invoices', 'view')): ?>
                <a href="<?php echo e(auth()->user()->staffUrl('invoices')); ?>" class="flex items-center gap-3.5 p-3.5 rounded-xl bg-white hover:bg-slate-50/90 border border-slate-200/90 hover:border-amber-300 transition group shadow-2xs hover:shadow-xs">
                    ...
                    <?php if(!auth()->user()->hasPermission('invoices', 'edit')): ?>
                        <span class="ml-auto text-[10px] font-bold text-slate-500 bg-slate-100 px-2 py-0.5 rounded border border-slate-200"><i class="fa-solid fa-eye text-slate-400 mr-1"></i> View Only</span>
                    <?php endif; ?>
                </a>
            <?php endif; ?>

            <?php if(auth()->user()->hasPermission('scholarships', 'view')): ?>
                <a href="<?php echo e(auth()->user()->staffUrl('scholarships')); ?>" class="flex items-center gap-3.5 p-3.5 rounded-xl bg-white hover:bg-slate-50/90 border border-slate-200/90 hover:border-pink-300 transition group shadow-2xs hover:shadow-xs">
            ...
            <?php if(auth()->user()->hasPermission('rooms', 'view')): ?>
                <a href="<?php echo e(auth()->user()->staffUrl('rooms')); ?>" class="flex items-center gap-3.5 p-3.5 rounded-xl bg-white hover:bg-slate-50/90 border border-slate-200/90 hover:border-teal-300 transition group shadow-2xs hover:shadow-xs">
                    ...
                    <?php if(!auth()->user()->hasPermission('rooms', 'edit')): ?>
                        <span class="ml-auto text-[10px] font-bold text-slate-500 bg-slate-100 px-2 py-0.5 rounded border border-slate-200"><i class="fa-solid fa-eye text-slate-400 mr-1"></i> View Only</span>
                    <?php endif; ?>
                </a>
            <?php endif; ?>

            <?php if(auth()->user()->hasPermission('classes', 'view') || auth()->user()->hasPermission('subjects', 'view')): ?>
                <a href="<?php echo e(auth()->user()->staffUrl('classes-subjects')); ?>" class="flex items-center gap-3.5 p-3.5 rounded-xl bg-white hover:bg-slate-50/90 border border-slate-200/90 hover:border-violet-300 transition group shadow-2xs hover:shadow-xs">
                    ...
                    <?php if(!auth()->user()->hasPermission('classes', 'edit') && !auth()->user()->hasPermission('subjects', 'edit')): ?>
                        <span class="ml-auto text-[10px] font-bold text-slate-500 bg-slate-100 px-2 py-0.5 rounded border border-slate-200"><i class="fa-solid fa-eye text-slate-400 mr-1"></i> View Only</span>
                    <?php endif; ?>
                </a>
            <?php endif; ?>

            <?php if(auth()->user()->hasPermission('accounts', 'view') || auth()->user()->hasPermission('staff_salaries', 'view')): ?>
                <a href="<?php echo e(auth()->user()->staffUrl('accounts')); ?>" class="flex items-center gap-3.5 p-3.5 rounded-xl bg-white hover:bg-slate-50/90 border border-slate-200/90 hover:border-emerald-300 transition group shadow-2xs hover:shadow-xs">
                    <div class="w-10 h-10 rounded-xl bg-emerald-50 text-emerald-600 border border-emerald-200/70 flex items-center justify-center text-sm group-hover:scale-105 transition">
                        <i class="fa-solid fa-calculator"></i>
                    </div>
                    <div>
                    ...
                    <?php if(!auth()->user()->hasPermission('accounts', 'edit') && !auth()->user()->hasPermission('staff_salaries', 'edit')): ?>
                        <span class="ml-auto text-[10px] font-bold text-slate-500 bg-slate-100 px-2 py-0.5 rounded border border-slate-200"><i class="fa-solid fa-eye text-slate-400 mr-1"></i> View Only</span>
                    <?php endif; ?>
                </a>
            <?php endif; ?>
            ...
            <?php if(auth()->user()->hasPermission('staff', 'view')): ?>
                <a href="<?php echo e(auth()->user()->staffUrl('staff')); ?>" class="flex items-center gap-3.5 p-3.5 rounded-xl bg-white hover:bg-slate-50/90 border border-slate-200/90 hover:border-cyan-300 transition group shadow-2xs hover:shadow-xs">
                    ...
                    <?php if(!auth()->user()->hasPermission('staff', 'edit')): ?>
                        <span class="ml-auto text-[10px] font-bold text-slate-500 bg-slate-100 px-2 py-0.5 rounded border border-slate-200"><i class="fa-solid fa-eye text-slate-400 mr-1"></i> View Only</span>
                    <?php endif; ?>
                </a>
            <?php endif; ?>

            <?php if(auth()->user()->hasPermission('security', 'view')): ?>
                <a href="<?php echo e(auth()->user()->staffUrl('password-resets')); ?>" class="flex items-center gap-3.5 p-3.5 rounded-xl bg-white hover:bg-slate-50/90 border border-slate-200/90 hover:border-rose-300 transition group shadow-2xs hover:shadow-xs">
                    ...
                    <?php if(!auth()->user()->hasPermission('security', 'edit')): ?>
                        <span class="ml-auto text-[10px] font-bold text-slate-500 bg-slate-100 px-2 py-0.5 rounded border border-slate-200"><i class="fa-solid fa-eye text-slate-400 mr-1"></i> View Only</span>
                    <?php endif; ?>
                </a>
            <?php endif; ?>
    ...
    <div class="liquid-glass-card max-w-6xl w-full max-h-[92vh] overflow-y-auto p-6 md:p-8 relative bg-white border border-slate-200 shadow-2xl rounded-2xl">
        ...
        <div class="overflow-x-auto">
            <div class="min-w-[850px]">
                ...
                <?php $__currentLoopData = $timeSlotsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tSlot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                        $rowTimeRange = $tSlot;
                    ...
                    <div class="grid grid-cols-6 gap-3 mb-3">
                        <div class="text-xs text-pink-700 font-mono font-bold text-center flex flex-col items-center justify-center bg-pink-50/80 rounded-xl border border-pink-200/70 p-3 shadow-2xs">
                            ...
                            <span class="text-[11px] font-extrabold text-slate-900 leading-tight"><?php echo e($rowTimeRange); ?></span>
                        </div>
                        <?php $__currentLoopData = $daysOfWeek; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $cell = $weeklyGrid[$tSlot][$day] ?? null; ?>
                            <?php if($cell): ?>
                                <div class="bg-white border border-slate-200/90 hover:border-pink-300 rounded-xl p-3.5 text-left shadow-2xs hover:shadow-xs transition flex flex-col justify-between space-y-2">
                                    <div class="text-xs font-extrabold text-slate-900 truncate">
                                        <?php echo e($cell['subject_name']); ?>

                                        <span class="text-pink-600 text-[10.5px] font-bold">(<?php echo e($cell['subject_code']); ?>)</span>
                                    </div>
                                    ...
                                    <div class="text-[11px] font-extrabold text-indigo-700 flex items-center gap-1.5 bg-indigo-50 px-2.5 py-1 rounded-lg border border-indigo-200/60">
                                        ...
                                        <span class="truncate"><?php echo e($cell['section_name']); ?></span>
                                    </div>
                                    ...
                                    <div class="text-[11px] font-bold text-slate-600 flex items-center gap-1.5 bg-slate-100/80 px-2.5 py-1 rounded-lg border border-slate-200/70">
                                        ...
                                        <span class="truncate"><?php echo e($cell['room_name']); ?></span>
                                    </div>
                                </div>
                            <?php else: ?>
        ...
        <div class="mt-6 pt-4 border-t border-slate-200 flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                <a href="<?php echo e(route('teacher.schedule')); ?>" class="btn-primary px-4 py-2 text-xs font-bold flex items-center gap-1.5">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\UPLYFT\uplifyt\resources\views\teacher\dashboard.blade.php ENDPATH**/ ?>