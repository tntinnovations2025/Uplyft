...
<?php $__env->startSection('page-header', 'Teacher Schedule'); ?>
    ...
    <div class="liquid-glass-card p-6 bg-gradient-to-r from-pink-500/[0.06] via-purple-500/[0.04] to-indigo-500/[0.06] border border-slate-200/90 flex flex-col md:flex-row md:items-center justify-between gap-4 relative overflow-hidden glass-specular-top">
        ...
        <div class="flex items-center gap-3">
            <span class="badge badge-indigo text-xs font-bold">
                <i class="fa-solid fa-graduation-cap"></i> <?php echo e($activeTerm->name ?? 'Active Session'); ?>
                        ...
                        <?php $__currentLoopData = $daysOfWeek; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php if($cell): ?>
                                ...
                                <div class="bg-white border border-slate-200/90 hover:border-pink-300 rounded-xl p-3.5 text-left shadow-2xs hover:shadow-xs transition duration-200 flex flex-col justify-between space-y-2">
                                    ...
                                    <div class="text-[11px] font-extrabold <?php echo e($badgeStyle); ?> flex items-center gap-1.5 px-2.5 py-1 rounded-lg border">
        ...
        <div class="space-y-6">
            <?php $__currentLoopData = $daysOfWeek; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="bg-slate-50/80 border border-slate-200/80 rounded-2xl p-5 space-y-4">
                    ...
                    <?php if($daySlots->isEmpty()): ?>
                        <div class="py-6 text-center text-xs text-slate-500 italic">No assigned classes scheduled for <?php echo e(ucfirst($day)); ?>.</div>
                    <?php else: ?>
                        <div class="space-y-3">
                            <?php $__currentLoopData = $daySlots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slotItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                <div class="bg-white border border-slate-200/90 hover:border-pink-300 rounded-xl p-4 transition shadow-2xs">
                                    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-2">
                                        <div class="flex items-center gap-3">
                                            <span class="px-3 py-1 rounded-lg bg-pink-50 text-pink-700 font-mono text-xs font-bold border border-pink-200/70 flex items-center gap-1.5">
                                                ...
                                                <span><?php echo e($slotItem['time_range'] ?? $slotItem['start_time']); ?></span>
                                            </span>
                                            <span class="text-xs font-extrabold text-slate-900"><?php echo e($slotItem['subject_code']); ?> — <?php echo e($slotItem['subject_name']); ?></span>
                                        </div>
                                        ...
                                        <div class="flex items-center gap-2">
                                            ...
                                            <span class="badge badge-indigo text-xs font-bold">
                                                ...
                                                <span><?php echo e($slotItem['section_name']); ?></span>
                                            </span>
                                            <span class="badge badge-emerald text-xs font-bold">
                                                <i class="fa-solid fa-door-open"></i>
                                                <span><?php echo e($slotItem['room_name']); ?></span>
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="w-full bg-slate-100 h-2.5 rounded-full overflow-hidden my-2.5 border border-slate-200 shadow-inner">
                                        <div class="h-full bg-gradient-to-r from-[#fd1d1d] via-[#e1306c] to-[#833ab4] rounded-full transition-all duration-500" style="width: <?php echo e($barWidthPercent); ?>%;"></div>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\UPLYFT\uplifyt\resources\views\teacher\schedule.blade.php ENDPATH**/ ?>