<?php $__env->startSection('breadcrumb', 'Campuses'); ?>
<?php $__env->startSection('title', 'Registered Campuses'); ?>
...
<div class="page-header" style="display:flex;align-items:center;justify-content:space-between;margin-bottom:20px">
    ...
    <a href="<?php echo e(route('global-admin.institutes.create')); ?>" class="btn btn-primary" style="padding:8px 16px;font-size:12.5px">
...
<div class="card" style="padding:0;overflow:hidden;border-radius:14px;box-shadow:0 1px 3px rgba(15,23,42,0.04)">
    <table class="campuses-table">
        ...
        <tbody>
            ...
            <tr style="<?php echo e($inst->trashed() ? 'opacity:.6;background:#fef2f2;' : (!$inst->is_active ? 'background:#fffbeb;' : '')); ?>">
                <td style="color:#64748b;font-weight:700;text-align:center;font-size:12px"><?php echo e($inst->id); ?></td>
                
                
                <td>
                    <div style="display:flex;align-items:center;gap:10px">
                        <?php if($inst->logo_path): ?>
                            <img src="<?php echo e(asset('storage/'.$inst->logo_path)); ?>" alt="<?php echo e($inst->name); ?>" style="height:34px;width:34px;object-fit:contain;border-radius:8px;background:#F9F8F5;padding:2px;border:1px solid #E1DFD7;flex-shrink:0" />
                        <?php elseif($inst->icon_path): ?>
                            <img src="<?php echo e(asset('storage/'.$inst->icon_path)); ?>" alt="<?php echo e($inst->name); ?>" style="height:34px;width:34px;object-fit:cover;border-radius:50%;background:#F9F8F5;padding:1px;border:2px solid #D48A2E;flex-shrink:0" />
                        <?php else: ?>
                            <div style="width:34px;height:34px;border-radius:8px;background:#D48A2E;color:#1A1200;display:flex;align-items:center;justify-content:center;font-weight:800;font-size:14px;flex-shrink:0">
                                <?php echo e($inst->display_initial); ?>
                        ...
                        <div style="min-width:0">
                            <div style="font-weight:700;color:var(--text-primary);font-size:13.5px;display:flex;align-items:center;gap:5px;flex-wrap:wrap">
                                <span><?php echo e($inst->name); ?></span>
                                <?php if($inst->logo_path || $inst->icon_path): ?>
                            ...
                            <div style="font-size:11.5px;color:var(--text-secondary);font-weight:500;margin-top:2px;display:flex;align-items:center;gap:6px;flex-wrap:wrap">
                                <span><?php echo e($inst->city ?? 'Main Campus'); ?></span>
                                <?php if($inst->organization): ?>
                                    <a href="<?php echo e(route('global-admin.organizations.edit', $inst->organization)); ?>" style="font-size:10.5px;background:#F8E9D3;color:#8A5A10;padding:1px 6px;border-radius:5px;font-weight:600;text-decoration:none" title="Member of <?php echo e($inst->organization->name); ?>">
                                        <?php echo e($inst->organization->name); ?>
                ...
                <td>
                    <?php $instPrincipal = $inst->principals->first(); ?>
                    <?php if($instPrincipal): ?>
                        <div style="display:flex;flex-direction:column;gap:1px">
                            <div style="font-weight:700;color:var(--text-primary);font-size:13px">
                                <?php echo e($instPrincipal->name); ?>

                            </div>
                            <div style="font-size:11px;color:#8A5A10;font-weight:500;overflow:hidden;text-overflow:ellipsis;white-space:nowrap" title="<?php echo e($instPrincipal->email); ?>">
                                <?php echo e($instPrincipal->email); ?>

                            </div>
                            <?php if($instPrincipal->identifier): ?>
                                <div style="font-size:10px;color:var(--text-faint);font-weight:600;font-family:monospace">
                                    ID: <?php echo e($instPrincipal->identifier); ?>
                    ...
                    <?php else: ?>
                        <div style="display:flex;flex-direction:column;gap:2px">
                            ...
                            <a href="<?php echo e(route('global-admin.accounts.principals.create')); ?>?institute_id=<?php echo e($inst->id); ?>" style="font-size:10.5px;color:#8A5A10;font-weight:700;text-decoration:none">
                                + Create Principal
                            </a>
                        </div>
                    <?php endif; ?>
                ...
                <td>
                    <div style="display:flex;flex-direction:column;gap:4px">
                        <div style="display:flex;align-items:center;gap:6px;flex-wrap:wrap">
                            <span class="badge <?php echo e($inst->subscription_tier === 'premium' ? 'badge-amber' : ($inst->subscription_tier === 'standard' ? 'badge-amber' : 'badge-neutral')); ?>" style="font-size:10px;padding:2px 7px">
                                <?php echo e(ucfirst($inst->subscription_tier)); ?>

                            </span>
                            <?php if($inst->trashed()): ?>
                                <span class="badge badge-danger" style="font-size:10px;padding:2px 7px">Deleted</span>
                            <?php elseif($inst->is_active): ?>
                        ...
                        <div style="font-size:11px;color:var(--text-faint);font-weight:500;line-height:1.3">
                            <span><?php echo e($inst->subscription_expires_at?->format('d M Y') ?? 'Perpetual'); ?></span>
                            <?php if($inst->featureToggles): ?>
                                <span> &bull; <?php echo e(collect(\App\Models\InstituteFeatureToggle::$featureKeys)->filter(fn($k) => $inst->featureToggles->$k)->count()); ?> Modules ON</span>
                            <?php endif; ?>
                        </div>
                    </div>
                </td>
                ...
                <td style="text-align:right">
                    <div class="action-btn-group">
                        <?php if($inst->trashed()): ?>
                            ...
                            <form method="POST" action="<?php echo e(route('global-admin.institutes.restore', $inst->id)); ?>" style="display:inline">
                                <?php echo csrf_field(); ?>
                                <button class="act-btn act-btn-success" type="submit" title="Restore Institute and Reactivate Portals">
                                    <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'arrows-rotate','class' => 'w-3 h-3']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'arrows-rotate','class' => 'w-3 h-3']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalce262628e3a8d44dc38fd1f3965181bc)): ?>
<?php $attributes = $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
...
<?php endif; ?>
                            ...
                            <form method="POST" action="<?php echo e(route('global-admin.institutes.purge', $inst->id)); ?>" onsubmit="return confirm('Permanently wipe <?php echo e(addslashes($inst->name)); ?> and ALL linked data, users, and portals? This cannot be undone.');" style="display:inline">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('DELETE'); ?>
                        ...
                        <?php else: ?>
                            ...
                            <a href="<?php echo e(route('global-admin.institutes.show', $inst)); ?>" class="act-btn act-btn-ghost" title="View details">
                                <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'magnifying-glass','class' => 'w-3 h-3']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'magnifying-glass','class' => 'w-3 h-3']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalce262628e3a8d44dc38fd1f3965181bc)): ?>
<?php $attributes = $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
...
<?php endif; ?>
                            ...
                            <a href="<?php echo e(route('global-admin.institutes.edit', $inst)); ?>" class="act-btn act-btn-ghost" title="Edit details">
                                <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'pen-to-square','class' => 'w-3 h-3']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'pen-to-square','class' => 'w-3 h-3']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalce262628e3a8d44dc38fd1f3965181bc)): ?>
<?php $attributes = $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
...
<?php endif; ?>
                            ...
                            <a href="<?php echo e(route('global-admin.institutes.toggles.edit', $inst)); ?>" class="act-btn act-btn-ghost" title="Feature toggles">
                                <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
...
<?php endif; ?>
                            ...
                            <form method="POST" action="<?php echo e(route('global-admin.institutes.toggle-status', $inst)); ?>" style="display:inline">
                                <?php echo csrf_field(); ?>
                                <?php if($inst->is_active): ?>
                                    <button type="submit" class="act-btn act-btn-warning" title="Pause Services: Temporarily suspends portal access. All data is safely preserved.">
                                        <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'pause','class' => 'w-3 h-3']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'pause','class' => 'w-3 h-3']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalce262628e3a8d44dc38fd1f3965181bc)): ?>
<?php $attributes = $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
...
<?php endif; ?>
                                ...
                                <?php else: ?>
                                    <button type="submit" class="act-btn act-btn-success" title="Resume Services: Instantly restores portal access.">
                                        <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'play','class' => 'w-3 h-3']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'play','class' => 'w-3 h-3']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalce262628e3a8d44dc38fd1f3965181bc)): ?>
<?php $attributes = $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
...
<?php endif; ?>
                            ...
                            <button
                                ...
                                onclick="openDeleteModal(
                                    '<?php echo e(route('global-admin.institutes.destroy', $inst)); ?>',
                                    '<?php echo e(addslashes($inst->name)); ?>'
                                )">
                                <span>Delete</span>
                            </button>
                        <?php endif; ?>
            ...
            <tr>
                <td colspan="5" style="text-align:center;color:var(--text-muted);padding:40px">
                    No institutes registered yet. <a href="<?php echo e(route('global-admin.institutes.create')); ?>" style="color:var(--accent2)">Register one →</a>
                </td>
            </tr>
            <?php endif; ?>
        </tbody>
    </table>
    <div style="padding:14px 18px;border-top:1px solid #f1f5f9;background:#f8fafc"><?php echo e($institutes->links()); ?></div>
</div>
...
<?php echo $__env->make('global-admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\UPLYFT\uplifyt\resources\views\global-admin\institutes\index.blade.php ENDPATH**/ ?>