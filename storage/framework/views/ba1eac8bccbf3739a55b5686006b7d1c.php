...
<body>
    <div class="container">
        ...
        <div class="body">
            ...
            <?php if($processedBy): ?>
                by Administrator <strong><?php echo e($processedBy->name); ?></strong>.
            <?php else: ?>
            ...
            <div class="credential-card">
                <table>
                    <tr><td>Account Name</td><td><?php echo e($user->name); ?></td></tr>
                    <?php if($user->email): ?>
                    <tr><td>Email Address</td><td><?php echo e($user->email); ?></td></tr>
                    <?php endif; ?>
                    <?php if($user->identifier): ?>
                    <tr><td>Account Identifier</td><td><?php echo e($user->identifier); ?></td></tr>
                    <?php endif; ?>
                    <tr><td>New Password</td><td style="font-family:monospace;font-size:16px;color:#38bdf8"><?php echo e($newPassword); ?></td></tr>
                </table>
            </div>
            ...
            <div style="text-align:center;margin-top:24px">
                <a href="<?php echo e($loginUrl); ?>" class="cta">🔐 Log In To Your Portal</a>
            </div>
        </div>
        <div class="footer">
            &copy; <?php echo e(date('Y')); ?> UPLYFT Multi-Tenant Governance Platform
        </div>
    </div>
</body>
</html>
<?php /**PATH D:\UPLYFT\uplifyt\resources\views\emails\password-reset-success.blade.php ENDPATH**/ ?>