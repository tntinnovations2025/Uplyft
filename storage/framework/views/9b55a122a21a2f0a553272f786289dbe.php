...
<body>
    <div class="container">
        ...
        <div class="body">
            ...
            <p>A password reset request was recently submitted for your account (<strong><?php echo e($user->email ?? $user->identifier); ?></strong>).</p>
            ...
            <div class="otp-box">
                ...
                <div class="otp-code"><?php echo e($notification->otp); ?></div>
                <div class="otp-expiry">⏱️ Valid for 30 minutes (Expires: <?php echo e($notification->otp_expires_at ? $notification->otp_expires_at->format('h:i A') : '30 mins'); ?>)</div>
            </div>
            ...
            <div class="warning-card">
                ...
                <div style="text-align:center;margin-top:12px">
                    <a href="<?php echo e(url('/password/cancel/' . $notification->cancellation_token)); ?>" class="btn-cancel">🛑 Cancel Password Reset Request</a>
                </div>
            </div>

            <p style="font-size:12px;color:#94a3b8">If the button above does not work, copy and paste this link into your browser:<br>
            <a href="<?php echo e(url('/password/cancel/' . $notification->cancellation_token)); ?>" style="color:#38bdf8"><?php echo e(url('/password/cancel/' . $notification->cancellation_token)); ?></a></p>
        </div>
        <div class="footer">
...
<?php /**PATH D:\UPLYFT\uplifyt\resources\views\emails\password-reset-requested.blade.php ENDPATH**/ ?>