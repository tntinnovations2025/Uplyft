...
<?php $__env->startSection('title', 'Assign & Issue Fee Vouchers'); ?>
<?php $__env->startSection('breadcrumb', 'Assign Fee Vouchers'); ?>
    ...
    <form action="<?php echo e(route($routePrefix . 'store')); ?>" method="POST">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit, minmax(240px, 1fr));gap:14px;margin-bottom:24px">
            <label class="radio-option-card" id="card_all">
                <input type="radio" name="target_scope" value="all_institute" <?php echo e(old('target_scope', 'all_institute') === 'all_institute' ? 'checked' : ''); ?> onchange="updateScopeUI()" style="accent-color:#e1306c">
                <div>
            ...
            <label class="radio-option-card" id="card_class">
                <input type="radio" name="target_scope" value="class_section" <?php echo e(old('target_scope') === 'class_section' ? 'checked' : ''); ?> onchange="updateScopeUI()" style="accent-color:#e1306c">
                <div>
            ...
            <label class="radio-option-card" id="card_single">
                <input type="radio" name="target_scope" value="single_student" <?php echo e(old('target_scope') === 'single_student' ? 'checked' : ''); ?> onchange="updateScopeUI()" style="accent-color:#e1306c">
                <div>
            ...
            <select name="class_section_id" class="form-control">
                ...
                <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php $__currentLoopData = $class->sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($sec->id); ?>" <?php echo e(old('class_section_id') == $sec->id ? 'selected' : ''); ?>>
                            📚 <?php echo e($clsName); ?> — Section <?php echo e($sec->section_name ?? $sec->name); ?>
        ...
        <div id="section_student_wrapper" class="form-group mb-4" style="display:none">
            ...
            <select name="student_id" id="select_student_id" class="form-control" onchange="onStudentSelectChange(this)">
                ...
                <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($st->id); ?>" data-base-fee="<?php echo e($st->base_fee ?? 50000); ?>" <?php echo e(old('student_id') == $st->id ? 'selected' : ''); ?>>
                        <?php echo e($st->full_name); ?> (<?php echo e($st->roll_number); ?>) — 
                        <?php if($st->classSection && $st->classSection->instituteClass): ?>
                            <?php echo e($st->classSection->instituteClass->name); ?> (Sec <?php echo e($st->classSection->section_name ?? $st->classSection->name); ?>)
                        <?php else: ?>
                            <?php echo e($st->enrolled_program ?? 'General'); ?>

                        <?php endif; ?>
                        [Default Fee: PKR <?php echo e(number_format($st->base_fee ?? 50000, 2)); ?>]
                    </option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </div>
        ...
        <div class="form-grid mb-4">
                    ...
                    <div>
                        ...
                        <select name="from_month" class="form-control" required>
                            <?php $__currentLoopData = $monthsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($m); ?>" <?php echo e(old('from_month', 'June') === $m ? 'selected' : ''); ?>><?php echo e($m); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div>
                        ...
                        <select name="to_month" class="form-control" required>
                            <?php $__currentLoopData = $monthsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($m); ?>" <?php echo e(old('to_month', 'September') === $m ? 'selected' : ''); ?>><?php echo e($m); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div>
                        ...
                        <select name="fee_year" class="form-control" required>
                            <?php $__currentLoopData = $yearsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $y): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($y); ?>" <?php echo e(old('fee_year', now()->year) == $y ? 'selected' : ''); ?>><?php echo e($y); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                </div>
            ...
            <div class="form-group" style="margin-top:16px">
                ...
                <input type="text" name="title" class="form-control" value="<?php echo e(old('title', 'Monthly Tuition & Academic Fee')); ?>" required placeholder="e.g., Monthly Tuition Fee Voucher">
            </div>
        </div>
        ...
        <div class="form-grid form-grid-2 mb-4">
            <div class="form-group">
                ...
                <input type="number" step="0.01" name="base_fee" id="base_fee_input" class="form-control" value="<?php echo e(old('base_fee', 50000)); ?>" placeholder="e.g. 50000" required>
            ...
            <div class="form-group">
                ...
                <input type="date" name="due_date" class="form-control" value="<?php echo e(old('due_date', now()->addDays(10)->format('Y-m-d'))); ?>" required>
            </div>
        </div>

        <div style="margin-top:32px;display:flex;justify-content:flex-end;gap:12px">
            <a href="<?php echo e(route($routePrefix . 'index')); ?>" class="btn btn-ghost">Cancel</a>
...
<?php echo $__env->make(auth()->check() && !auth()->user()->isPrincipal() && !auth()->user()->isGlobalAdmin() ? 'layouts.app' : 'principal.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\UPLYFT\uplifyt\resources\views\principal\invoices\create.blade.php ENDPATH**/ ?>