...
<?php $__env->startSection('title', 'Faculty Profile: ' . $teacher->full_name); ?>
<?php $__env->startSection('breadcrumb', 'Faculty Profile & Salary Ledger'); ?>
...
<div class="profile-header-card">
    <div style="display:flex;align-items:center;gap:20px">
        <?php if($teacher->profile_picture_path): ?>
            <img src="<?php echo e(Storage::url($teacher->profile_picture_path)); ?>" class="hero-avatar" alt="<?php echo e($teacher->full_name); ?>" style="object-fit:cover">
        <?php else: ?>
        ...
        <div>
            ...
            <div style="font-size:13px;color:#0284c7;font-weight:700;margin-top:4px;display:flex;gap:12px;align-items:center">
                <span class="badge badge-blue">Employee ID: <?php echo e($teacher->employee_id ?? 'EMP-' . $teacher->id); ?></span>
                <span>🎓 <?php echo e($teacher->qualification ?? 'Faculty Member'); ?></span>
            </div>
        </div>
    </div>
    ...
    <div style="display:flex;gap:12px">
        <?php if(auth()->check() && auth()->user()->hasPermission('profile_edit', 'edit')): ?>
            <a href="<?php echo e(route($routePrefix . 'teacher.edit', $teacher)); ?>" class="btn btn-primary">
...
<div class="card mb-6">
    ...
    <div class="detail-grid detail-grid-3 mb-4">
        <div class="info-box">
            ...
            <div class="info-val"><?php echo e($teacher->full_name); ?></div>
        </div>
        <div class="info-box">
            <div class="info-label">Email Address</div>
            <div class="info-val"><?php echo e($teacher->email); ?></div>
        </div>
        <div class="info-box">
            <div class="info-label">Phone Number</div>
            <div class="info-val"><?php echo e($teacher->phone ?? 'N/A'); ?></div>
        </div>
        <div class="info-box">
            <div class="info-label">Highest Qualification</div>
            <div class="info-val"><?php echo e($teacher->qualification ?? 'N/A'); ?></div>
        </div>
        <div class="info-box">
            <div class="info-label">Teaching Experience</div>
            <div class="info-val"><?php echo e($teacher->years_of_experience ? $teacher->years_of_experience . ' Years' : 'N/A'); ?></div>
        </div>
        <div class="info-box">
            <div class="info-label">Monthly Basic Salary</div>
            <div class="info-val" style="color:#059669">PKR <?php echo e(number_format($teacher->basic_salary_pkr ?? 0)); ?></div>
        </div>
    </div>

    <?php if($teacher->emergency_contact_phone): ?>
        <div class="info-box">
            <div class="info-label">Emergency Contact Phone</div>
            <div class="info-val" style="color:#d97706"><?php echo e($teacher->emergency_contact_phone); ?></div>
        </div>
    <?php endif; ?>
</div>
...
<div class="card mb-6" style="border-color:rgba(56,189,248,0.3)">
    ...
    <div class="detail-grid detail-grid-3 mb-2">
        <div class="info-box">
            ...
            <div style="margin-top:6px">
                <?php if($teacher->matriculation_cert): ?>
                    <a href="<?php echo e(Storage::url($teacher->matriculation_cert)); ?>" target="_blank" class="btn btn-ghost btn-sm" style="color:#0284c7;border-color:#bae6fd;background:#f0f9ff">
                        📄 View Matric Result
                    </a>
                <?php else: ?>
        ...
        <div class="info-box">
            ...
            <div style="margin-top:6px">
                <?php if($teacher->intermediate_cert): ?>
                    <a href="<?php echo e(Storage::url($teacher->intermediate_cert)); ?>" target="_blank" class="btn btn-ghost btn-sm" style="color:#0284c7;border-color:#bae6fd;background:#f0f9ff">
                        📄 View Inter Result
                    </a>
                <?php else: ?>
                    <span style="font-size:12px;color:#64748b">Not Uploaded</span>
        ...
        <div class="info-box">
            ...
            <div style="margin-top:6px">
                <?php if($teacher->bachelors_cert): ?>
                    <a href="<?php echo e(Storage::url($teacher->bachelors_cert)); ?>" target="_blank" class="btn btn-ghost btn-sm" style="color:#0284c7;border-color:#bae6fd;background:#f0f9ff">
    ...
    <?php if($teacher->masters_cert || $teacher->phd_cert): ?>
        <div class="detail-grid detail-grid-2" style="margin-top:12px">
            <?php if($teacher->masters_cert): ?>
                <div class="info-box">
                    <div class="info-label">MS / M.Phil Result Certificate</div>
                    <div style="margin-top:6px">
                        <a href="<?php echo e(Storage::url($teacher->masters_cert)); ?>" target="_blank" class="btn btn-ghost btn-sm" style="color:#0284c7;border-color:#bae6fd;background:#f0f9ff">
                            🔬 View MS Result
                        </a>
                    </div>
                </div>
            ...
            <?php if($teacher->phd_cert): ?>
                <div class="info-box">
                    <div class="info-label">PhD Degree / Certificate</div>
                    <div style="margin-top:6px">
                        <a href="<?php echo e(Storage::url($teacher->phd_cert)); ?>" target="_blank" class="btn btn-ghost btn-sm" style="color:#0284c7;border-color:#bae6fd;background:#f0f9ff">
                            🎓 View PhD Degree
                        </a>
                    </div>
                </div>
...
<div class="card mb-6" style="border-color:rgba(16,185,129,0.3)">
    ...
    <form action="<?php echo e(route($routePrefix . 'teacher.salary-slips.store', $teacher->id)); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div class="detail-grid detail-grid-3 mb-4">
            ...
            <div>
                ...
                <input type="number" name="amount" step="500" class="form-control" value="<?php echo e($teacher->basic_salary_pkr); ?>" placeholder="Amount in PKR">
            </div>
        </div>
...
<div class="card">
    <div class="card-header">
        ...
        <span class="badge badge-green"><?php echo e($teacher->salarySlips->count()); ?> Records Uploaded</span>
    </div>

    <?php if($teacher->salarySlips->isEmpty()): ?>
        <div style="padding:24px;text-align:center;color:#64748b;background:#f8fafc;border-radius:12px;border:1px dashed #cbd5e1">
            No salary slips or payment screenshots uploaded yet for <?php echo e($teacher->full_name); ?>.
        </div>
    <?php else: ?>
        <div>
            <?php $__currentLoopData = $teacher->salarySlips; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="slip-card">
                    <div style="display:flex;align-items:center;gap:16px">
                        ...
                        <div>
                            <div style="font-family:'Outfit',sans-serif;font-weight:800;font-size:16px;color:#0f172a">
                                <?php echo e($slip->title); ?>

                            </div>
                            <div style="font-size:12px;color:#64748b;margin-top:2px;display:flex;gap:12px;font-weight:500">
                                <span>📅 <?php echo e($slip->month_year); ?></span>
                                <?php if($slip->amount): ?>
                                    <span style="color:#059669;font-weight:700">💵 PKR <?php echo e(number_format($slip->amount)); ?></span>
                                <?php endif; ?>
                                <span>🕒 Uploaded <?php echo e($slip->created_at->format('d M, Y (h:i A)')); ?></span>
                            </div>
                            <?php if($slip->notes): ?>
                    ...
                    <div style="display:flex;align-items:center;gap:12px">
                        <a href="<?php echo e(Storage::url($slip->file_path)); ?>" target="_blank" class="btn btn-ghost btn-sm" style="color:#0284c7;border-color:#bae6fd;background:#f0f9ff">
                            👁️ View / Download File
                        </a>

                        <form action="<?php echo e(route($routePrefix . 'salary-slips.destroy', $slip->id)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this salary slip?')">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make(auth()->check() && !auth()->user()->isPrincipal() && !auth()->user()->isGlobalAdmin() ? 'layouts.app' : 'principal.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\UPLYFT\uplifyt\resources\views\principal\directory\teacher-show.blade.php ENDPATH**/ ?>