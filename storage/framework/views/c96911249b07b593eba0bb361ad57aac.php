<?php $__env->startSection('title', 'Onboard Faculty & Staff'); ?>
<?php $__env->startSection('breadcrumb', 'Onboard Faculty & Staff'); ?>
...
<div class="onboard-container">
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:24px;flex-wrap:wrap;gap:12px">
        ...
        <a href="<?php echo e(route('principal.staff.index')); ?>" class="btn btn-ghost">
            👥 View Staff Roster &rarr;
        </a>
    </div>

    <div class="onboard-card">
        <form method="POST" action="<?php echo e(route('principal.staff.store')); ?>" enctype="multipart/form-data" autocomplete="off">
            <?php echo csrf_field(); ?>
...
$message = $__bag->first($__errorArgs[0]); ?><span style="font-size:12px;color:#dc2626;margin-top:4px;display:block;font-weight:700"><?php echo e($message); ?></span><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="name" required placeholder="e.g. Dr. Ahmed Hassan" value="<?php echo e(old('name')); ?>" class="form-input">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="email" name="email" required placeholder="ahmed.hassan@school.edu.pk" value="<?php echo e(old('email')); ?>" class="form-input" autocomplete="off" spellcheck="false">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <div style="display:flex;gap:6px">
                        ...
                        <input type="text" id="staff_phone" name="phone" class="form-input" value="<?php echo e(old('phone')); ?>" placeholder="3001234567" maxlength="10" oninput="formatStaffPhoneInput()">
                    </div>
                ...
                <div>
                    ...
                    <input type="number" name="basic_salary_pkr" step="500" placeholder="e.g. 75000" value="<?php echo e(old('basic_salary_pkr')); ?>" class="form-input">
                </div>
                ...
                <div class="full-width">
                    <label class="form-label" style="display:flex;align-items:center;justify-content:space-between">
                        ...
                        <a href="<?php echo e(route('principal.staff.authorities')); ?>" target="_blank" style="font-size:11.5px;color:#4f46e5;text-decoration:none;font-weight:700">
                    ...
                    <div class="role-tile-grid">
                        ...
                        <?php $__currentLoopData = $rolesList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $rAuth): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                ...
                                $isFirst = ($idx === 0);
                            ?>
                            <label class="role-tile <?php echo e($isFirst ? 'selected' : ''); ?>" id="tile-<?php echo e($rSlug); ?>" onclick="selectRole('<?php echo e($rSlug); ?>')">
                                <input type="radio" name="role_option" value="<?php echo e($rSlug); ?>" <?php echo e($isFirst ? 'checked' : ''); ?>>
                                <div style="font-size:24px;margin-bottom:2px"><?php echo e($rIcon); ?></div>
                                <div class="role-name-text"><?php echo e($rName); ?></div>
                            </label>
                ...
                <div class="full-width section-box" id="customRoleRow" style="display:none;background:#f0fdf4;border:1.5px solid #a7f3d0">
                    ...
                    <input type="text" name="custom_role_name" id="custom_role_name" placeholder="e.g. Lab Assistant, Librarian, Vice Principal..." value="<?php echo e(old('custom_role_name')); ?>" class="form-input">
                    ...
                    <?php $__errorArgs = ['custom_role_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><span style="font-size:12px;color:#dc2626;margin-top:4px;display:block;font-weight:700"><?php echo e($message); ?></span><?php unset($message);
                ...
                <div class="full-width section-box" style="background:#f0f9ff;border:1.5px solid #bae6fd">
                    ...
                    <div class="form-grid">
                        <div>
                            ...
                            <?php $__errorArgs = ['matriculation_cert'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><span style="font-size:12px;color:#dc2626;margin-top:4px;display:block;font-weight:700"><?php echo e($message); ?></span><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <?php $__errorArgs = ['intermediate_cert'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><span style="font-size:12px;color:#dc2626;margin-top:4px;display:block;font-weight:700"><?php echo e($message); ?></span><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="full-width">
                            ...
                            <?php $__errorArgs = ['bachelors_cert'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><span style="font-size:12px;color:#dc2626;margin-top:4px;display:block;font-weight:700"><?php echo e($message); ?></span><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="identifier" placeholder="e.g. EMP-2026-0001" value="<?php echo e(old('identifier', $autoEmployeeId ?? '')); ?>" class="form-input" style="font-family:monospace;font-weight:800;color:#312e81;background:#eef2ff;border:1.5px solid #c7d2fe">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div style="display:flex;justify-content:flex-end;gap:12px;margin-top:28px">
                <a href="<?php echo e(route('principal.staff.index')); ?>" class="btn btn-ghost">Cancel</a>
...
<script>
    const rolePermissionsMap = {
        <?php $__currentLoopData = $rolesList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rAuth): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            '<?php echo e($rAuth->role_slug); ?>': <?php echo json_encode($rAuth->permissions ?? [], 15, 512) ?>,
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        'custom': {}
    };
...
<?php echo $__env->make(auth()->check() && auth()->user()->isTeacher() ? 'layouts.app' : 'principal.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\UPLYFT\uplifyt\resources\views\principal\staff\create.blade.php ENDPATH**/ ?>