<?php $__env->startSection('breadcrumb', 'Organization Networks'); ?>
<?php $__env->startSection('title', 'Registered Organization Networks'); ?>
...
<div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:24px">
    ...
    <a href="<?php echo e(route('global-admin.organizations.create')); ?>" class="btn btn-primary">
...
<div class="stat-grid" style="margin-bottom:24px">
    <div class="stat-card">
        ...
        <div class="stat-value"><?php echo e($organizations->count()); ?></div>
    </div>
    ...
    <div class="stat-card">
        ...
        <div class="stat-value"><?php echo e($organizations->sum('institutes_count')); ?></div>
    </div>
    ...
    <div class="stat-card">
        ...
        <div class="stat-value"><?php echo e($organizations->sum('max_campuses')); ?></div>
    </div>
</div>
            ...
            <tr>
                <td>
                    <div style="display:flex;align-items:center;gap:12px">
                        ...
                        <div>
                            ...
                            <div style="font-size:11.5px;color:#64748b">Registered Network #<?php echo e($org->id); ?></div>
                        </div>
                    </div>
                </td>
                ...
                <td>
                    ...
                    <div style="display:flex;flex-direction:column;gap:4px">
                        <span class="badge <?php echo e($isFull ? 'badge-amber' : 'badge-emerald'); ?>" style="width:fit-content">
                            <?php echo e($used); ?> / <?php echo e($max); ?> Campuses <?php echo e($isFull ? '(Quota Full)' : 'Used'); ?>

                        </span>
                        <div style="width:120px;height:6px;background:#e2e8f0;border-radius:999px;overflow:hidden;margin-top:2px">
                            <div style="width:<?php echo e(min(100, round(($used/$max)*100))); ?>%;height:100%;background:<?php echo e($isFull ? '#f59e0b' : '#10b981'); ?>;border-radius:999px"></div>
                        </div>
                    </div>
                </td>
                ...
                <td>
                    <div style="display:flex;flex-direction:column;gap:6px;max-width:300px">
                        <?php $__empty_2 = true; $__currentLoopData = $org->institutes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $camp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                            <?php $campPrincipal = $camp->principals->first(); ?>
                            <div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;padding:6px 10px;display:flex;flex-direction:column;gap:2px">
                                <a href="<?php echo e(route('global-admin.institutes.show', $camp)); ?>" style="font-size:12px;font-weight:800;color:#4338ca;text-decoration:none">
                                    🏫 <?php echo e($camp->name); ?>

                                </a>
                                <?php if($campPrincipal): ?>
                                    <div style="font-size:11px;color:#334155;font-weight:600">
                                        👤 Principal: <?php echo e($campPrincipal->name); ?> (<span style="color:#0284c7"><?php echo e($campPrincipal->email); ?></span>)
                                    </div>
                                <?php else: ?>
                ...
                <td style="text-align:right">
                    <div style="display:inline-flex;gap:6px;align-items:center">
                        <form method="POST" action="<?php echo e(route('global-admin.organizations.toggle-status', $org)); ?>" style="display:inline">
                            <?php echo csrf_field(); ?>
                            <?php if($org->is_active): ?>
                        ...
                        <a href="<?php echo e(route('global-admin.organizations.edit', $org)); ?>" class="btn btn-secondary btn-sm" style="font-size:11.5px;padding:4px 8px">
                            <i class="fa-solid fa-pen-to-square"></i> Edit
                        </a>

                        <form method="POST" action="<?php echo e(route('global-admin.organizations.destroy', $org)); ?>" onsubmit="return confirm('⚠️ DANGER: Deleting this Organization Network will permanently delete ALL member campuses, data, and portals linked to it. This action cannot be undone. Are you absolutely sure?');" style="display:inline">
...
<?php echo $__env->make('global-admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\UPLYFT\uplifyt\resources\views\global-admin\organizations\index.blade.php ENDPATH**/ ?>