...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title><?php echo $__env->yieldContent('title', config('app.name', 'UPLYFT Platform')); ?> - UPLYFT Academic Suite</title>
    ...
    <body class="font-sans antialiased text-ink min-h-screen relative selection:bg-amber-500 selection:text-amber-950" style="background: #EFEEEA fixed;">
        ...
        <div class="min-h-screen flex relative z-10">
            ...
            <div class="app-main-wrapper">
                    ...
                    <div class="py-3.5 px-6 lg:px-8 flex items-center justify-between gap-4">
                            ...
                            <?php else: ?>
                                ...
                                <?php else: ?>
                                    <div class="flex items-center gap-2 text-sm text-ink-secondary font-semibold">
                                        <span class="text-ink font-extrabold tracking-tight"><?php echo e(config('app.name', 'UPLYFT')); ?></span>
                                        <span>/</span>
                        ...
                        <div class="flex items-center gap-3.5">
                            ...
                            <div class="hidden sm:inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-[#E1DFD7] bg-[#F9F8F5] text-xs font-bold text-[#1B1A17]">
                                ...
                                <span><?php echo e($headerActiveTerm?->name ?? 'No Active Term'); ?></span>
                            </div>
                            <?php endif; ?>
                            ...
                            <?php if(auth()->guard()->check()): ?>
                                <div class="flex items-center gap-2.5 pl-3 border-l border-[#E1DFD7]">
                                    <div class="w-8 h-8 rounded-xl bg-[#D48A2E] border border-[#C07A22] flex items-center justify-center text-[#1A1200] text-xs font-extrabold shadow-sm relative overflow-hidden">
                                        <span class="relative z-10"><?php echo e(Auth::user()->display_initials); ?></span>
                                    </div>
                                    <div class="hidden md:block text-left">
                                        <p class="text-xs font-extrabold text-[#1B1A17] leading-tight"><?php echo e(Auth::user()->display_name); ?></p>
                                        <p class="text-[10px] text-[#68665D] leading-tight font-medium"><?php echo e(Auth::user()->display_email); ?></p>
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
                ...
                <main class="flex-1 py-6 px-6 lg:px-8 w-full max-w-7xl mx-auto">
                    ...
                    <?php if(isset($slot) && $slot instanceof \Illuminate\View\ComponentSlot): ?>
                        <?php echo e($slot); ?>
        ...
        <script>
            ...
            (function() {
                ...
                var loginUrl = '<?php echo e(url("/login")); ?>';
                <?php if(auth()->check()): ?>
                    <?php if(auth()->user()->isPrincipal()): ?>
                        loginUrl = '<?php echo e(route("principal.login")); ?>';
                    <?php elseif(auth()->user()->isGlobalAdmin()): ?>
                        loginUrl = '<?php echo e(route("global-admin.login")); ?>';
                    <?php else: ?>
...
<?php /**PATH D:\UPLYFT\uplifyt\resources\views\layouts\app.blade.php ENDPATH**/ ?>