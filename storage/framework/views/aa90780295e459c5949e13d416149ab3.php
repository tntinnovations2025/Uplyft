...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Principal Portal'); ?> — UPLYFT Academic Suite</title>
...
<body>
    ...
    <aside class="sidebar flex flex-col justify-between" style="background:#0E0E11;border-right:1px solid #2A2C30;box-shadow:none;">
        ...
        <div class="sidebar-nav-container custom-scrollbar">
            ...
            <div id="principal-main-nav" class="space-y-1.5" style="padding: 4px 6px 10px; display: <?php echo e($currentSubGroup ? 'none' : 'block'); ?>;">
...
<?php endif; ?></span>
                ...
                <button type="button" onclick="showSubNav('students')" class="sidebar-hub-card-btn <?php echo e($currentSubGroup === 'students' ? 'active' : ''); ?>">
...
<?php endif; ?></span>
                ...
                <!-- 2. Faculty & Staff Hub -->
                <button type="button" onclick="showSubNav('staff')" class="sidebar-hub-card-btn <?php echo e($currentSubGroup === 'staff' ? 'active' : ''); ?>">
                    <div class="hub-btn-left">
...
<?php endif; ?></span>
                ...
                <button type="button" onclick="showSubNav('finance')" class="sidebar-hub-card-btn <?php echo e($currentSubGroup === 'finance' ? 'active' : ''); ?>">
                    <div class="hub-btn-left">
...
<?php endif; ?></span>
                ...
                <button type="button" onclick="showSubNav('academic')" class="sidebar-hub-card-btn <?php echo e($currentSubGroup === 'academic' ? 'active' : ''); ?>">
                    <div class="hub-btn-left">
...
<?php endif; ?></span>
                ...
                <button type="button" onclick="showSubNav('ai')" class="sidebar-hub-card-btn <?php echo e($currentSubGroup === 'ai' ? 'active' : ''); ?>">
                    <div class="hub-btn-left">
...
<?php endif; ?></span>
                ...
                <button type="button" onclick="showSubNav('exams')" class="sidebar-hub-card-btn <?php echo e($currentSubGroup === 'exams' ? 'active' : ''); ?>">
                    <div class="hub-btn-left">
...
<?php endif; ?></span>
                ...
                <button type="button" onclick="showSubNav('settings')" class="sidebar-hub-card-btn <?php echo e($currentSubGroup === 'settings' ? 'active' : ''); ?>">
                    <div class="hub-btn-left">
...
<?php endif; ?></span>
                ...
                <?php if(isset($topOrg) && $topOrg && auth()->user()->isPrincipal()): ?>
                    <div style="margin-top: 10px; padding-top: 8px; border-top: 1px dashed #2A2C30;">
                        <a href="<?php echo e(route('principal.organization.campuses.create')); ?>" class="glossy-nav-item <?php echo e(request()->routeIs('principal.organization.campuses.create') ? 'active' : ''); ?>">
                            <span class="icon"><?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
...
<?php endif; ?></span>
            ...
            <div id="subnav-students" class="sidebar-subnav-panel space-y-1" style="padding: 4px 6px 10px; display: <?php echo e($currentSubGroup === 'students' ? 'block' : 'none'); ?>;">
...
<?php endif; ?></span>
            ...
            <div id="subnav-staff" class="sidebar-subnav-panel space-y-1" style="padding: 4px 6px 10px; display: <?php echo e($currentSubGroup === 'staff' ? 'block' : 'none'); ?>;">
                <div class="subnav-header">
                    <button type="button" onclick="backToDashboard()" class="subnav-back-btn">
                        <span class="subnav-back-icon"><?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
...
<?php endif; ?></span>
            ...
            <div id="subnav-finance" class="sidebar-subnav-panel space-y-1" style="padding: 4px 6px 10px; display: <?php echo e($currentSubGroup === 'finance' ? 'block' : 'none'); ?>;">
                <div class="subnav-header">
                    <button type="button" onclick="backToDashboard()" class="subnav-back-btn">
                        <span class="subnav-back-icon"><?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
...
<?php endif; ?></span>
                ...
                <?php if(Route::has('principal.accounts.index')): ?>
                    <a href="<?php echo e(route('principal.accounts.index')); ?>" class="glossy-nav-item <?php echo e((request()->routeIs('principal.accounts.*') || request()->is('principal/accounts*')) ? 'active' : ''); ?>">
                        <span class="icon"><?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
...
<?php endif; ?></span>
            ...
            <div id="subnav-academic" class="sidebar-subnav-panel space-y-1" style="padding: 4px 6px 10px; display: <?php echo e($currentSubGroup === 'academic' ? 'block' : 'none'); ?>;">
                <div class="subnav-header">
                    <button type="button" onclick="backToDashboard()" class="subnav-back-btn">
                        <span class="subnav-back-icon"><?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
...
<?php endif; ?></span>
            ...
            <div id="subnav-ai" class="sidebar-subnav-panel space-y-1" style="padding: 4px 6px 10px; display: <?php echo e($currentSubGroup === 'ai' ? 'block' : 'none'); ?>;">
                <div class="subnav-header">
                    <button type="button" onclick="backToDashboard()" class="subnav-back-btn">
                        <span class="subnav-back-icon"><?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
...
<?php endif; ?></span>
            ...
            <div id="subnav-exams" class="sidebar-subnav-panel space-y-1" style="padding: 4px 6px 10px; display: <?php echo e($currentSubGroup === 'exams' ? 'block' : 'none'); ?>;">
                <div class="subnav-header">
                    <button type="button" onclick="backToDashboard()" class="subnav-back-btn">
                        <span class="subnav-back-icon"><?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
...
<?php endif; ?></span>
            ...
            <div id="subnav-settings" class="sidebar-subnav-panel space-y-1" style="padding: 4px 6px 10px; display: <?php echo e($currentSubGroup === 'settings' ? 'block' : 'none'); ?>;">
                <div class="subnav-header">
                    <button type="button" onclick="backToDashboard()" class="subnav-back-btn">
                        <span class="subnav-back-icon"><?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
...
<?php endif; ?></span>
        ...
        <div class="sidebar-bottom-actions" style="margin-top:auto;padding:12px;border-top:1px solid #2A2C30;background:#121316;">
            <div class="flex flex-col gap-1.5">
                <button type="button" onclick="showSubNav('settings')" class="w-full flex items-center justify-center gap-1.5 px-3 py-2 rounded-xl text-[11px] font-bold text-[#C9C7BD] hover:text-[#FFFFFF] hover:bg-[#1E1F22] border border-[#303136] bg-[#191A1C] transition cursor-pointer <?php echo e($currentSubGroup === 'settings' ? 'active' : ''); ?>">
                    <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'sliders','class' => 'w-3.5 h-3.5 text-[#9CA3AF]']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'sliders','class' => 'w-3.5 h-3.5 text-[#9CA3AF]']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalce262628e3a8d44dc38fd1f3965181bc)): ?>
<?php $attributes = $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
...
<?php endif; ?>
                ...
                <form method="POST" action="<?php echo e(route('logout')); ?>" class="w-full" style="margin:0;">
                    <?php echo csrf_field(); ?>
    ...
    <main class="main">
        <header class="topbar">
            <div class="breadcrumb">
                <span><?php echo $__env->yieldContent('breadcrumb', 'Overview'); ?></span>
            </div>
            <div style="display:flex;align-items:center;gap:14px">
                <?php if(isset($topOrg) && $topOrg): ?>
                    <?php
                        ...
                        <button type="button" onclick="event.stopPropagation(); toggleTopNavProfileSwitcher()" style="display:flex;align-items:center;gap:10px;padding:6px 14px;background:linear-gradient(135deg,#ecfdf5 0%,#eef2ff 100%);border:1.5px solid #a7f3d0;border-radius:20px;cursor:pointer;box-shadow:0 2px 8px rgba(16,185,129,0.12);transition:all 0.2s;user-select:none" title="Switch Campus & Organization Profiles">
                            ...
                            <div style="text-align:left">
                                ...
                                <div style="font-size:12px;font-weight:800;color:#0f172a;margin-top:2px;line-height:1;display:flex;align-items:center;gap:6px">
                                    <span style="max-width:140px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis"><?php echo e($activeCampusModel?->name ?? 'Active Campus'); ?></span>
                                    <span style="font-size:9.5px;background:#dcfce7;color:#15803d;padding:1px 6px;border-radius:10px;font-weight:800;border:1px solid #bbf7d0"><?php echo e($usedCount); ?>/<?php echo e($maxQuota); ?></span>
                                </div>
                            </div>
                        ...
                        <div id="top-nav-profile-switcher-pop" style="display:none;position:absolute;top:calc(100% + 8px);right:0;width:340px;z-index:999999;background:#ffffff;border:1.5px solid #cbd5e1;border-radius:20px;box-shadow:0 20px 50px -10px rgba(15,23,42,0.25);padding:14px;animation:appleLiquidSpringPop 0.25s ease forwards">
                            ...
                            <div style="display:flex;align-items:center;justify-content:space-between;padding-bottom:10px;border-bottom:1px solid #f1f5f9;margin-bottom:10px">
                                <div style="display:flex;align-items:center;gap:10px">
                                    ...
                                    <div>
                                        <div style="font-size:13px;font-weight:800;color:#0f172a"><?php echo e($topOrg->name); ?></div>
                                ...
                                <span style="font-size:11px;font-weight:800;background:#e0e7ff;color:#4338ca;padding:3px 9px;border-radius:12px;border:1px solid #c7d2fe">
                                    <?php echo e($usedCount); ?>/<?php echo e($maxQuota); ?> Profiles
                                </span>
                            </div>
                            ...
                            <div style="max-height:280px;overflow-y:auto;display:flex;flex-direction:column;gap:6px;padding-right:2px">
                                <?php $__currentLoopData = $topCampuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tcamp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php $isTopCurr = (int)$tcamp->id === (int)$topActiveCampusId; ?>
                                    <form method="POST" action="<?php echo e(route('tenant.switch-institute')); ?>" style="margin:0">
                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" name="institute_id" value="<?php echo e($tcamp->id); ?>">
                                        <button type="submit" style="width:100%;text-align:left;padding:10px 12px;border-radius:14px;border:1.5px solid <?php echo e($isTopCurr ? '#818cf8' : '#e2e8f0'); ?>;background:<?php echo e($isTopCurr ? '#eef2ff' : '#ffffff'); ?>;cursor:pointer;display:flex;align-items:center;justify-content:space-between;transition:all 0.18s;box-shadow:<?php echo e($isTopCurr ? '0 2px 8px rgba(79,70,229,0.12)' : 'none'); ?>">
                                            <div style="display:flex;align-items:center;gap:10px;min-width:0">
                                                <div style="width:32px;height:32px;border-radius:10px;background:<?php echo e($isTopCurr ? 'linear-gradient(135deg,#4f46e5,#6366f1)' : '#cbd5e1'); ?>;color:#ffffff;font-size:13px;font-weight:800;display:flex;align-items:center;justify-content:center;flex-shrink:0;box-shadow:<?php echo e($isTopCurr ? '0 2px 6px rgba(79,70,229,0.3)' : 'none'); ?>">
                                                    <?php echo e($tcamp->display_initial); ?>

                                                </div>
                                                <div style="min-width:0">
                                                    <div style="font-size:12.5px;font-weight:<?php echo e($isTopCurr ? '800' : '700'); ?>;color:#0f172a;white-space:nowrap;overflow:hidden;text-overflow:ellipsis">
                                                        <?php echo e($tcamp->name); ?>

                                                    </div>
                                                    <div style="font-size:10.5px;color:<?php echo e($isTopCurr ? '#4338ca' : '#64748b'); ?>;font-weight:600;display:flex;align-items:center;gap:4px">
                                                        <?php if($isTopCurr): ?>
                                                            <i class="fa-solid fa-check text-emerald-500"></i> Active Profile
                                                        <?php else: ?>
                                                            <?php echo e($tcamp->city ?? 'Campus Profile'); ?>
                ...
                ?>
                <?php if(auth()->check() && auth()->user()->institute_id): ?>
                <div style="display:flex;align-items:center;gap:7px;padding:6px 14px;background:linear-gradient(135deg,#ecfdf5 0%,#eef2ff 100%);border:1.5px solid #a7f3d0;border-radius:20px;box-shadow:0 2px 8px rgba(16,185,129,0.12);user-select:none">
                    ...
                    <span style="font-size:11px;font-weight:800;color:#047857;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:160px" title="<?php echo e($headerActiveTerm?->name ?? 'No Active Term'); ?>">
                        <?php echo e($headerActiveTerm?->name ?? 'Activate Term'); ?>
        ...
        <div class="apple-liquid-glass-card" style="max-width:480px;width:92%;padding:28px 30px;text-align:left">
            ...
            <div style="display:flex;align-items:flex-start;gap:14px;margin-bottom:18px">
                <div id="globalClassyIconBox" style="width:48px;height:48px;border-radius:14px;background:#F6E4E1;color:#A2412C;border:1px solid #EAC8C1;display:flex;align-items:center;justify-content:center;font-size:20px;flex-shrink:0;">
                    <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'triangle-exclamation','class' => 'w-6 h-6']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'triangle-exclamation','class' => 'w-6 h-6']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalce262628e3a8d44dc38fd1f3965181bc)): ?>
<?php $attributes = $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
...
<?php endif; ?>
    ...
    <script>
        function openPortalHubModal(type) {
            if (type === 'executive') {
                window.location.href = "<?php echo e(route('principal.dashboard')); ?>";
            }
        }
        ...
        (function() {
            ...
            var loginUrl = '<?php echo e(route("principal.login")); ?>';
...
<?php /**PATH D:\UPLYFT\uplifyt\resources\views\principal\layouts\app.blade.php ENDPATH**/ ?>