        ...
        <div style="display:flex;align-items:center;gap:12px">
            ...
            <div>
                ...
                <p style="font-size: 13px; color: #64748b; margin-top: 3px; font-weight: 500;">
                    <?php echo e(__('Your identity details as registered with the institute.')); ?>
    ...
    <div style="display: flex; flex-direction: column; gap: 18px;">
        ...
        <?php if(session('status') === 'profile-updated'): ?>
            <div style="display:flex;align-items:center;gap:8px;background:#f0fdf4;border:1px solid #bbf7d0;padding:10px 14px;border-radius:10px;color:#166534;font-weight:700;font-size:13px;">
                ✓ <?php echo e(__('Profile Saved Successfully.')); ?>

            </div>
        <?php endif; ?>
    </div>
</section><?php /**PATH D:\UPLYFT\uplifyt\resources\views\profile\partials\update-profile-information-form.blade.php ENDPATH**/ ?>