<?php $__env->startSection('title', 'Master Timetable Grid'); ?>
<?php $__env->startSection('breadcrumb', 'Timetable Grid'); ?>
...
<div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:24px;flex-wrap:wrap;gap:16px" class="no-print">
    <div>
        ...
        <p style="color:#64748b;font-size:13px;margin-top:4px;font-weight:500">
            Single unified timetable showing <strong>All Class Sections on the left Y-axis</strong> and <strong>Time Slots across top X-axis</strong> for <strong><?php echo e($activeTerm?->name); ?></strong>.
        </p>
    </div>
    <div style="display:flex;align-items:center;gap:10px;flex-wrap:wrap">
        <a href="<?php echo e(route($routePrefix . 'timetables.index', ['view_type' => 'class'])); ?>" class="btn btn-ghost" style="font-size:12.5px;font-weight:700">
            🏫 Class-Wise
        </a>
        <a href="<?php echo e(route($routePrefix . 'timetables.index', ['view_type' => 'teacher'])); ?>" class="btn btn-ghost" style="font-size:12.5px;font-weight:700">
            👨‍🏫 Teacher-Wise
        </a>
        <a href="<?php echo e(route($routePrefix . 'timetables.export')); ?>" class="btn btn-primary" style="font-size:12px;font-weight:700;display:inline-flex;align-items:center;gap:6px">
            📗 Download Excel (.xlsx)
        </a>
...
<div style="display:flex;gap:10px;margin-bottom:24px;overflow-x:auto;padding-bottom:6px" class="no-print">
    <?php $__currentLoopData = $days; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <a href="<?php echo e(route('principal.timetables.grid', ['day' => $day])); ?>" 
           class="day-tab <?php echo e(strtolower($selectedDay) === strtolower($day) ? 'active' : ''); ?>">
...
<div class="card" style="text-align:center;padding:48px 24px">
    ...
    <a href="<?php echo e(route('principal.timetables.index')); ?>" class="btn btn-primary">
...
<div class="card" style="margin-bottom:32px;padding:24px">
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:20px;border-bottom:1px solid #e2e8f0;padding-bottom:14px">
        <h2 style="font-family:'Outfit',sans-serif;font-size:18px;font-weight:800;color:#0f172a;margin:0">
            📅 Master Daily Schedule — <span style="color:#e1306c;text-transform:capitalize"><?php echo e($selectedDay); ?></span>
        </h2>
        <span style="font-size:12px;color:#64748b;font-weight:600">
            Timeline Schedule across <?php echo e($timeSlots->count()); ?> Time Slots
        </span>
    </div>
    ...
    <div style="overflow-x:auto;border-radius:12px;border:1px solid #e2e8f0;background:#ffffff">
        <div style="min-width:1400px">
            ...
            <div style="display:flex;width:100%;background:#f8fafc;border-bottom:2px solid #e2e8f0">
                ...
                <div style="flex:1;position:relative;display:flex;align-items:center;height:48px">
                    <?php $__currentLoopData = $timeSlots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                        <div style="width:<?php echo e($tsWidthPct); ?>%;height:100%;border-right:1px dashed #e2e8f0;display:flex;align-items:center;justify-content:center;font-size:12px;font-weight:800;color:#e1306c">
            ...
            <!-- ROOM ROWS -->
            <?php $__empty_1 = true; $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php
                ...
                <div style="display:flex;width:100%;border-bottom:1px solid #e2e8f0;background:#ffffff;min-height:104px">
                    ...
                    <div style="width:170px;flex-shrink:0;padding:14px;background:#f8fafc;border-right:1px solid #e2e8f0;display:flex;flex-direction:column;justify-content:center">
                        <div style="font-size:15px;font-weight:800;color:#0f172a">📍 <?php echo e($rm->room_number); ?></div>
                        <div style="font-size:11px;color:#0284c7;font-weight:700;margin-top:2px"><?php echo e($rm->room_type); ?></div>
                    </div>
                        ...
                        <div style="position:absolute;top:0;left:0;right:0;bottom:0;display:flex;pointer-events:none">
                            <?php $__currentLoopData = $timeSlots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    ...
                                    $tsWidthPct = (($tsEndMin - $tsStartMin) / $totalTimelineMins) * 100;
                                ?>
                                <div style="width:<?php echo e($tsWidthPct); ?>%;height:100%;border-right:1px dashed #e2e8f0"></div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>

                        <!-- Lecture Horizontal Rectangle Bars -->
                        <?php $__empty_2 = true; $__currentLoopData = $mergedRoomSlots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                            <?php
                            ...
                            <div class="tt-horizontal-rect-card" 
                                 style="position:absolute;left:calc(<?php echo e($leftPct); ?>% + 4px);width:calc(<?php echo e($widthPct); ?>% - 8px);top:9px;height:86px;background:#ffffff;border:1px solid #e2e8f0;border-left:5px solid #e1306c;border-radius:12px;padding:9px 12px;box-shadow:0 2px 8px rgba(0,0,0,0.06);display:flex;flex-direction:column;justify-content:space-between;overflow:hidden;z-index:2;transition:all 0.15s ease;"
                                ...
                                <div style="font-size:11.5px;font-weight:700;color:#334155;white-space:nowrap;text-overflow:ellipsis;overflow:hidden;display:flex;align-items:center;gap:4px">
                                    <span>👨‍🏫</span>
                                    <span style="text-overflow:ellipsis;overflow:hidden"><?php echo e($slot->teacher->name); ?></span>
                                </div>
                                ...
                                <div style="display:flex;align-items:center;justify-content:space-between;font-size:10.5px;font-weight:800;color:#e1306c">
                                    <span>⏰ <?php echo e(\Carbon\Carbon::parse($slot->start_time)->format('g:i')); ?> – <?php echo e(\Carbon\Carbon::parse($slot->end_time)->format('g:i A')); ?></span>
                                    <span style="background:#fdf2f8;border:1px solid #fbcfe8;color:#be185d;padding:1.5px 6px;border-radius:5px;font-size:10px"><?php echo e($durLabel); ?></span>
                                </div>
                            </div>
                        ...
                        <div style="position:absolute;top:0;left:0;right:0;bottom:0;display:flex;pointer-events:none">
                            <?php $__currentLoopData = $timeSlots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    ...
                                    $tsWidthPct = (($tsEndMin - $tsStartMin) / $totalTimelineMins) * 100;
                                ?>
                                <div style="width:<?php echo e($tsWidthPct); ?>%;height:100%;border-right:1px dashed #fecaca"></div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>

                        <?php $__currentLoopData = $mergedUnassignedSlots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uSlot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <div class="tt-horizontal-rect-card" 
                                 style="position:absolute;left:calc(<?php echo e($leftPct); ?>% + 4px);width:calc(<?php echo e($widthPct); ?>% - 8px);top:9px;height:86px;background:#ffffff;border:1px solid #fca5a5;border-left:5px solid #ef4444;border-radius:12px;padding:9px 12px;box-shadow:0 2px 8px rgba(0,0,0,0.06);display:flex;flex-direction:column;justify-content:space-between;overflow:hidden;z-index:2;transition:all 0.15s ease;">
                                ...
                                <div style="display:flex;align-items:center;justify-content:space-between;gap:6px">
                                    ...
                                    <span style="font-size:12.5px;font-weight:800;color:#0f172a;white-space:nowrap;text-overflow:ellipsis;overflow:hidden">
                                        📚 <?php echo e($uSlot->subject->subject_name); ?>
                                ...
                                <div style="font-size:11.5px;font-weight:700;color:#334155;white-space:nowrap;text-overflow:ellipsis;overflow:hidden;display:flex;align-items:center;gap:4px">
                                    <span>👨‍🏫</span>
                                    <span style="text-overflow:ellipsis;overflow:hidden"><?php echo e($uSlot->teacher->name); ?></span>
                                </div>

                                <div style="display:flex;align-items:center;justify-content:space-between;font-size:10.5px;font-weight:800;color:#ef4444">
                                    <span>⏰ <?php echo e(\Carbon\Carbon::parse($uSlot->start_time)->format('g:i')); ?> – <?php echo e(\Carbon\Carbon::parse($uSlot->end_time)->format('g:i A')); ?></span>
                                    <span style="background:#fee2e2;color:#dc2626;padding:1.5px 6px;border-radius:5px;font-size:10px"><?php echo e($durLabel); ?></span>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
...
<?php echo $__env->make(auth()->check() && auth()->user()->isTeacher() ? 'layouts.app' : 'principal.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\UPLYFT\uplifyt\resources\views\principal\timetables\grid.blade.php ENDPATH**/ ?>