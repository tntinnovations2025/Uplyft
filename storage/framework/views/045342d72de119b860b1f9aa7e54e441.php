<?php $__env->startSection('title', 'Faculty Work Hours & Availability'); ?>
<?php $__env->startSection('breadcrumb', 'Faculty Work Hours'); ?>
...
<div class="card" style="margin-bottom:24px;border:1.5px solid #c7d2fe;background:linear-gradient(135deg,#f8fafc 0%,#eef2ff 100%)">
    ...
    <div>
        ...
        <div style="display:flex;flex-wrap:wrap;gap:10px">
            <?php $allWeekdays = ['monday' => 'Monday', 'tuesday' => 'Tuesday', 'wednesday' => 'Wednesday', 'thursday' => 'Thursday', 'friday' => 'Friday', 'saturday' => 'Saturday', 'sunday' => 'Sunday']; ?>
            <?php $__currentLoopData = $allWeekdays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wKey => $wLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <label style="display:flex;align-items:center;gap:8px;padding:8px 14px;background:#ffffff;border:1.5px solid #cbd5e1;border-radius:10px;cursor:pointer;font-size:13px;font-weight:700;color:#0f172a;user-select:none" id="global-weekday-lbl-<?php echo e($wKey); ?>">
                    <input type="checkbox" id="global_weekday_<?php echo e($wKey); ?>" value="<?php echo e($wKey); ?>" <?php echo e(in_array($wKey, ['monday','tuesday','wednesday','thursday','friday','saturday']) ? 'checked' : ''); ?> onchange="onGlobalWeekdayToggle('<?php echo e($wKey); ?>')" style="width:16px!important;height:16px!important;accent-color:#4f46e5;margin:0!important">
                    <?php echo e($wLabel); ?>
...
<?php if($teachers->count() > 0): ?>
    <div style="margin-bottom:16px;color:#64748b;font-size:13px;display:flex;align-items:center;justify-content:space-between">
        <span>Showing <strong style="color:#0f172a"><?php echo e($teachers->count()); ?></strong> Faculty Members</span>
    ...
    <div class="teacher-card" id="teacher-card-<?php echo e($teacher->id); ?>">
        <!-- Clickable Header -->
        <div class="teacher-card-header" onclick="toggleTeacherCard(<?php echo e($teacher->id); ?>)">
            <div style="display:flex;align-items:center;gap:14px">
                <span class="chevron-icon" id="chevron-<?php echo e($teacher->id); ?>">▶</span>
                ...
                <div>
                    ...
                    <div style="font-size:12px;color:#64748b;margin-top:2px;font-weight:500">
                        ✉️ <?php echo e($teacher->email); ?> &bull; <span style="color:#059669;font-weight:700"><?php echo e(ucfirst($teacher->employment_type ?? 'Full Time')); ?> Faculty</span>
                    </div>
                </div>
            </div>
            ...
            <div style="display:flex;align-items:center;gap:12px" onclick="event.stopPropagation()">
                <span class="badge badge-purple" style="font-size:12px;padding:6px 12px">
                    🗓️ <span id="teacher-active-days-<?php echo e($teacher->id); ?>"><?php echo e($activeDaysCount); ?></span> Working Days
                </span>
                <button type="button" class="btn btn-ghost btn-sm" onclick="toggleTeacherCard(<?php echo e($teacher->id); ?>)" style="font-size:12px">
                    ⚙️ Edit Hours
                </button>
            </div>
        </div>
        ...
        <div class="teacher-card-body">
            <form method="POST" action="<?php echo e(route('principal.teachers.availability.store')); ?>" id="form-teacher-<?php echo e($teacher->id); ?>">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="teacher_id" value="<?php echo e($teacher->id); ?>">

                <div class="schedule-grid">
                    <?php $__currentLoopData = ['monday','tuesday','wednesday','thursday','friday','saturday','sunday']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    <div class="day-box <?php echo e($isAvailable ? 'active' : 'disabled'); ?>" id="day-box-<?php echo e($teacher->id); ?>-<?php echo e($day); ?>">
                        <div class="day-header">
                            <span class="day-name"><?php echo e(ucfirst($day)); ?></span>

                            <label class="switch">
                                <input type="hidden" name="availabilities[<?php echo e($idx); ?>][day_of_week]" value="<?php echo e($day); ?>">
                                <input type="hidden" name="availabilities[<?php echo e($idx); ?>][is_available]" value="0">
                                <input type="checkbox" 
                                       name="availabilities[<?php echo e($idx); ?>][is_available]" 
                                       value="1" 
                                       <?php echo e($isAvailable ? 'checked' : ''); ?>

                                       onchange="toggleDayState(<?php echo e($teacher->id); ?>, '<?php echo e($day); ?>', this)">
                        ...
                        <div style="display:flex;gap:6px;margin-bottom:12px;flex-wrap:wrap">
                            <span class="preset-chip" onclick="setPreset('<?php echo e($teacher->id); ?>', '<?php echo e($day); ?>', '08:00', '14:30')">Standard</span>
                            <span class="preset-chip" onclick="setPreset('<?php echo e($teacher->id); ?>', '<?php echo e($day); ?>', '08:00', '12:30')">Half-Day</span>
                            <span class="preset-chip" onclick="setPreset('<?php echo e($teacher->id); ?>', '<?php echo e($day); ?>', '09:00', '16:00')">Late Shift</span>
                        </div>
                        ...
                        <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px">
                            <div>
                                ...
                                <input type="time" 
                                       name="availabilities[<?php echo e($idx); ?>][start_time]" 
                                       id="start-<?php echo e($teacher->id); ?>-<?php echo e($day); ?>" 
                            ...
                            <div>
                                ...
                                <input type="time" 
                                       name="availabilities[<?php echo e($idx); ?>][end_time]" 
                                       id="end-<?php echo e($teacher->id); ?>-<?php echo e($day); ?>" 
                ...
                <div style="display:flex;justify-content:flex-end;margin-top:20px;padding-top:16px;border-top:1px solid #e2e8f0">
                    <button type="button" class="btn btn-ghost btn-sm" onclick="toggleTeacherCard(<?php echo e($teacher->id); ?>)" style="margin-right:8px">Cancel</button>
                    <button type="submit" class="btn btn-primary btn-sm" style="padding:8px 20px">
                        💾 Save <?php echo e($teacher->name); ?>'s Hours
                    </button>
                </div>
            </form>
        </div>
...
<div class="card" style="text-align:center;padding:50px 20px">
    ...
    <a href="<?php echo e(route('principal.staff.index')); ?>" class="btn btn-primary">
...
<?php echo $__env->make(auth()->check() && auth()->user()->isTeacher() ? 'layouts.app' : 'principal.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\UPLYFT\uplifyt\resources\views\principal\teachers\availability.blade.php ENDPATH**/ ?>