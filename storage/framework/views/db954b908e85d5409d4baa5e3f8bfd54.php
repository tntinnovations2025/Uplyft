<?php $__env->startSection('title', 'Assign Subject & Teacher'); ?>
<?php $__env->startSection('breadcrumb', 'Subject & Teacher Assignments'); ?>
...
<div style="display:grid;grid-template-columns:repeat(auto-fit, minmax(320px, 1fr));gap:24px">
    ...
    <div>
        <div class="card" style="background:#ffffff;border:1px solid rgba(226,232,240,0.85);box-shadow:0 4px 20px -2px rgba(0,0,0,0.04);border-radius:16px;padding:24px">
            ...
            <form id="leftAssignForm" method="POST" action="<?php echo e($storeRoute); ?>" onsubmit="return confirmLeftAssignmentForm(event)">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group mb-3">
                    ...
                    <select id="teacher_id" name="teacher_id" required style="width:100%;padding:10px 14px;background:#ffffff;border:1px solid #cbd5e1;border-radius:10px;color:#0f172a;outline:none">
                        ...
                        <?php $__currentLoopData = $staffMembers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($t->id); ?>"><?php echo e($t->name); ?> (<?php echo e($t->staff_role ?? ucfirst($t->role)); ?>)</option>
                ...
                <div class="form-group mb-3">
                    ...
                    <select id="class_section_id" name="class_section_id" required onchange="onFormSelectionChange()" style="width:100%;padding:10px 14px;background:#ffffff;border:1px solid #cbd5e1;border-radius:10px;color:#0f172a;outline:none">
                        ...
                        <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($sec->id); ?>" data-class-id="<?php echo e($sec->institute_class_id); ?>">
                                <?php echo e($sec->instituteClass->custom_name); ?> — Section <?php echo e($sec->section_name); ?>
                ...
                <div class="form-group mb-3">
                    ...
                    <select id="subject_id" name="subject_id" required onchange="updateAssignmentStatusNotice()" style="width:100%;padding:10px 14px;background:#ffffff;border:1px solid #cbd5e1;border-radius:10px;color:#0f172a;outline:none">
                        ...
                        <?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($sub->id); ?>" data-class-id="<?php echo e($sub->institute_class_id); ?>" class="subject-option" style="display:none">
                                <?php echo e($sub->subject_name); ?> <?php if($sub->subject_code): ?>(<?php echo e($sub->subject_code); ?>)<?php endif; ?>
                            </option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
        ...
        <div class="card" style="background:#ffffff;border:1px solid rgba(226,232,240,0.85);box-shadow:0 4px 20px -2px rgba(0,0,0,0.04);border-radius:16px;padding:24px">
            ...
            <?php if($offerings->count() > 0): ?>
                ...
                <div id="viewByClassContainer">
                    <?php $__currentLoopData = $byClass; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $className => $classOfferings): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        ?>
                        <div class="allocation-card" id="<?php echo e($cardId); ?>" data-group-search="<?php echo e(strtolower($className)); ?>">
                            <div class="allocation-card-header" onclick="toggleAllocationCard('<?php echo e($cardId); ?>', '<?php echo e($chevId); ?>')">
                                <div style="display:flex;align-items:center;gap:12px">
                                    <span id="<?php echo e($chevId); ?>" class="chevron-icon">▶</span>
                                    <div>
                            ...
                            <div class="allocation-card-body">
                                <div style="overflow-x:auto">
                                    <table class="assignments-table">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $classOfferings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $off): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php
                                                ...
                                                ?>
                                                <tr class="offering-row" data-search-text="<?php echo e($searchData); ?>">
                                                    <td>
                                                        <?php if($off->is_assigned): ?>
                                                            <strong style="color:#0f172a"><?php echo e($off->teacher->name); ?></strong>
                                                            <div style="font-size:11px;color:#64748b"><?php echo e($tRole); ?></div>
                                                        <?php else: ?>
                                                    ...
                                                    <td>
                                                        <span style="color:#0284c7;font-weight:700">Section <?php echo e($secName); ?></span>
                                                    </td>
                                                    <td>
                                                        ...
                                                        <div style="display:inline-flex;gap:6px">
                                                            <?php if($off->is_assigned): ?>
                                                                <button type="button" 
                                                                        ...
                                                                        onclick="openReplaceModal(<?php echo e($off->section->id); ?>, '<?php echo e(addslashes($className)); ?> — Section <?php echo e(addslashes($secName)); ?>', <?php echo e($off->subject->id); ?>, '<?php echo e(addslashes($subName)); ?>', <?php echo e($off->teacher->id); ?>, '<?php echo e(addslashes($off->teacher->name)); ?>')"
                                                                        style="font-size:11px;padding:4px 10px;color:#0284c7;border-color:#bae6fd;background:#f0f9ff">
                                                                    ✏️ Replace Teacher
                                                                </button>
                                                                <form method="POST" action="<?php echo e(request()->routeIs('teacher.*') ? route('teacher.assignments.destroy', $off->assignment) : route('principal.assignments.destroy', $off->assignment)); ?>" onsubmit="return confirm('Remove teacher assignment for <?php echo e(addslashes($subName)); ?> in <?php echo e(addslashes($className)); ?>?')" style="margin:0;display:inline">
                                                            ...
                                                            <?php else: ?>
                                                                <button type="button" 
                                                                        ...
                                                                        onclick="openReplaceModal(<?php echo e($off->section->id); ?>, '<?php echo e(addslashes($className)); ?> — Section <?php echo e(addslashes($secName)); ?>', <?php echo e($off->subject->id); ?>, '<?php echo e(addslashes($subName)); ?>', null, null)"
                ...
                <div id="viewByTeacherContainer" style="display:none">
                    <?php $__currentLoopData = $byTeacher; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tKey => $tGroup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            $cardId = "teacher-card-".Str::slug($tKey);
                            $chevId = "chev-t-".Str::slug($tKey);
                            $tOfferings = $tGroup->offerings;
                        ?>
                        <div class="allocation-card" id="<?php echo e($cardId); ?>" data-group-search="<?php echo e(strtolower($tKey)); ?>">
                            <div class="allocation-card-header" onclick="toggleAllocationCard('<?php echo e($cardId); ?>', '<?php echo e($chevId); ?>')">
                                <div style="display:flex;align-items:center;gap:12px">
                                    <span id="<?php echo e($chevId); ?>" class="chevron-icon">▶</span>
                                    <div>
                                        ...
                                        <div style="font-size:11px;color:#64748b;margin-top:1px;font-weight:500">
                                            <?php echo e($tOfferings->count()); ?> Assigned Subject(s) • Click to expand
                                        </div>
                                    </div>
                                </div>

                                <div style="display:flex;align-items:center;gap:8px" onclick="event.stopPropagation()">
                                    <span class="badge <?php echo e($tOfferings->count() > 0 ? 'badge-purple' : 'badge-ghost'); ?>" style="font-weight:700;font-size:11px">
                                        📖 <?php echo e($tOfferings->count()); ?> Assigned Subject(s)
                                    </span>
                                </div>
                            </div>

                            <div class="allocation-card-body">
                                <?php if($tOfferings->count() > 0): ?>
                                    <div style="overflow-x:auto">
                                        <table class="assignments-table">
                                            <thead>
                                              <tr>
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $tOfferings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $off): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php
                                                    ...
                                                    <tr class="offering-row" data-search-text="<?php echo e($searchData); ?>">
                                                        <td>
                                                            <span style="font-weight:800;color:#0f172a"><?php echo e($clsName); ?></span> — 
                                                            <span style="color:#0284c7;font-weight:700">Section <?php echo e($secName); ?></span>
                                                        </td>
                                                        <td>
                                                            <span class="badge badge-purple" style="font-weight:700">
                                                        ...
                                                        <td style="text-align:right">
                                                            <div style="display:inline-flex;gap:6px">
                                                                <button type="button" 
                                                                        class="btn btn-ghost btn-sm" 
                                                                        onclick="openReplaceModal(<?php echo e($off->section->id); ?>, '<?php echo e(addslashes($clsName)); ?> — Section <?php echo e(addslashes($secName)); ?>', <?php echo e($off->subject->id); ?>, '<?php echo e(addslashes($subName)); ?>', <?php echo e($off->teacher->id); ?>, '<?php echo e(addslashes($off->teacher->name)); ?>')"
                                                                        style="font-size:11px;padding:4px 10px;color:#0284c7;border-color:#bae6fd;background:#f0f9ff">
                                                                    ✏️ Replace Teacher
                                                                </button>
                                                                <form method="POST" action="<?php echo e(request()->routeIs('teacher.*') ? route('teacher.assignments.destroy', $off->assignment) : route('principal.assignments.destroy', $off->assignment)); ?>" onsubmit="return confirm('Remove teacher assignment for <?php echo e(addslashes($subName)); ?> in <?php echo e(addslashes($clsName)); ?>?')" style="margin:0;display:inline">
                                                                    <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
                                                                    <button type="submit" class="btn btn-danger btn-sm" style="font-size:11px;padding:4px 8px">🗑️</button>
                                                                </form>
                                                            </div>
                                ...
                                <?php else: ?>
                                    <div style="text-align:center;padding:24px;color:#64748b">
                                        <div style="font-size:13px">No subjects currently assigned to <strong><?php echo e($tGroup->teacher->name ?? 'this teacher'); ?></strong>.</div>
                                        <?php if($tGroup->teacher): ?>
                                            <button type="button" class="btn btn-primary btn-sm" onclick="selectTeacherInForm(<?php echo e($tGroup->teacher->id); ?>)" style="margin-top:10px;font-size:11px">
                                                ➕ Assign Subject to <?php echo e($tGroup->teacher->name); ?>
                ...
                <div id="viewByUnassignedContainer" style="display:none">
                    <?php $__empty_1 = true; $__currentLoopData = $unassignedByClass; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uClassName => $uOfferings): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php
                            $cardId = "unassigned-card-".Str::slug($uClassName);
                            $chevId = "chev-u-".Str::slug($uClassName);
                        ?>
                        <div class="allocation-card" id="<?php echo e($cardId); ?>" data-group-search="<?php echo e(strtolower($uClassName)); ?>">
                            <div class="allocation-card-header" onclick="toggleAllocationCard('<?php echo e($cardId); ?>', '<?php echo e($chevId); ?>')">
                                <div style="display:flex;align-items:center;gap:12px">
                                    <span id="<?php echo e($chevId); ?>" class="chevron-icon">▶</span>
                                    <div>
                                        <div style="font-family:'Outfit',sans-serif;font-size:16px;font-weight:800;color:#ef4444">
                                            🏫 <?php echo e($uClassName); ?>

                                        </div>
                                        <div style="font-size:11px;color:#64748b;margin-top:1px;font-weight:500">
                                            <?php echo e($uOfferings->count()); ?> Unassigned Subject(s) • Click to expand
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div style="display:flex;align-items:center;gap:8px" onclick="event.stopPropagation()">
                                    <span class="badge" style="background:#fee2e2;color:#dc2626;border:1px solid #fecaca;font-size:11px;font-weight:800">
                                        🔴 <?php echo e($uOfferings->count()); ?> Unassigned
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="allocation-card-body">
                                <div style="overflow-x:auto">
                                    <table class="assignments-table">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $uOfferings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $off): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php
                                                    $secName = $off->section->section_name ?? '';
                                                    $subName = $off->subject->subject_name ?? '';
                                                    $subCode = $off->subject->subject_code ?? '';
                                                ...
                                                <tr class="offering-row" data-search-text="<?php echo e($searchData); ?>">
                                                    ...
                                                    <td style="text-align:right">
                                                        <button type="button" 
                                                                class="btn btn-primary btn-sm" 
                                                                onclick="openReplaceModal(<?php echo e($off->section->id); ?>, '<?php echo e(addslashes($uClassName)); ?> — Section <?php echo e(addslashes($secName)); ?>', <?php echo e($off->subject->id); ?>, '<?php echo e(addslashes($subName)); ?>', null, null)"
                                                                style="font-size:11px;padding:4px 10px">
                                                            ➕ Assign Teacher
                                                        </button>
                                                    </td>
...
<div id="replaceTeacherModal" class="modal-backdrop" onclick="if(event.target===this) closeReplaceModal()">
    <div class="modal-box">
        ...
        <form id="replaceTeacherForm" method="POST" action="<?php echo e($storeRoute); ?>">
            <?php echo csrf_field(); ?>
...
<script>
    ...
    const assignmentsMap = <?php echo json_encode($assignmentsMap ?? [], 15, 512) ?>;
...
<?php echo $__env->make(auth()->check() && auth()->user()->isTeacher() ? 'layouts.app' : 'principal.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\UPLYFT\uplifyt\resources\views\principal\assignments\index.blade.php ENDPATH**/ ?>