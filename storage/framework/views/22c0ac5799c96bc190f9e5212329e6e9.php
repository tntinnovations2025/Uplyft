...
<?php $__env->startSection('title', 'Finance & Accounts'); ?>
<?php $__env->startSection('breadcrumb', 'Finance & Accounts'); ?>
...
<div style="display:flex;flex-direction:column;gap:20px">
    ...
    <?php if($activeTab === 'salaries'): ?>
        <div style="background:#ffffff;border:1px solid rgba(226,232,240,0.85);border-radius:14px;box-shadow:0 2px 12px -2px rgba(0,0,0,0.03);overflow:hidden">
            ...
            <div style="padding:14px 20px;border-bottom:1px solid #e2e8f0;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:14px">
                ...
                <form method="GET" action="<?php echo e(route($routePrefix . 'index')); ?>" style="display:flex;align-items:center;gap:8px;flex-wrap:wrap;flex:1;max-width:400px">
                    <input type="hidden" name="tab" value="salaries">
                    <input type="hidden" name="section" value="<?php echo e($salarySection); ?>">
                    <div style="position:relative;flex:1">
                        <span style="position:absolute;left:12px;top:50%;transform:translateY(-50%);font-size:13px;color:#64748b">🔍</span>
                        <input type="text" name="search" value="<?php echo e($salarySearch); ?>" placeholder="Search by name, email, or ID..." style="width:100%;padding:7px 12px 7px 34px;background:#ffffff;border:1px solid #cbd5e1;border-radius:8px;color:#0f172a;font-size:12px;outline:none">
                    </div>
                    <button type="submit" class="btn btn-primary" style="padding:7px 14px;font-size:12px">Search</button>
                    <?php if($salarySearch): ?>
                        <a href="<?php echo e(route($routePrefix . 'index', ['tab' => 'salaries', 'section' => $salarySection])); ?>" class="btn btn-danger" style="padding:7px 12px;font-size:12px">Reset</a>
                    <?php endif; ?>
                </form>
            </div>
                ...
                <div style="display:flex;align-items:center;gap:14px;flex-wrap:wrap">
                    <div style="display:flex;gap:10px">
                        <div style="background:#ffffff;border:1px solid #cbd5e1;border-radius:8px;padding:5px 12px;text-align:right;box-shadow:0 1px 4px rgba(0,0,0,0.02)">
                            ...
                            <div style="font-size:13px;font-weight:800;color:#059669;margin-top:1px"><?php echo e($currencySymbol); ?> <?php echo e(number_format($totalIncome, 2)); ?></div>
                        </div>
                        <div style="background:#ffffff;border:1px solid #cbd5e1;border-radius:8px;padding:5px 12px;text-align:right;box-shadow:0 1px 4px rgba(0,0,0,0.02)">
                            <div style="font-size:9px;font-weight:800;letter-spacing:0.4px;text-transform:uppercase;color:#64748b">Monthly Payroll</div>
                            <div style="font-size:13px;font-weight:800;color:#e11d48;margin-top:1px"><?php echo e($currencySymbol); ?> <?php echo e(number_format($totalConfiguredPayroll, 2)); ?></div>
                        </div>
                    </div>

                    <?php if($canEditSalaries): ?>
            ...
            <div style="display:flex;align-items:center;gap:10px;padding:10px 20px;background:#f8fafc;border-bottom:1px solid #e2e8f0;margin-top:12px">
                <a href="<?php echo e(request()->fullUrlWithQuery(['tab' => 'salaries', 'section' => 'faculty'])); ?>" class="btn <?php echo e($salarySection === 'faculty' ? 'btn-primary' : 'btn-ghost'); ?>" style="font-size:12px;padding:6px 14px;border-radius:8px">
                    👨‍🏫 Faculty (Teaching Staff) — <?php echo e($facultyList->count()); ?>

                </a>
                <a href="<?php echo e(request()->fullUrlWithQuery(['tab' => 'salaries', 'section' => 'staff'])); ?>" class="btn <?php echo e($salarySection === 'staff' ? 'btn-primary' : 'btn-ghost'); ?>" style="font-size:12px;padding:6px 14px;border-radius:8px">
                    💼 Support &amp; Admin Staff — <?php echo e($staffList->count()); ?>

                </a>
            </div>

            
            <?php if($salarySection === 'faculty'): ?>
                <?php if($facultyList->isEmpty()): ?>
                ...
                <?php else: ?>
                    <div style="display:grid;grid-template-columns:repeat(auto-fill, minmax(290px, 1fr));gap:12px;padding:14px 20px">
                        <?php $__currentLoopData = $facultyList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div>
                                    ...
                                    <div style="display:flex;align-items:flex-start;justify-content:space-between;gap:10px;margin-bottom:10px">
                                        <div style="display:flex;align-items:center;gap:10px">
                                            <div style="width:36px;height:36px;border-radius:10px;background:linear-gradient(135deg, #fd1d1d, #e1306c, #833ab4);color:#ffffff;display:flex;align-items:center;justify-content:center;font-weight:800;font-size:14px;box-shadow:0 3px 8px rgba(225,48,108,0.2);flex-shrink:0">
                                                <?php echo e(strtoupper(substr($t->first_name, 0, 1))); ?>
                                        ...
                                        <span style="font-family:monospace;font-size:10px;font-weight:700;color:#0284c7;background:#eff6ff;padding:2px 6px;border-radius:6px;border:1px solid #bfdbfe;flex-shrink:0">
                                            <?php echo e($t->employee_id ?: 'TCH-'.$t->id); ?>
                                    ...
                                    <div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;padding:8px 10px;margin-bottom:10px;display:flex;flex-direction:column;gap:5px">
                                        <div style="display:flex;align-items:center;justify-content:space-between">
                                            ...
                                            <span style="font-size:11px;font-weight:700;color:#0f172a"><?php echo e($t->qualification ?: 'Degree Verified'); ?></span>
                                        </div>
                                        <div style="display:flex;align-items:center;justify-content:space-between">
                                            <span style="font-size:11px;color:#64748b;font-weight:600">📧 Email</span>
                                            <span style="font-size:11px;color:#334155;max-width:150px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap" title="<?php echo e($t->email); ?>"><?php echo e($t->email); ?></span>
                                        </div>
                                        <div style="display:flex;align-items:center;justify-content:space-between">
                                            <span style="font-size:11px;color:#64748b;font-weight:600">📞 Phone</span>
                                            <span style="font-size:11px;color:#334155"><?php echo e($t->phone ?: 'Not provided'); ?></span>
                                        </div>
                                    </div>
                                    ...
                                    <div style="display:flex;align-items:center;justify-content:space-between;padding:8px 10px;background:#ecfdf5;border:1px solid #a7f3d0;border-radius:8px;margin-bottom:10px">
                                        <div>
                                            ...
                                            <div style="font-family:'Outfit',sans-serif;font-size:14px;font-weight:800;color:#059669;margin-top:1px">
                                                Rs. <?php echo e(number_format($t->basic_salary_pkr ?: 0, 2)); ?>
                                        ...
                                        <span style="font-size:10px;font-weight:700;color:#0284c7;background:#eff6ff;padding:3px 8px;border-radius:6px;border:1px solid #bfdbfe">
                                            📄 <?php echo e($t->salarySlips->count()); ?> Slip(s)
                                        </span>
                                    </div>
                                </div>

                                
                                <div style="display:grid;grid-template-columns:<?php echo e($canEditSalaries ? '1fr 1fr' : '1fr'); ?>;gap:8px;margin-top:2px">
                                    <?php if($canEditSalaries): ?>
                                        <button type="button" class="btn btn-primary" onclick="openSalaryModal(<?php echo e($t->id); ?>, '<?php echo e(addslashes($t->full_name)); ?>')" style="padding:6px 10px;font-size:11px;display:flex;align-items:center;justify-content:center;gap:4px;border-radius:8px">
                                            <span>➕ Record Salary</span>
                                        </button>
                                    <?php endif; ?>
                                    <a href="<?php echo e(auth()->user()->isPrincipal() || auth()->user()->isGlobalAdmin() ? route('principal.directory.teacher', $t->id) : auth()->user()->staffUrl('directory/teacher/' . $t->id)); ?>" class="btn btn-ghost" style="padding:6px 10px;font-size:11px;display:flex;align-items:center;justify-content:center;gap:4px;border-radius:8px">
            ...
            <?php if($salarySection === 'staff'): ?>
                ...
                <?php else: ?>
                    <div style="display:grid;grid-template-columns:repeat(auto-fill, minmax(290px, 1fr));gap:12px;padding:14px 20px">
                        <?php $__currentLoopData = $staffList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div style="background:#ffffff;border:1px solid rgba(226,232,240,0.85);border-radius:14px;padding:12px 14px;box-shadow:0 2px 10px -2px rgba(0,0,0,0.03);display:flex;flex-direction:column;justify-content:space-between;transition:transform 0.2s ease, border-color 0.2s ease">
                                <div>
                                    ...
                                    <div style="display:flex;align-items:flex-start;justify-content:space-between;gap:10px;margin-bottom:10px">
                                        <div style="display:flex;align-items:center;gap:10px">
                                            <div style="width:36px;height:36px;border-radius:10px;background:linear-gradient(135deg, #fd1d1d, #e1306c, #833ab4);color:#ffffff;display:flex;align-items:center;justify-content:center;font-weight:800;font-size:14px;box-shadow:0 3px 8px rgba(225,48,108,0.2);flex-shrink:0">
                                                <?php echo e(strtoupper(substr($st->name, 0, 1))); ?>
                                        ...
                                        <span style="font-family:monospace;font-size:10px;font-weight:700;color:#64748b;background:#f1f5f9;padding:2px 6px;border-radius:6px;flex-shrink:0">
                                            <?php echo e($st->identifier ?: 'STF-'.$st->id); ?>
                                    ...
                                    <div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;padding:8px 10px;margin-bottom:10px;display:flex;flex-direction:column;gap:5px">
                                        <div style="display:flex;align-items:center;justify-content:space-between">
                                            <span style="font-size:11px;color:#64748b;font-weight:600">📧 Email</span>
                                            <span style="font-size:11px;color:#334155"><?php echo e($st->email); ?></span>
                                        </div>
                                        <div style="display:flex;align-items:center;justify-content:space-between">
                                            <span style="font-size:11px;color:#64748b;font-weight:600">📅 Registered</span>
                                            <span style="font-size:11px;color:#334155"><?php echo e($st->created_at->format('M d, Y')); ?></span>
                                        </div>
                                    </div>
                                </div>
    ...
    <?php if($activeTab === 'ledger' || $activeTab === 'transactions'): ?>
        <div style="display:flex;flex-direction:column;gap:18px">
            ...
            <div style="background:#ffffff;border:1px solid rgba(226,232,240,0.85);border-radius:16px;padding:18px 22px;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:16px;box-shadow:0 2px 12px -2px rgba(0,0,0,0.03)">
                ...
                <div style="display:flex;align-items:center;gap:10px;flex-wrap:wrap">
                    <a href="<?php echo e(route($routePrefix . 'index', ['tab' => 'ai_report'])); ?>" class="btn btn-secondary btn-sm" style="padding:8px 16px;font-size:12.5px;font-weight:700;display:inline-flex;align-items:center;gap:6px">
            ...
            <div style="display:grid;grid-template-columns:repeat(auto-fit, minmax(220px, 1fr));gap:16px">
                ...
                <div style="background:#ffffff;border:1px solid rgba(226,232,240,0.85);border-radius:14px;padding:16px 18px;box-shadow:0 2px 8px rgba(0,0,0,0.02)">
                    ...
                    <div style="font-family:'Outfit',sans-serif;font-size:22px;font-weight:800;color:#0f172a;margin-top:6px">
                        <?php echo e($currencySymbol); ?> <?php echo e(number_format($totalIncome, 2)); ?>
                ...
                <div style="background:#ffffff;border:1px solid rgba(226,232,240,0.85);border-radius:14px;padding:16px 18px;box-shadow:0 2px 8px rgba(0,0,0,0.02)">
                    ...
                    <div style="font-family:'Outfit',sans-serif;font-size:22px;font-weight:800;color:#e11d48;margin-top:6px">
                        <?php echo e($currencySymbol); ?> <?php echo e(number_format($totalExpense, 2)); ?>
                ...
                <div style="background:#ffffff;border:1px solid rgba(226,232,240,0.85);border-radius:14px;padding:16px 18px;box-shadow:0 2px 8px rgba(0,0,0,0.02)">
                    <div style="display:flex;align-items:center;justify-content:space-between">
                        <span style="font-size:11px;font-weight:800;text-transform:uppercase;color:<?php echo e($netBalance >= 0 ? '#0284c7' : '#e11d48'); ?>;letter-spacing:0.5px">Net Operating Balance</span>
                        <span style="font-size:16px">⚖️</span>
                    </div>
                    <div style="font-family:'Outfit',sans-serif;font-size:22px;font-weight:800;color:<?php echo e($netBalance >= 0 ? '#0284c7' : '#e11d48'); ?>;margin-top:6px">
                        <?php echo e($currencySymbol); ?> <?php echo e(number_format($netBalance, 2)); ?>

                    </div>
                    <div style="font-size:11px;color:#64748b;margin-top:4px"><?php echo e($netBalance >= 0 ? 'Surplus Operating Balance' : 'Operating Deficit'); ?></div>
                </div>
            ...
            <div style="background:#ffffff;border:1px solid rgba(226,232,240,0.85);border-radius:14px;padding:12px 18px;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px">
                <form method="GET" action="<?php echo e(route($routePrefix . 'index')); ?>" style="display:flex;align-items:center;gap:10px;flex-wrap:wrap;flex:1">
                    ...
                    <div style="display:flex;align-items:center;gap:6px">
                        ...
                        <select name="head_id" onchange="this.form.submit()" style="padding:6px 12px;border:1px solid #cbd5e1;border-radius:8px;font-size:12px;color:#0f172a;background:#ffffff">
                            ...
                            <?php $__currentLoopData = $heads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($h->id); ?>" <?php echo e($headFilter == $h->id ? 'selected' : ''); ?>>
                                    <?php echo e($h->name); ?> (<?php echo e(strtoupper($h->type)); ?>)
                                </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    ...
                    <div style="display:flex;align-items:center;gap:6px">
                        ...
                        <select name="type" onchange="this.form.submit()" style="padding:6px 12px;border:1px solid #cbd5e1;border-radius:8px;font-size:12px;color:#0f172a;background:#ffffff">
                            ...
                            <option value="expense" <?php echo e($typeFilter === 'expense' ? 'selected' : ''); ?>>Expenses Only</option>
                            <option value="income" <?php echo e($typeFilter === 'income' ? 'selected' : ''); ?>>Income Only</option>
                        </select>
                    </div>

                    <?php if($headFilter || $typeFilter): ?>
                        <a href="<?php echo e(route($routePrefix . 'index', ['tab' => 'ledger'])); ?>" class="btn btn-ghost btn-sm" style="font-size:11.5px;color:#e11d48;padding:5px 10px">
                            ✕ Reset Filter
                        </a>
                    <?php endif; ?>
                </form>
                                    ...
                                    <tr>
                                        <td>
                                            <div style="font-weight:700;color:#0f172a;font-size:13px">
                                                <?php echo e(\Carbon\Carbon::parse($tx->transaction_date)->format('d M Y')); ?>

                                            </div>
                                            <div style="font-size:11px;color:#94a3b8"><?php echo e(\Carbon\Carbon::parse($tx->transaction_date)->format('l')); ?></div>
                                        </td>
                                        <td>
                                            <div style="font-weight:800;color:#0f172a;font-size:13.5px"><?php echo e($tx->title); ?></div>
                                            <?php if($tx->reference_number): ?>
                                                <div style="font-size:11px;color:#64748b">Ref: <code><?php echo e($tx->reference_number); ?></code></div>
                                            <?php endif; ?>
                                            <?php if($tx->notes): ?>
                                                <div style="font-size:11px;color:#94a3b8;margin-top:2px;max-width:240px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis" title="<?php echo e($tx->notes); ?>">
                                                    <?php echo e($tx->notes); ?>
                                        ...
                                        <td>
                                            <span style="font-size:12px;font-weight:700;color:#334155;background:#f8fafc;padding:4px 8px;border-radius:6px;border:1px solid #e2e8f0">
                                                <?php echo e($tx->accountHead->name ?? 'General'); ?>
                                        ...
                                        <td>
                                            <div style="font-family:'Outfit',sans-serif;font-size:15px;font-weight:800;color:<?php echo e($tx->type === 'income' ? '#059669' : '#dc2626'); ?>">
                                                <?php echo e($tx->type === 'income' ? '+' : '-'); ?> <?php echo e($currencySymbol); ?> <?php echo e(number_format($tx->amount, 2)); ?>

                                            </div>
                                        </td>
                                        <td>
                                            <div style="font-size:12px;color:#475569;font-weight:600"><?php echo e($tx->payment_method ?? 'N/A'); ?></div>
                                        </td>
                                        <td>
                                            <?php if($tx->receipt_image): ?>
                                                ...
                                                ?>
                                                <?php if($isPdf): ?>
                                                    <a href="<?php echo e($fileUrl); ?>" target="_blank" class="btn btn-ghost btn-sm" style="font-size:11px;padding:3px 8px;display:inline-flex;align-items:center;gap:4px">
                                                        📄 View PDF
                                                    </a>
                                                <?php else: ?>
                                                    <button type="button" onclick="viewReceiptImage('<?php echo e($fileUrl); ?>', '<?php echo e(addslashes($tx->title)); ?>')" class="btn btn-ghost btn-sm" style="font-size:11px;padding:3px 8px;display:inline-flex;align-items:center;gap:4px">
                                                        🖼️ View Bill
                                                    </button>
                                                <?php endif; ?>
                                            <?php else: ?>
                                        ...
                                        <td>
                                            <div style="font-size:12px;color:#0f172a;font-weight:700"><?php echo e($tx->creator->name ?? 'System'); ?></div>
                                        </td>
                                        <td style="text-align:right">
                                            <?php if($canEditAccounts): ?>
                                                <form method="POST" action="<?php echo e(route($routePrefix . 'transactions.destroy', $tx->id)); ?>" onsubmit="return confirm('Are you sure you want to delete this transaction? It will be removed from AI calculations.')" style="display:inline">
                                                    <?php echo csrf_field(); ?>
            ...
            <?php else: ?>
                <div style="overflow-x:auto">
                    <table>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $heads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td>
                                        <div style="font-weight:800;color:#0f172a;font-size:14px"><?php echo e($hd->name); ?></div>
                                    </td>
                                    <td>
                                        <?php if($hd->type === 'income'): ?>
                                    ...
                                    <td>
                                        <div style="font-size:12px;color:#64748b;font-weight:500"><?php echo e($hd->description ?: 'No detailed description'); ?></div>
                                    </td>
                                    <td>
                                        <?php if($hd->receipt_requirement === 'mandatory'): ?>
                                            <span class="badge badge-yellow">⚠️ MANDATORY PICTURE</span>
                                        <?php elseif($hd->receipt_requirement === 'optional'): ?>
                                    ...
                                    <td style="text-align:right">
                                        ...
                                        <div style="display:flex;align-items:center;justify-content:flex-end;gap:8px">
                                            <button type="button" class="btn btn-ghost btn-sm" onclick="editAccountHead(<?php echo e($hd->id); ?>, '<?php echo e(addslashes($hd->name)); ?>', '<?php echo e($hd->type); ?>', '<?php echo e(addslashes($hd->description ?? '')); ?>', '<?php echo e($hd->receipt_requirement); ?>', <?php echo e($hd->is_active ? 1 : 0); ?>)">
                                                Edit
                                            </button>
                                            <form method="POST" action="<?php echo e(route($routePrefix . 'heads.destroy', $hd->id)); ?>" onsubmit="return classyConfirmForm(this, 'Delete Account Head', 'Are you sure you want to delete head \'<?php echo e(addslashes($hd->name)); ?>\'? This cannot be undone.', { danger: true, icon: '🗑️', confirmText: 'Yes, Delete Head' })">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('DELETE'); ?>
        ...
        <div style="display:flex;flex-direction:column;gap:24px">
            ...
            <div class="card" style="margin-bottom:0">
                <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:16px">
                    ...
                    <form method="GET" action="<?php echo e(route($routePrefix . 'index')); ?>" style="display:flex;align-items:center;gap:8px;flex-wrap:wrap">
                        <input type="hidden" name="tab" value="ai_report">
                        
                        <button type="submit" name="period" value="weekly" class="btn <?php echo e($period === 'weekly' ? 'btn-primary' : 'btn-ghost'); ?> btn-sm">Weekly</button>
                        <button type="submit" name="period" value="monthly" class="btn <?php echo e($period === 'monthly' ? 'btn-primary' : 'btn-ghost'); ?> btn-sm">Monthly</button>
                        <button type="submit" name="period" value="jan_jun" class="btn <?php echo e($period === 'jan_jun' ? 'btn-primary' : 'btn-ghost'); ?> btn-sm">Jan - Jun</button>
                        <button type="submit" name="period" value="jul_dec" class="btn <?php echo e($period === 'jul_dec' ? 'btn-primary' : 'btn-ghost'); ?> btn-sm">Jul - Dec</button>
                        <button type="submit" name="period" value="annual" class="btn <?php echo e($period === 'annual' ? 'btn-primary' : 'btn-ghost'); ?> btn-sm">Annual</button>
                    </form>
                </div>

                
                <div style="margin-top:16px;padding-top:16px;border-top:1px solid #e2e8f0">
                    <form method="GET" action="<?php echo e(route($routePrefix . 'index')); ?>" style="display:flex;align-items:center;gap:12px;flex-wrap:wrap">
                        <input type="hidden" name="tab" value="ai_report">
                        <input type="hidden" name="period" value="custom">

                        <div style="display:flex;align-items:center;gap:6px">
                            <label style="font-size:11px;font-weight:700;color:#64748b">START DATE:</label>
                            <input type="date" name="start_date" value="<?php echo e($customStart ?: date('Y-m-01')); ?>" style="padding:6px 10px;background:#ffffff;border:1px solid #cbd5e1;border-radius:8px;color:#0f172a;font-size:12px">
                        </div>

                        <div style="display:flex;align-items:center;gap:6px">
                            <label style="font-size:11px;font-weight:700;color:#64748b">END DATE:</label>
                            <input type="date" name="end_date" value="<?php echo e($customEnd ?: date('Y-m-t')); ?>" style="padding:6px 10px;background:#ffffff;border:1px solid #cbd5e1;border-radius:8px;color:#0f172a;font-size:12px">
                        </div>
            ...
            <div style="display:grid;grid-template-columns:repeat(auto-fit, minmax(220px, 1fr));gap:16px">
                <div style="background:#ffffff;border:1px solid rgba(226,232,240,0.85);border-radius:18px;padding:22px;box-shadow:0 4px 20px -2px rgba(0,0,0,0.04)">
                    ...
                    <div style="font-family:'Outfit',sans-serif;font-size:26px;font-weight:800;color:#0f172a;margin-top:8px">
                        Rs. <?php echo e($m['total_income']); ?>

                    </div>
                    <div style="font-size:11px;color:#64748b;margin-top:6px;font-weight:500">
                        Top Revenue Stream: <strong style="color:#059669"><?php echo e($m['top_income_head']); ?></strong>
                    </div>
                </div>
                ...
                <div style="background:#ffffff;border:1px solid rgba(226,232,240,0.85);border-radius:18px;padding:22px;box-shadow:0 4px 20px -2px rgba(0,0,0,0.04)">
                    ...
                    <div style="font-family:'Outfit',sans-serif;font-size:26px;font-weight:800;color:#0f172a;margin-top:8px">
                        Rs. <?php echo e($m['total_expense']); ?>

                    </div>
                    <div style="font-size:11px;color:#64748b;margin-top:6px;font-weight:500">
                        Primary Cost Driver: <strong style="color:#dc2626"><?php echo e($m['top_expense_head']); ?></strong>
                    </div>
                </div>

                <div style="background:#ffffff;border:1px solid rgba(226,232,240,0.85);border-radius:18px;padding:22px;box-shadow:0 4px 20px -2px rgba(0,0,0,0.04)">
                    <div style="display:flex;align-items:center;justify-content:space-between">
                        <div style="font-size:11px;font-weight:800;text-transform:uppercase;color:<?php echo e($isProfit ? '#059669' : '#dc2626'); ?>;letter-spacing:1px">Net Profit / (Loss)</div>
                        <span style="font-size:11px;padding:3px 8px;border-radius:100px;background:<?php echo e($isProfit ? '#ecfdf5' : '#fee2e2'); ?>;color:<?php echo e($isProfit ? '#059669' : '#dc2626'); ?>;font-weight:800">
                            <?php echo e($isProfit ? '📈 GOING UP' : '📉 GOING DOWN'); ?>

                        </span>
                    </div>
                    <div style="font-family:'Outfit',sans-serif;font-size:26px;font-weight:800;color:<?php echo e($isProfit ? '#059669' : '#dc2626'); ?>;margin-top:8px">
                        Rs. <?php echo e($m['net_profit_loss']); ?>

                    </div>
                    <div style="font-size:11px;color:#64748b;margin-top:6px;font-weight:500">
                        Net Profit Margin: <strong style="color:#0f172a"><?php echo e($m['profit_margin_pct']); ?>%</strong>
                    </div>
                </div>
                ...
                <div style="background:#ffffff;border:1px solid rgba(226,232,240,0.85);border-radius:18px;padding:22px;box-shadow:0 4px 20px -2px rgba(0,0,0,0.04)">
                    ...
                    <div style="font-family:'Outfit',sans-serif;font-size:16px;font-weight:800;color:#0f172a;margin-top:8px">
                        <?php echo e($m['period_title']); ?>

                    </div>
                    <div style="font-size:11px;color:#64748b;margin-top:6px;font-weight:500">
                        Processed <strong style="color:#d97706"><?php echo e($m['transaction_count']); ?> transaction(s)</strong>
                    </div>
                </div>
            </div>
            ...
            <div style="display:grid;grid-template-columns:1fr 2fr;gap:20px">
                ...
                <div class="card" style="margin-bottom:0;display:flex;flex-direction:column;gap:20px;justify-content:center">
                    ...
                    <div style="display:flex;align-items:center;gap:16px;background:#f8fafc;padding:14px;border-radius:14px;border:1px solid #e2e8f0">
                        <div style="position:relative;width:80px;height:80px;flex-shrink:0">
                            <svg width="80" height="80" viewBox="0 0 100 100">
                                ...
                                <circle cx="50" cy="50" r="45" fill="none" stroke="<?php echo e($isProfit ? '#059669' : '#dc2626'); ?>" stroke-width="8" stroke-dasharray="283" stroke-dashoffset="<?php echo e($profitOffset); ?>" stroke-linecap="round" transform="rotate(-90 50 50)" />
                            </svg>
                    ...
                    <div style="display:flex;align-items:center;gap:16px;background:#f8fafc;padding:14px;border-radius:14px;border:1px solid #e2e8f0">
                        <div style="position:relative;width:80px;height:80px;flex-shrink:0">
                            <svg width="80" height="80" viewBox="0 0 100 100">
                                <circle cx="50" cy="50" r="45" fill="none" stroke="#e2e8f0" stroke-width="8" />
                                <circle cx="50" cy="50" r="45" fill="none" stroke="#dc2626" stroke-width="8" stroke-dasharray="283" stroke-dashoffset="<?php echo e($expRatioOffset); ?>" stroke-linecap="round" transform="rotate(-90 50 50)" />
                            </svg>
                ...
                <div class="card" style="margin-bottom:0">
                    ...
                    <div style="display:grid;grid-template-columns:repeat(6, 1fr);gap:12px;align-items:end;height:180px;padding-top:20px;border-bottom:1px solid #e2e8f0;padding-bottom:8px">
                        <?php $__currentLoopData = $trends; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <div style="display:flex;flex-direction:column;align-items:center;gap:6px;height:100%;justify-content:flex-end">
                                ...
                                <div style="display:flex;align-items:end;gap:4px;width:100%;justify-content:center">
                                    <div title="Income: Rs. <?php echo e(number_format($tr['income'], 2)); ?>" style="width:16px;height:<?php echo e($incHeight); ?>px;background:linear-gradient(to top, #059669, #10b981);border-radius:4px 4px 0 0;transition:all 0.3s"></div>
                                    <div title="Expense: Rs. <?php echo e(number_format($tr['expense'], 2)); ?>" style="width:16px;height:<?php echo e($expHeight); ?>px;background:linear-gradient(to top, #dc2626, #ef4444);border-radius:4px 4px 0 0;transition:all 0.3s"></div>
                                </div>
                                <span style="font-size:10px;font-weight:800;color:<?php echo e($tr['is_up'] ? '#059669' : '#dc2626'); ?>">
                                    <?php echo e($tr['is_up'] ? '📈 UP' : '📉 DOWN'); ?>

                                </span>
                                <span style="font-size:11px;color:#64748b;font-weight:700"><?php echo e($tr['short_month']); ?></span>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
            ...
            <div class="card" style="border:1px solid #e2e8f0;background:#ffffff;box-shadow:0 4px 20px -2px rgba(0,0,0,0.04)">
                <div class="card-header" style="border-bottom:1px solid #e2e8f0">
                    <div style="display:flex;align-items:center;gap:10px">
                        ...
                        <div>
                            ...
                            <div style="font-size:11px;color:#059669;font-weight:700">Audit Scope: <?php echo e($m['period_title']); ?></div>
                        </div>
                    </div>
                ...
                <div class="ai-report-presentation" style="line-height:1.7;color:#334155;font-size:14px;padding:24px">
                    <?php if(str_contains($aiReportData['ai_analysis'], '<div')): ?>
                        <?php echo \App\Support\HtmlSanitizer::clean($aiReportData['ai_analysis']); ?>

                    <?php else: ?>
                        <?php echo \App\Support\HtmlSanitizer::clean(\Illuminate\Support\Str::markdown(e($aiReportData['ai_analysis']))); ?>
...
<div id="addTransactionModal" style="display:none;position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(15,23,42,0.5);backdrop-filter:blur(8px);z-index:9999;align-items:center;justify-content:center;padding:16px">
    <div style="max-width:560px;width:100%;max-height:88vh;background:#ffffff;border:1px solid #e2e8f0;border-radius:22px;box-shadow:0 25px 60px rgba(0,0,0,0.15);display:flex;flex-direction:column;overflow:hidden">
        ...
        <form method="POST" action="<?php echo e(route($routePrefix . 'transactions.store')); ?>" enctype="multipart/form-data" style="display:flex;flex-direction:column;flex:1;overflow:hidden;margin:0">
            <?php echo csrf_field(); ?>
            ...
            <div style="padding:20px 24px;overflow-y:auto;flex:1;display:flex;flex-direction:column;gap:16px">
                <div class="form-group" style="margin:0">
                    ...
                    <select name="account_head_id" id="tx_head_select" onchange="checkHeadRequirement()" required style="width:100%;padding:11px 14px;background:#ffffff;border:1px solid #cbd5e1;border-radius:10px;color:#0f172a;font-size:14px">
                        ...
                        <?php $__currentLoopData = $heads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($hd->id); ?>" data-requirement="<?php echo e($hd->receipt_requirement); ?>" data-type="<?php echo e($hd->type); ?>">
                                <?php echo e($hd->name); ?> (<?php echo e(strtoupper($hd->type)); ?>) — <?php echo e(strtoupper($hd->receipt_requirement)); ?> RECEIPT
                            </option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
                    ...
                    <div class="form-group" style="margin:0">
                        ...
                        <input type="date" name="transaction_date" value="<?php echo e(date('Y-m-d')); ?>" required style="width:100%;padding:11px 14px;background:#ffffff;border:1px solid #cbd5e1;border-radius:10px;color:#0f172a;font-size:14px">
                    </div>
                </div>
...
<div id="addHeadModal" style="display:none;position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(15,23,42,0.5);backdrop-filter:blur(8px);z-index:9999;align-items:center;justify-content:center;padding:16px">
    <div style="max-width:520px;width:100%;max-height:88vh;background:#ffffff;border:1px solid #e2e8f0;border-radius:22px;box-shadow:0 25px 60px rgba(0,0,0,0.15);display:flex;flex-direction:column;overflow:hidden">
        ...
        <form id="headModalForm" method="POST" action="<?php echo e(route($routePrefix . 'heads.store')); ?>" style="display:flex;flex-direction:column;flex:1;overflow:hidden;margin:0">
            <?php echo csrf_field(); ?>
            ...
            <div style="padding:20px 24px;overflow-y:auto;flex:1;display:flex;flex-direction:column;gap:16px">
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
                    <div class="form-group" style="margin:0">
                        ...
                        <input type="text" name="month_year" value="<?php echo e(date('F Y')); ?>" placeholder="e.g. August 2026" required style="width:100%;padding:11px 14px;background:#ffffff;border:1px solid #cbd5e1;border-radius:10px;color:#0f172a;font-size:14px">
                    </div>
                    <div class="form-group" style="margin:0">
            ...
            <div style="padding:20px 24px;overflow-y:auto;flex:1;display:flex;flex-direction:column;gap:14px">
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
                    <div class="form-group" style="margin:0">
                        ...
                        <select name="account_head_id" id="tx_head_select" onchange="checkHeadRequirement()" required style="width:100%;padding:10px 14px;background:#ffffff;border:1px solid #cbd5e1;border-radius:10px;color:#0f172a;font-size:13px">
                            <option value="">Select Account Head</option>
                            <?php $__currentLoopData = $heads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($hd->id); ?>" data-requirement="<?php echo e($hd->receipt_requirement); ?>" <?php echo e($hd->type === 'expense' ? '' : 'style=color:#059669'); ?>>
                                    <?php echo e($hd->name); ?> (<?php echo e(strtoupper($hd->type)); ?>)
                                </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
                    <div class="form-group" style="margin:0">
                        ...
                        <input type="date" name="transaction_date" value="<?php echo e(date('Y-m-d')); ?>" required style="width:100%;padding:10px 14px;background:#ffffff;border:1px solid #cbd5e1;border-radius:10px;color:#0f172a;font-size:13px">
                    </div>
...
<script>
    ...
    function openSalaryModal(teacherId, teacherName) {
        ...
        let storeRoute = "<?php echo e(route($routePrefix . 'salaries.store', 9999)); ?>".replace('9999', teacherId);
    ...
    function editAccountHead(id, name, type, description, receiptReq, isActive) {
        ...
        let updateRoute = "<?php echo e(route($routePrefix . 'heads.update', 9999)); ?>".replace('9999', id);
    ...
    <div class="apple-liquid-glass-card" style="width:100%;max-width:540px;max-height:90vh;overflow-y:auto;padding:26px 28px;border-radius:24px;box-sizing:border-box;box-shadow:0 25px 60px -12px rgba(15,23,42,0.35)">
        <div style="display:flex;align-items:flex-start;justify-content:space-between;margin-bottom:18px;border-bottom:1px solid #e2e8f0;padding-bottom:14px">
            <div>
                ...
                <p style="font-size:12px;color:#64748b;margin-top:4px">
                    Disburse salaries for <?php echo e(now()->format('F Y')); ?> and deduct total payroll directly from collected income.
                </p>
            </div>
        ...
        <div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:16px;padding:16px;margin-bottom:20px;display:flex;flex-direction:column;gap:12px">
            <div style="display:flex;align-items:center;justify-content:space-between">
                ...
                <span style="font-size:14px;font-weight:800;color:#059669"><?php echo e($currencySymbol); ?> <?php echo e(number_format($totalIncome, 2)); ?></span>
            </div>
            <div style="display:flex;align-items:center;justify-content:space-between">
                <span style="font-size:13px;color:#64748b;font-weight:600">Total Monthly Staff Payroll</span>
                <span style="font-size:14px;font-weight:800;color:#e11d48">- <?php echo e($currencySymbol); ?> <?php echo e(number_format($totalConfiguredPayroll, 2)); ?></span>
            </div>
            <div style="border-top:1px dashed #cbd5e1;padding-top:10px;display:flex;align-items:center;justify-content:space-between">
                ...
                <span style="font-size:16px;font-weight:800;color:<?php echo e(($totalIncome - $totalConfiguredPayroll) >= 0 ? '#0284c7' : '#e11d48'); ?>">
                    <?php echo e($currencySymbol); ?> <?php echo e(number_format($totalIncome - $totalConfiguredPayroll, 2)); ?>

                </span>
            </div>
        </div>

        <form method="POST" action="<?php echo e(route($routePrefix . 'salaries.auto-disburse')); ?>">
            <?php echo csrf_field(); ?>
            <div style="font-size:12.5px;color:#475569;background:#eff6ff;border:1px solid #bfdbfe;border-radius:12px;padding:12px 16px;margin-bottom:20px;line-height:1.5;font-weight:600">
                ℹ️ Executing this action will auto-generate expense ledger entries for all active faculty &amp; staff members, generate monthly salary slips for <?php echo e(now()->format('F Y')); ?>, and deduct the total payroll amount from total institute income reserves.
            </div>
        ...
        <form method="POST" action="<?php echo e(route('principal.bulk-import.finance')); ?>" enctype="multipart/form-data">
            ...
            <div style="background:#f8fafc;border:1px solid #cbd5e1;border-radius:12px;padding:14px;margin-bottom:16px">
                <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px">
                    ...
                    <a href="<?php echo e(route('principal.bulk-import.sample', 'finance')); ?>" class="btn btn-ghost btn-sm" style="font-size:11px;color:#0284c7;padding:4px 10px">
...
<?php echo $__env->make(auth()->check() && !auth()->user()->isPrincipal() && !auth()->user()->isGlobalAdmin() ? 'layouts.app' : 'principal.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\UPLYFT\uplifyt\resources\views\principal\accounts\index.blade.php ENDPATH**/ ?>