<?php $__env->startSection('title', 'Academic Years & Terms'); ?>
<?php $__env->startSection('breadcrumb', 'Academic Years & Terms'); ?>
...
<div style="display:grid;grid-template-columns:1.8fr 1fr;gap:24px;margin-bottom:28px">
    ...
    <div class="card">
        <div class="card-header">
            <div class="card-title" style="display:flex;align-items:center;gap:10px">
                ...
                <span class="badge badge-purple" style="font-size:11px;font-weight:700"><?php echo e($terms->count()); ?> Sessions</span>
            </div>
        </div>
        ...
        <div style="overflow-x:auto">
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <strong style="font-size:15px;color:#0f172a"><?php echo e($term->name); ?></strong>
                        </td>
                        <td style="font-size:13px;color:#64748b;font-weight:500">
                            <?php echo e($term->start_date->format('d M Y')); ?> &rarr; <?php echo e($term->end_date->format('d M Y')); ?>
                        ...
                        <td>
                            <form method="POST" action="<?php echo e(route('principal.academic-terms.update-deadline', $term)); ?>" style="display:flex;flex-direction:column;gap:4px">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PUT'); ?>
                                <?php if($term->promotion_deadline): ?>
                                    <?php if($term->isPromotionWindowOpen()): ?>
                                        <span class="badge badge-green" style="font-size:10px">
                                            🎓 Open until <?php echo e($term->promotion_deadline->format('d M Y, h:i A')); ?>

                                        </span>
                                    <?php else: ?>
                                        <span class="badge badge-yellow" style="font-size:10px">
                                            ⏳ Closed (Expired <?php echo e($term->promotion_deadline->format('d M Y, h:i A')); ?>)
                                        </span>
                                    <?php endif; ?>
                                <?php else: ?>
                                ...
                                <div style="display:flex;align-items:center;gap:4px;margin-top:2px">
                                    <input type="datetime-local" 
                                           ...
                                           value="<?php echo e($term->promotion_deadline ? $term->promotion_deadline->format('Y-m-d\TH:i') : ''); ?>"
                        ...
                        <td style="text-align:right">
                            <div style="display:inline-flex;gap:8px;align-items:center">
                                <?php if(!$term->is_active): ?>
                                    <form method="POST" action="<?php echo e(route('principal.academic-terms.set-active', $term)); ?>" style="margin:0">
                                        <?php echo csrf_field(); ?>
                                ...
                                <button type="button" 
                                        onclick="prefillCloneModal(<?php echo e($term->id); ?>)" 
                                ...
                                <form method="POST" action="<?php echo e(route('principal.academic-terms.destroy', $term)); ?>" style="margin:0">
                                    <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
                                    <button type="button" 
                                            onclick="classyConfirmForm(this, 'Delete Academic Term <?php echo e($term->name); ?>?', 'WARNING: This will permanently delete term classes, sections, subjects, faculty allocations, and timetable slots associated with <?php echo e($term->name); ?>.', {danger: true, confirmText: 'Yes, Delete Term & Data', icon: '🗑️'})" 
    ...
    <div class="card">
        ...
        <form method="POST" action="<?php echo e(route('principal.academic-terms.store')); ?>">
            <?php echo csrf_field(); ?>

            <div class="form-group">
                <label for="name">Term Name *</label>
                <input id="name" type="text" name="name" placeholder="e.g. 2025-2026, Fall 2026, AUG 2026 - Dec 2027" required value="<?php echo e(old('name')); ?>">
                <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="form-error" style="color:#ef4444;font-size:12px;margin-top:4px"><?php echo e($message); ?></p><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input id="start_date" type="date" name="start_date" required value="<?php echo e(old('start_date')); ?>">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input id="end_date" type="date" name="end_date" required value="<?php echo e(old('end_date')); ?>">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input id="promotion_deadline" type="datetime-local" name="promotion_deadline" value="<?php echo e(old('promotion_deadline')); ?>">
                <div style="font-size:11px;color:#64748b;margin-top:4px">
                    The "Promote Class" feature will automatically disappear after this date &amp; time.
                </div>
                <?php $__errorArgs = ['promotion_deadline'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="form-error" style="color:#ef4444;font-size:12px;margin-top:4px"><?php echo e($message); ?></p><?php unset($message);
...
<div class="card" id="clone-section" style="background:#ffffff;border:1px solid rgba(226,232,240,0.85)">
    ...
    <?php if($terms->count() >= 2): ?>
    <form method="POST" action="<?php echo e(route('principal.academic-terms.clone')); ?>">
        <?php echo csrf_field(); ?>
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;margin-bottom:20px">
            <div class="form-group" style="margin-bottom:0">
                ...
                <select id="source_term_id" name="source_term_id" required style="border-color:#cbd5e1">
                    ...
                    <?php $__currentLoopData = $terms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($t->id); ?>"><?php echo e($t->name); ?> (<?php echo e($t->start_date->format('M Y')); ?> - <?php echo e($t->end_date->format('M Y')); ?>)</option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            ...
            <div class="form-group" style="margin-bottom:0">
                ...
                <select id="target_term_id" name="target_term_id" required style="border-color:#cbd5e1">
                    ...
                    <?php $__currentLoopData = $terms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($t->id); ?>" <?php echo e($t->is_active ? 'selected' : ''); ?>>
...
<?php echo $__env->make(auth()->check() && auth()->user()->isTeacher() ? 'layouts.app' : 'principal.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\UPLYFT\uplifyt\resources\views\principal\academic-terms\index.blade.php ENDPATH**/ ?>