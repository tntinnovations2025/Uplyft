<?php $__env->startSection('title', 'Principal Accounts'); ?>
<?php $__env->startSection('breadcrumb', 'Principal Accounts'); ?>
...
<div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:24px">
    ...
    <a href="<?php echo e(route('global-admin.accounts.principals.create')); ?>" class="btn btn-primary">
...
<div class="card">
    <div class="card-header">
        ...
        <span class="badge badge-purple" style="font-size:11px;font-weight:700"><?php echo e($principals->total()); ?> Total</span>
    </div>
    ...
    <div style="overflow-x:hidden;width:100%">
        <table class="data-table" style="width:100%">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $principals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $principal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td>
                            <div style="font-weight:800;color:#0f172a;font-size:14px"><?php echo e($principal->name); ?></div>
                        </td>
                        <td style="color:#64748b;font-weight:600;font-size:13px"><?php echo e($principal->email ?? '—'); ?></td>
                        <td>
                            <span class="badge badge-purple" style="font-size:10px"><?php echo e($principal->identifier ?? '—'); ?></span>
                        </td>
                        <td>
                            <div style="font-weight:700;color:#0f172a;font-size:13px"><?php echo e($principal->institute->name ?? '—'); ?></div>
                        </td>
                        <td style="color:#64748b;font-size:12.5px;font-weight:500"><?php echo e($principal->created_at->format('M d, Y')); ?></td>
                        <td style="text-align:right">
                            <div style="display:flex;align-items:center;justify-content:flex-end;gap:5px;flex-wrap:wrap">
                                <button type="button" 
                                        onclick="openRoleModal('<?php echo e($principal->id); ?>', '<?php echo e(addslashes($principal->name)); ?>', '<?php echo e(addslashes($principal->email)); ?>', '<?php echo e($principal->role); ?>')"
                                ...
                                <form method="POST" action="<?php echo e(route('global-admin.accounts.principals.destroy', $principal)); ?>"
                                    ...
                                    <button type="button" 
                                            onclick="openDeletePrincipalModal(this.form, '<?php echo e(addslashes($principal->name)); ?>', '<?php echo e(addslashes($principal->email)); ?>', '<?php echo e(addslashes($principal->institute->name ?? 'this institute')); ?>')"
...
<?php echo $__env->make('global-admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\UPLYFT\uplifyt\resources\views\global-admin\accounts\principals-index.blade.php ENDPATH**/ ?>