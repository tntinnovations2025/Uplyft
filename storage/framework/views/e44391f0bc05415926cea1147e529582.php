<?php $__env->startSection('breadcrumb', 'Modular Feature Switchboard — ' . $institute->name); ?>
<?php $__env->startSection('title', 'SaaS Feature Switchboard — ' . $institute->name); ?>
    ...
    <div class="hero-top-row">
        <div class="institute-identity">
            ...
            <div class="inst-details">
                <h1>
                    <span><?php echo e($institute->name); ?></span>
                ...
                <div style="color:var(--text-muted);font-size:13px;margin-top:4px;display:flex;align-items:center;gap:12px">
                    <span>
                        ...
                        <strong style="color:#0f172a"><?php echo e(ucfirst($institute->subscription_tier)); ?> Tier</strong>
                    </span>
                    <span>•</span>
                    <span>
                        <i class="fa-solid fa-location-dot mr-1" style="color:#64748b"></i>
                        <?php echo e($institute->city ?? 'Main Campus'); ?>

                    </span>
                    <span>•</span>
                    <a href="<?php echo e(route('global-admin.institutes.show', $institute)); ?>" style="color:#0284c7;text-decoration:none;font-weight:700">
        ...
        <div class="meter-card">
            <div class="meter-header">
                ...
                <span id="meter-pct" style="font-weight:700;color:var(--accent-cyan)"><?php echo e($pct); ?>%</span>
            </div>
            <div class="meter-count">
                <span id="active-count-display"><?php echo e($activeCount); ?></span> / <?php echo e($totalCount); ?>

            </div>
            <div class="meter-bar-track">
                <div class="meter-bar-fill" id="meter-fill" style="width: <?php echo e($pct); ?>%"></div>
            </div>
        </div>
    </div>
</div>
...
<!-- MASTER FORM -->
<form method="POST" action="<?php echo e(route('global-admin.institutes.toggles.update', $institute)); ?>" id="feature-toggle-form">
    <?php echo csrf_field(); ?>
    ...
    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $catKey => $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="category-section" data-cat="<?php echo e($catKey); ?>" id="sec-<?php echo e($catKey); ?>">
            <div class="category-header">
                <div class="category-title-wrap">
                    ...
                    <span class="category-count-badge cat-counter" data-cat="<?php echo e($catKey); ?>">
                        <?php echo e(count($cat['keys'])); ?> Modules
                    </span>
                </div>

                <div class="category-actions">
                    <button type="button" class="cat-btn" onclick="toggleCategoryGroup('<?php echo e($catKey); ?>', true)">
                        <i class="fa-solid fa-check mr-1"></i> Enable All
                    </button>
                    <button type="button" class="cat-btn" onclick="toggleCategoryGroup('<?php echo e($catKey); ?>', false)">
            ...
            <div class="features-grid">
                <?php $__currentLoopData = $cat['keys']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    ?>
                    <div class="feature-card <?php echo e($isActive ? 'is-active' : ''); ?>" data-key="<?php echo e($key); ?>" data-search-target="<?php echo e(strtolower($label . ' ' . $key . ' ' . $meta['desc'] . ' ' . $meta['badge'])); ?>">
                        <div class="card-top">
                            <div class="card-icon-title">
                                ...
                                <div class="feat-meta-title">
                                    ...
                                    <span class="feat-badge"><?php echo e($meta['badge']); ?></span>
                                </div>
                            </div>
                            ...
                            <label class="ios-switch">
                                <input type="checkbox" 
                                       name="<?php echo e($key); ?>" 
                                       id="toggle-<?php echo e($key); ?>" 
                                       class="feature-checkbox" 
                                       data-key="<?php echo e($key); ?>" 
                                       value="1" 
                                       <?php echo e($isActive ? 'checked' : ''); ?>

                                       onchange="handleToggleChange('<?php echo e($key); ?>', this)">
                        ...
                        <div class="card-bottom">
                            <div class="card-key-tag">
                                <code><?php echo e($key); ?></code>
                            </div>
                            <div class="status-indicator <?php echo e($isActive ? 'active' : 'inactive'); ?>" id="status-<?php echo e($key); ?>">
                                <i class="fa-solid <?php echo e($isActive ? 'fa-circle-check' : 'fa-circle-minus'); ?>"></i>
                                <span><?php echo e($isActive ? 'Active' : 'Disabled'); ?></span>
                            </div>
                        </div>
                    </div>
    ...
    <div class="floating-action-bar">
        <div class="floating-left">
            <div style="font-size:13px;color:var(--text);font-weight:600">
                <span id="float-active-count" style="color:var(--accent-cyan);font-weight:800"><?php echo e($activeCount); ?></span> of <?php echo e($totalCount); ?> Features Enabled
            </div>
        ...
        <div style="display:flex;align-items:center;gap:12px">
            <a href="<?php echo e(route('global-admin.institutes.show', $institute)); ?>" class="cat-btn" style="padding:10px 18px;font-size:13px;border-radius:10px">
                Discard / Back
            </a>
...
<script>
    const INSTITUTE_ID = <?php echo e($institute->id); ?>;
    const TOTAL_KEYS = <?php echo e($totalCount); ?>;
    ...
    async function handleToggleChange(key, inputElem) {
        ...
        try {
            ...
            const res = await fetch(`<?php echo e(route('global-admin.institutes.toggles.update', $institute)); ?>`, {
                method: 'POST',
                headers: {
    ...
    async function applyPresetTier(tier) {
        try {
            ...
            const res = await fetch(`<?php echo e(route('global-admin.institutes.toggles.apply-tier', $institute)); ?>`, {
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
                    'Accept': 'application/json'
...
<?php echo $__env->make('global-admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\UPLYFT\uplifyt\resources\views\global-admin\toggles\edit.blade.php ENDPATH**/ ?>