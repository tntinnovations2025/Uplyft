...
<?php endif; ?>
    ...
    <form id="loginForm" method="POST" action="<?php echo e($studentLogin ? route('student.login.store') : route('login')); ?>">
        <?php echo csrf_field(); ?>

        <!-- 1. Email (Student portal) or Email / Institutional ID (others) -->
        <div class="input-group">
            <label for="credential" class="input-label"><?php echo e($studentLogin ? 'Email Address' : 'Email Address or ID'); ?></label>
            <div class="input-wrapper">
                <input id="credential" class="custom-input" type="<?php echo e($studentLogin ? 'email' : 'text'); ?>" name="credential" value="<?php echo e(old('credential')); ?>" required autofocus autocomplete="username"
                    placeholder="<?php echo e($studentLogin ? 'e.g. student@apex.edu.pk' : 'e.g. teacher@apex.edu.pk, STU-2025-001'); ?>" />
...
<?php endif; ?>
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;font-size:9.5px;color:#64748b;margin-top:2px;">
            ...
            <?php if(Route::has('password.request')): ?>
                <a href="<?php echo e(route('password.request')); ?>" style="color:#0284c7;text-decoration:none;font-weight:700">Forgot Password?</a>
            <?php endif; ?>
        </div>
...
<?php endif; ?>
<?php /**PATH D:\UPLYFT\uplifyt\resources\views\auth\login.blade.php ENDPATH**/ ?>