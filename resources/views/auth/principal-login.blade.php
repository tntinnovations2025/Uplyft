<x-guest-layout>
    ...
    <form id="principalLoginForm" method="POST" action="{{ route('login') }}">
        @csrf
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;font-size:9.5px;color:#64748b;margin-top:2px;">
            ...
            @if (Route::has('password.request'))
                <a href="{{ route('password.request') }}" style="color:#059669;text-decoration:none;font-weight:700">Forgot Password?</a>
            @endif
        </div>
