@props(['name', 'class' => 'w-[19px] h-[19px]'])
...
<svg viewBox="0 0 24 24" {{ $attributes->merge(['class' => $class]) }} stroke="currentColor" fill="none" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round">
@switch($key)
    {{-- ── Overview / Dashboards ── --}}
    @case('chart-pie')
    ...
    {{-- ── Organizations / Institutes / Campuses ── --}}
    @case('sitemap')
