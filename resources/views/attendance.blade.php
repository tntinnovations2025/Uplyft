...
<div class="space-y-6">
    ...
    <div class="liquid-glass-card p-5 flex flex-col md:flex-row items-center justify-between gap-4 border border-slate-200/90 shadow-2xs glass-specular-top">
        ...
        <div class="flex flex-wrap items-center gap-3 w-full md:w-auto">
            ...
            <!-- Date Picker -->
            <div>
                <input type="date" id="attendance_date" class="p-2.5 rounded-xl text-xs font-semibold bg-white border border-slate-300 text-slate-800 shadow-2xs outline-none focus:border-pink-500" value="{{ date('Y-m-d') }}" onchange="loadRoster()">
            </div>
