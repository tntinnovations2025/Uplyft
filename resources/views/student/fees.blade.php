            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="text-sm text-slate-700 divide-y divide-slate-100 bg-white">
                    <tr>
                        ...
                        <td class="py-3.5 px-5 text-right font-bold text-slate-900 font-mono">{{ $currencySymbol ?? 'PKR' }} {{ number_format($baseFee, 2) }}</td>
                    </tr>
                    <tr>
                        ...
                        <td class="py-3.5 px-5 text-right font-bold text-slate-900 font-mono">{{ $currencySymbol ?? 'PKR' }} {{ number_format($taxAmount, 2) }}</td>
                    </tr>
                    <tr class="bg-slate-50/80 font-extrabold text-slate-900 border-t-2 border-slate-200">
                        ...
                        <td class="py-4 px-5 text-right text-base text-pink-700 font-extrabold font-mono">{{ $currencySymbol ?? 'PKR' }} {{ number_format($totalFee, 2) }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
