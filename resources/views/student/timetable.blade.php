...
<div class="space-y-6">
    <div class="glass-panel p-6 bg-gradient-to-r from-indigo-900/40 to-slate-900/60 flex items-center justify-between">
        <div>
            ...
            <p class="text-xs text-slate-400">Your scheduled classes for the current semester.</p>
        </div>
            ...
            <div class="min-w-[800px]">
                ...
                <div class="grid grid-cols-6 gap-4 mb-4">
                    ...
                    <div class="bg-indigo-500/10 border border-indigo-500/20 rounded-lg p-3 text-left">
                        <div class="text-sm font-bold text-indigo-300">CS-101</div>
                        <div class="text-[10px] text-slate-400">Room 302</div>
                    </div>
                    ...
                    <div class="bg-emerald-500/10 border border-emerald-500/20 rounded-lg p-3 text-left">
                        <div class="text-sm font-bold text-emerald-300">ENG-105</div>
                        <div class="text-[10px] text-slate-400">Hall A</div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-6 gap-4 mb-4">
                    ...
                    <div class="bg-cyan-500/10 border border-cyan-500/20 rounded-lg p-3 text-left">
                        <div class="text-sm font-bold text-cyan-300">MATH-201</div>
                        <div class="text-[10px] text-slate-400">Room 405</div>
                    </div>
                    <div class="bg-transparent border border-dashed border-white/10 rounded-lg p-3"></div>
                    <div class="bg-cyan-500/10 border border-cyan-500/20 rounded-lg p-3 text-left">
                        <div class="text-sm font-bold text-cyan-300">MATH-201</div>
