...
<head>
    ...
    <title>@yield('title', 'Global Admin Hub') — UPLYFT Governance</title>
...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav custom-scrollbar" style="padding: 10px 10px 20px;">
        {{-- Main Menu --}}
        <div id="admin-main-nav" class="space-y-1.5" style="display: {{ $adminSubGroup ? 'none' : 'block' }};">
            <a href="{{ route('global-admin.dashboard') }}"
               class="nav-link {{ request()->routeIs('global-admin.dashboard') ? 'active' : '' }}" style="margin-bottom: 8px;">
                <span class="icon"><x-icon name="chart-pie" /></span> Platform Overview
            </a>
            ...
            <button type="button" onclick="showAdminSubNav('organizations')" class="sidebar-hub-card-btn {{ $adminSubGroup === 'organizations' ? 'active' : '' }}">
                <div class="hub-btn-left">
                    <span class="hub-btn-icon" style="background:rgba(59,130,246,0.15);color:#60a5fa;"><x-icon name="sitemap" /></span>
            ...
            <button type="button" onclick="showAdminSubNav('access')" class="sidebar-hub-card-btn {{ $adminSubGroup === 'access' ? 'active' : '' }}">
                <div class="hub-btn-left">
                    <span class="hub-btn-icon" style="background:rgba(234,179,8,0.15);color:#eab308;"><x-icon name="user-shield" /></span>
                    <div class="hub-btn-text">
            ...
            <!-- Settings -->
            <a href="{{ route('profile.edit') }}" class="nav-link {{ request()->routeIs('profile.edit') ? 'active' : '' }}" style="margin-top: 8px;">
                <span class="icon"><x-icon name="user-gear" /></span> Settings
            </a>
            ...
            <form method="POST" action="{{ route('logout') }}" style="margin-top: 4px;">
                ...
                <button type="submit" class="nav-link" style="cursor:pointer;width:100%;text-align:left;">
                    <span class="icon"><x-icon name="arrow-right-from-bracket" /></span> Sign Out
                </button>
            </form>
        </div>

        {{-- Submenu: Organizations & Institutes --}}
        <div id="subnav-organizations" class="sidebar-subnav-panel space-y-1" style="display: {{ $adminSubGroup === 'organizations' ? 'block' : 'none' }};">
            <div class="subnav-header">
                ...
                <div class="subnav-badge" style="color:#60a5fa;">
                    <x-icon name="sitemap" class="w-3.5 h-3.5 text-[#60a5fa]" />
                    <span>Organizations &amp; Campuses</span>
                </div>
            </div>

            <a href="{{ route('global-admin.organizations.index') }}"
               class="nav-link {{ request()->routeIs('global-admin.organizations.index') || request()->routeIs('global-admin.organizations.show') || request()->routeIs('global-admin.organizations.edit') ? 'active' : '' }}">
                <span class="icon"><x-icon name="sitemap" /></span> Registered Organizations
            </a>
            <a href="{{ route('global-admin.organizations.create') }}"
               class="nav-link {{ request()->routeIs('global-admin.organizations.create') ? 'active' : '' }}">
                <span class="icon"><x-icon name="square-plus" /></span> Register Organization
            </a>
            <a href="{{ route('global-admin.institutes.index') }}"
               class="nav-link {{ request()->routeIs('global-admin.institutes.index') || request()->routeIs('global-admin.institutes.show') || request()->routeIs('global-admin.institutes.edit') ? 'active' : '' }}">
                <span class="icon"><x-icon name="building-columns" /></span> Registered Institutes
            </a>
            <a href="{{ route('global-admin.institutes.create') }}"
               class="nav-link {{ request()->routeIs('global-admin.institutes.create') ? 'active' : '' }}">
                <span class="icon"><x-icon name="plus" /></span> Register Institute
            </a>
        </div>

        {{-- Submenu: Access Control & Security --}}
        <div id="subnav-access" class="sidebar-subnav-panel space-y-1" style="display: {{ $adminSubGroup === 'access' ? 'block' : 'none' }};">
            <div class="subnav-header">
                <button type="button" onclick="backToDashboard()" class="subnav-back-btn">
                    <span class="subnav-back-icon"><x-icon name="arrow-left" class="w-4 h-4" /></span>
                    <span>Back</span>
                ...
                <div class="subnav-badge" style="color:#eab308;">
                    <x-icon name="user-shield" class="w-3.5 h-3.5 text-[#eab308]" />
                    <span>Access Control &amp; Security</span>
                </div>
            </div>

            <a href="{{ route('global-admin.accounts.principals.index') }}"
               class="nav-link {{ request()->routeIs('global-admin.accounts.principals.*') ? 'active' : '' }}">
                <span class="icon"><x-icon name="user-shield" /></span> Principal Accounts
            </a>
            <a href="{{ route('global-admin.password-resets.index') }}"
               class="nav-link {{ request()->routeIs('global-admin.password-resets.*') ? 'active' : '' }}">
                <span class="icon"><x-icon name="key" /></span> Password Resets
            </a>
        </div>
    </nav>
...
<div id="globalClassyConfirmModal" class="apple-liquid-glass-overlay" style="display:none;z-index:999999;">
    ...
    <script>
        ...
        (function() {
            ...
            var loginUrl = '{{ route("global-admin.login") }}';
