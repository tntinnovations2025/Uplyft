...
<head>
    ...
    <style>
        ...
        .header { background: linear-gradient(135deg, #D48A2E, #C07A22); padding: 32px 28px; color: #fff; }
        ...
        .cta { display: inline-block; background: #D48A2E; color: #fff !important; padding: 12px 28px; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 14px; margin-top: 12px; }
