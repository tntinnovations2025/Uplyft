...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>{{ $user->institute?->name ?? 'UPLYFT' }} — Account Security</p>
        </div>
        <div class="body">
            <p>Hello <strong>{{ $user->name }}</strong>,</p>
            <p>A request was made to change the password for your account (<strong>{{ $user->email }}</strong>). Use the One-Time Passcode below to complete the change.</p>
