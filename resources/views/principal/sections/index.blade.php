...
<div style="display:grid;grid-template-columns:2fr 1fr;gap:24px">
    ...
    <div style="display:flex;flex-direction:column;gap:20px">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form method="POST" action="{{ route($routePrefix . 'sections.destroy', $section) }}" onsubmit="return confirm('Remove section?')">
                                    @csrf @method('DELETE')
        ...
        <div class="card">
            ...
            <a href="{{ route($routePrefix . 'classes-subjects.index') }}" class="btn btn-primary btn-sm" style="margin-top:12px">Provision Classes &rarr;</a>
        </div>
        @endif
    </div>
    ...
    <div>
        <div class="card">
            ...
            <form method="POST" action="{{ route($routePrefix . 'sections.store') }}">
                @csrf
