...
@section('title', 'Edit Faculty Profile: ' . $teacher->full_name)
@section('breadcrumb', 'Edit Faculty Sensitive Profile')
...
<div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:18px;flex-wrap:wrap;gap:12px">
    ...
    <div style="display:flex;gap:10px">
        <a href="{{ route($routePrefix . 'teacher', $teacher) }}" class="btn btn-ghost">
            <span><x-icon name="arrow-left" class="w-3.5 h-3.5" /></span> Back to Profile
        </a>
    </div>
</div>

<form method="POST" action="{{ route($routePrefix . 'teacher.update', $teacher) }}">
    @csrf
    @method('PUT')
    ...
    <div class="edit-card">
        <h2 class="edit-section-title">👤 Personal Identification</h2>
        <div class="form-grid form-grid-2 mb-4">
            ...
            <div class="form-group">
                ...
                <input type="email" name="email" value="{{ old('email', $teacher->email ?? $teacher->user?->email) }}" required>
                <div class="help-text">Used as the login email for the faculty account.</div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="help-text">Sensitive identification number shown on the profile.</div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="specialization_subjects" value="{{ old('specialization_subjects', $teacher->specialization_subjects) }}">
                <div class="help-text">e.g. General Faculty, Mathematics, Sciences.</div>
            </div>
        </div>
    </div>
    ...
    <div style="display:flex;gap:12px;align-items:center">
        ...
        <a href="{{ route($routePrefix . 'teacher', $teacher) }}" class="btn btn-ghost">Cancel</a>
    </div>
</form>
@endsection